...
| Income Tax | 42901.123400000004 | 42901.1233999998 | -2.0372681319713593e-10 | PASS |
| NI Class 4 (lower) | 3645 | 3645 | 0 | PASS |
| Total Tax + NI, less the CIS already deducted | 48066.17957000001 | 48066.1795699998 | -2.1100277081131935e-10 | PASS |
...
| Tax: IT = Basic + Higher + Additional | 42901.1233999998 | 42901.1233999998 | 0 | PASS |
| Tax: Total = IT + CIS deduction line + NI | 48066.17956999979 | 48066.1795699998 | +7.275957614183426e-12 | PASS |
...
| Forecast: personal allowance after taper | 2073.324999999997 | 2073.32500000022 | +2.2282620193436742e-10 | PASS |
| Forecast: tax at standard rate | 7500 | 7500 | 0 | PASS |
| Forecast: tax at higher rate | 32512.010000000006 | 32512.0099999997 | -3.055902197957039e-10 | PASS |
| Forecast: tax at additional rate | 0 | 0 | 0 | PASS |
| Forecast: National Insurance | 5062.067 | 5062.06699999999 | -1.000444171950221e-11 | PASS |
| Forecast: tax and NI liability | 45074.07700000001 | 45074.0769999997 | -3.128661774098873e-10 | PASS |
...
| SA103F: the online filing deadline banner (G1) names 31 January the year after the tax year ends | COPY DETAILS TO HMRC FORM          Submit HMRC RETURN ONLINE                   by 31st January 2022 | COPY DETAILS TO HMRC FORM          Submit HMRC RETURN ONLINE                   by 31st January 2022 |  | PASS |
...
| Admin: Amounts Payable By date (B21) = 31 January the year after the tax year ends | 44592 | 44592 | 0 | PASS |
| Payslips calendar: the payroll year starts on the accounts tax year start (B2 = Admin B4) | 43927 | 43927 | 0 | PASS |
| Payslips calendar: the year the calendar runs to (I1) = the accounts tax year end (Admin B17) | 44291 | 44291 | 0 | PASS |
| Payslips calendar: the tax year the payslips print (N1) = the tax year the package was generated for | 2020-21 | 2020-21 |  | PASS |
| Payslips calendar row 2: the date runs on unbroken from the tax year start | 43927 | 43927 | 0 | PASS |
| Payslips calendar row 2: the month name is its payroll month counted from the tax year start | Apr | Apr |  | PASS |
| Payslips calendar row 33: the date runs on unbroken from the tax year start | 43958 | 43958 | 0 | PASS |
| Payslips calendar row 33: the month name is its payroll month counted from the tax year start | May | May |  | PASS |
| Payslips calendar row 64: the date runs on unbroken from the tax year start | 43989 | 43989 | 0 | PASS |
| Payslips calendar row 64: the month name is its payroll month counted from the tax year start | Jun | Jun |  | PASS |
| Payslips calendar row 95: the date runs on unbroken from the tax year start | 44020 | 44020 | 0 | PASS |
| Payslips calendar row 95: the month name is its payroll month counted from the tax year start | Jul | Jul |  | PASS |
| Payslips calendar row 126: the date runs on unbroken from the tax year start | 44051 | 44051 | 0 | PASS |
| Payslips calendar row 126: the month name is its payroll month counted from the tax year start | Aug | Aug |  | PASS |
| Payslips calendar row 157: the date runs on unbroken from the tax year start | 44082 | 44082 | 0 | PASS |
| Payslips calendar row 157: the month name is its payroll month counted from the tax year start | Sep | Sep |  | PASS |
| Payslips calendar row 188: the date runs on unbroken from the tax year start | 44113 | 44113 | 0 | PASS |
| Payslips calendar row 188: the month name is its payroll month counted from the tax year start | Oct | Oct |  | PASS |
| Payslips calendar row 219: the date runs on unbroken from the tax year start | 44144 | 44144 | 0 | PASS |
| Payslips calendar row 219: the month name is its payroll month counted from the tax year start | Nov | Nov |  | PASS |
| Payslips calendar row 250: the date runs on unbroken from the tax year start | 44175 | 44175 | 0 | PASS |
| Payslips calendar row 250: the month name is its payroll month counted from the tax year start | Dec | Dec |  | PASS |
| Payslips calendar row 281: the date runs on unbroken from the tax year start | 44206 | 44206 | 0 | PASS |
| Payslips calendar row 281: the month name is its payroll month counted from the tax year start | Jan | Jan |  | PASS |
| Payslips calendar row 312: the date runs on unbroken from the tax year start | 44237 | 44237 | 0 | PASS |
| Payslips calendar row 312: the month name is its payroll month counted from the tax year start | Feb | Feb |  | PASS |
| Payslips calendar row 343: the date runs on unbroken from the tax year start | 44268 | 44268 | 0 | PASS |
| Payslips calendar row 343: the month name is its payroll month counted from the tax year start | Mar | Mar |  | PASS |
| Payslips calendar row 366: the date runs on unbroken from the tax year start | 44291 | 44291 | 0 | PASS |
| Payslips calendar row 366: the month name is its payroll month counted from the tax year start | Mar | Mar |  | PASS |
| Payslips calendar row 381: the date runs on unbroken from the tax year start | 44306 | 44306 | 0 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Personal Allowance | 2,073.33 |
| &nbsp;&nbsp;&nbsp;&nbsp;Profit after Allowance | 118,780.03 |
| &nbsp;&nbsp;&nbsp;&nbsp;Tax at standard rate | 7,500 |
| &nbsp;&nbsp;&nbsp;&nbsp;Tax at higher rate | 32,512.01 |
| &nbsp;&nbsp;&nbsp;&nbsp;Tax at additional rate | 0 |
| &nbsp;&nbsp;&nbsp;&nbsp;National Insurance | 5,062.07 |
| **Forecast Tax & NI Liability** | 45,074.08 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 June 2020) box 4: VAT reclaimed on purchases | 5,993.5 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 June 2020) box 5: net VAT due | 10,926.5 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 September 2020) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 September 2020) box 4: VAT reclaimed on purchases | 4,509.83 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 September 2020) box 5: net VAT due | 12,746.83 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 December 2020) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 December 2020) box 4: VAT reclaimed on purchases | 9,867 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 December 2020) box 5: net VAT due | 9,913 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 March 2021) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 March 2021) box 4: VAT reclaimed on purchases | 2,084.33 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 March 2021) box 5: net VAT due | 14,775.67 |
...
| E8 | Tax at Basic Rate (20%) | 7500 | tax.incomeTax.basicRate |
| C9 | Basic band ceiling the sheet applies | 37500 | tax.incomeTax.basicBandEnd (applied) |
| E9 | Tax at Higher Rate (40%) | 35401.1233999998 | tax.incomeTax.higherRate |
...
| E11 | **Total Income Tax** | 42901.1233999998 | tax.incomeTax (total) |
| E12 | Less: CIS Deducted | 0 | diya-gl:cisDeduction (total) |
| E15 | NI Class 4 (lower band) | 3645 | tax.nationalInsurance.class4MainRate |
| E16 | NI Class 4 (upper band) | 1520.05616999999 | tax.nationalInsurance.class4UpperRate |
| E18 | **Total Tax + NI** | 48066.1795699998 | gl-cor:taxAmount (totalTaxNI) |
...
| C40 | Personal Allowance | 2073.32500000022 | tax.incomeTax.personalAllowance |
| C41 | Profit after Allowance | 118780.024999999 | gl-cor:amount (forecast.taxableIncome) |
| C42 | Tax at standard rate | 7500 | tax.incomeTax.basicRate |
| C43 | Tax at higher rate | 32512.0099999997 | tax.incomeTax.higherRate |
| C44 | Tax at additional rate | 0 | tax.incomeTax.additionalRate |
| C45 | National Insurance | 5062.06699999999 | tax.nationalInsurance.class4 |
| C46 | **Forecast Tax & NI Liability** | 45074.0769999997 | gl-cor:taxAmount (forecast.totalTaxNI) |
...
| S17 | Accounting date | 43927 | documentInfo.periodCoveredEnd |
...
| G1 |  | COPY DETAILS TO HMRC FORM          Submit HMRC RETURN ONLINE                   by 31st January 2022 |  |
| Q2 |  | 43927 |  |
| V2 |  | 44291 |  |
| G141 |  | 0.18 |  |
| J280 |  | 9500 |  |
...
| N16 | NI Class 2 Small Profits Threshold | 6475 | tax.nationalInsurance.class2SmallProfitsThreshold |
