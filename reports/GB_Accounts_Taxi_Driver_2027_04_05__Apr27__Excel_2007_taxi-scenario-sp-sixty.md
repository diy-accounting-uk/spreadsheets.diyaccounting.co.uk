...
| P&L: Net = Gross - General Expenses | 31784 | 31784 | 0 | PASS |
| P&L: Cost of Sales = vehicle cost lines | 4896 | 4896 | 0 | PASS |
| P&L: Gross = Turnover - Cost of Sales | 33104 | 33104 | 0 | PASS |
...
| Fixed Assets: Schedule capital allowance total = P&L Capital Allowances | 28 | 28 | 0 | PASS |
...
| Tax: Total = IT + NI | 4950.92 | 4950.92 | 0 | PASS |
| SA103S: Profit for tax = Draft Tax E5 | 31612 | 31612 | 0 | PASS |
...
| Line | Cell | Amount |
|------|------|-------:|
| Net profit per the profit and loss account | Profit & Loss Acc!B23 | 31,784 |
| Add capital allowances charged in cost of sales | Profit & Loss Acc!B10 | 28 |
...
| Tax profit the sheet carries | Draft Tax calculation!E5 | 31,612 |
| **Residue** | | **0** |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Capital Allowances | 28 |
| &nbsp;&nbsp;&nbsp;&nbsp;Mileage Allowance | 0 |
| Cost of Sales (vehicle costs) | 4,896 |
| **Gross Profit** | 33,104 |
| &nbsp;&nbsp;&nbsp;&nbsp;Employee Costs | 0 |
| &nbsp;&nbsp;&nbsp;&nbsp;Premises Costs | 0 |
| &nbsp;&nbsp;&nbsp;&nbsp;General Admin | 420 |
...
| **Net business profit (box 27)** | 31,612 |
...
| B10 | Capital Allowances | 28 | tax.capitalAllowances |
| B11 | Mileage Allowance | 0 | tax.mileage (allowance) |
| B12 | Cost of Sales (vehicle costs) | 4896 | gl-cor:amount (costOfSales) |
| B13 | **Gross Profit** | 33104 | gl-cor:amount (grossProfit) |
...
| B23 | **Net Profit** | 31784 | gl-cor:amount (netProfit) |
...
| D99 | **Net business profit (box 27)** | 31612 | gl-cor:amount (sa103s.taxableProfit) |
...
| E14 | NI Class 4 (lower band) | 1142.52 | tax.nationalInsurance.class4MainRate |
| E15 | NI Class 4 (upper band) | 0 | tax.nationalInsurance.class4UpperRate |
| E17 | **Total Tax + NI** | 4950.92 | gl-cor:taxAmount (totalTaxNI) |
...
| Cell | DIY Label | Value | diya-gl mapping |
|------|-----------|-------|-----------------|
| D47 | New Asset Cost (Vehicle under £12,000) | 200 | accounts.assets.fixedAssets (cost) |
