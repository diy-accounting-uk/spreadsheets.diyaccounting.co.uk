# Reconciliation Report: GB Accounts Company 2020-04-30 (Apr20) Excel 2007
...
| VAT Q1: payment due date (G7) = Vatinterface final date for payment (C8) | 43708 | 43708 | 0 | PASS |
...
| VAT Q2: payment due date (G7) = Vatinterface final date for payment (C11) | 43799 | 43799 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 43890 | 43890 | 0 | PASS |
...
| VAT Q4: payment due date (G7) = Vatinterface final date for payment (C17) | 43982 | 43982 | 0 | PASS |
...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C20) | 44074 | 44074 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 43951 | 43951 | 0 | PASS |
...
| Board minute: meeting date = the scenario's board meeting | 43951 | 43951 | 0 | PASS |
...
| Payslips!May K49 the monthly payroll opens in the accounting period's May | 43586 | 43586 | 0 | PASS |
| Payslips!Jun K49 the monthly payroll opens in the accounting period's Jun | 43617 | 43617 | 0 | PASS |
| Payslips!Jul K59 the monthly payroll opens in the accounting period's Jul | 43647 | 43647 | 0 | PASS |
...
| Payslips!Apr K69 the monthly payroll opens in the accounting period's Apr | 43922 | 43922 | 0 | PASS |
...
| Payslips print: the period ends the day the scenario paid that month's wages | 43646 | 43646 | 0 | PASS |
...
| Payslips print: the payment date is the day the scenario paid that month's wages | 43646 | 43646 | 0 | PASS |
...
| Payslips!Aug M49 wages paid date | 43708 | 43708 | 0 | PASS |
...
| Payslips!Sep M49 wages paid date | 43738 | 43738 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 43951 | 43951 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 43951 | 43951 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 43951 | 43951 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 43951 | 43951 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 43951 | 43951 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 366 | +1 | PASS |
| Admin: first financial year row starts at the accounting period start | 43586 | 43586 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 43922 | 43922 | 0 | PASS |
| Admin: second financial year row ends at the year end | 43951 | 43951 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 43586 | 43586 | 0 | PASS |
| CT: working sheet heading ends at the year end | 43951 | 43951 | 0 | PASS |
| CT: the two tax rows span the accounting period | 366 | 366 | 0 | PASS |
| CT600: return period starts at the accounting period start | 43586 | 43586 | 0 | PASS |
| CT600: return period ends at the year end | 43951 | 43951 | 0 | PASS |
...
| CT600: corporation tax = first tax row gross tax | 21702.09365594 | 21702.09365594 | 0 | PASS |
| CT600: second financial year tax = second tax row gross tax | 1937.68693356607 | 1937.68693356607 | 0 | PASS |
...
| CT600: tax payable = tax chargeable | 23639.78058950607 | 23639.7805895061 | +2.9103830456733704e-11 | PASS |
...
| CT: first tax row gross tax = its profit at its rate | 21702.09365594001 | 21702.09365594 | -1.0913936421275139e-11 | PASS |
| CT: second tax row gross tax = its profit at its rate | 1937.686933566073 | 1937.68693356607 | -3.183231456205249e-12 | PASS |
| CT: first tax row tax = its gross tax less its marginal relief | 21702.09365594 | 21702.09365594 | 0 | PASS |
| CT: second tax row tax = its gross tax less its marginal relief | 1937.68693356607 | 1937.68693356607 | 0 | PASS |
| CT: charge for the year = the two tax rows | 23639.78058950607 | 23639.7805895061 | +2.9103830456733704e-11 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Box 335: amount of profit | 114,221.55 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 340: rate of tax | 19 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 345: tax | 21,702.09 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 380: financial year | 2,020 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 385: amount of profit | 10,198.35 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 390: rate of tax | 19 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 395: tax | 1,937.69 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 covers the periods ending | 31 May 2019, 30 June 2019, 31 July 2019 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 covers the periods ending | 31 August 2019, 30 September 2019, 31 October 2019 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 covers the periods ending | 30 November 2019, 31 December 2019, 31 January 2020 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 covers the periods ending | 29 February 2020, 31 March 2020, 30 April 2020 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 covers the periods ending | 31 May 2020, 30 June 2020, 31 July 2020 |
| The returns above also cover the periods ending 31 May 2020, 30 June 2020, 31 July 2020, which fall outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 180 |
| **The return forms as the package fills them in** |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 July 2019) box 1: VAT due on sales | 16,920 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 July 2019) box 4: VAT reclaimed on purchases | 6,023.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 July 2019) box 5: net VAT due | 10,896.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 October 2019) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 October 2019) box 4: VAT reclaimed on purchases | 4,473.25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 October 2019) box 5: net VAT due | 12,783.42 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 January 2020) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 January 2020) box 4: VAT reclaimed on purchases | 9,895.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 January 2020) box 5: net VAT due | 9,884.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 April 2020) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 April 2020) box 4: VAT reclaimed on purchases | 2,105.71 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 April 2020) box 5: net VAT due | 14,754.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 July 2020) box 1: VAT due on sales | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 July 2020) box 4: VAT reclaimed on purchases | 180 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 July 2020) box 5: net VAT due | 920 |
...
| G34 |  | 19 |  |
| J33 |  | 21702.09365594 |  |
| J34 |  | 1937.68693356607 |  |
| L33 |  | 0 |  |
| L34 |  | 0 |  |
| I33 |  | 21702.09365594 |  |
| I34 |  | 1937.68693356607 |  |
...
| N126 | Box 335: amount of profit | 114221.545557579 | gl-cor:amount (ct600.box335) |
| AA126 | Box 340: rate of tax | 19 | gl-cor:rate (ct600.box340) |
| AJ126 | Box 345: tax | 21702.09365594 | gl-cor:taxAmount (ct600.box345) |
| C128 | Box 380: financial year | 2020 | gl-cor:period (ct600.box380) |
| N128 | Box 385: amount of profit | 10198.3522819267 | gl-cor:amount (ct600.box385) |
| AA128 | Box 390: rate of tax | 19 | gl-cor:rate (ct600.box390) |
| AJ128 | Box 395: tax | 1937.68693356607 | gl-cor:taxAmount (ct600.box395) |
