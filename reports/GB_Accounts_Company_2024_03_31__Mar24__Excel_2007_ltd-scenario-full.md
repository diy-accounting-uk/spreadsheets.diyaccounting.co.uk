# Reconciliation Report: GB Accounts Company 2024-03-31 (Mar24) Excel 2007
...
| VAT Q1: payment due date (G7) = Vatinterface final date for payment (C8) | 45138 | 45138 | 0 | PASS |
...
| VAT Q2: payment due date (G7) = Vatinterface final date for payment (C11) | 45230 | 45230 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 45322 | 45322 | 0 | PASS |
...
| VAT Q4: payment due date (G7) = Vatinterface final date for payment (C17) | 45412 | 45412 | 0 | PASS |
...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C20) | 45504 | 45504 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 45382 | 45382 | 0 | PASS |
...
| Payslips!Apr K49 the monthly payroll opens in the accounting period's Apr | 45022 | 45022 | 0 | PASS |
...
| Payslips!Mar K69 the monthly payroll opens in the accounting period's Mar | 45352 | 45352 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 45382 | 45382 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 45382 | 45382 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 45382 | 45382 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 45382 | 45382 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 45382 | 45382 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 366 | +1 | PASS |
| Admin: first financial year row starts at the accounting period start | 45017 | 45017 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 45383 | 45383 | 0 | PASS |
| Admin: second financial year row ends at the year end | 45382 | 45382 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 45017 | 45017 | 0 | PASS |
| CT: working sheet heading ends at the year end | 45382 | 45382 | 0 | PASS |
| CT: the two tax rows span the accounting period | 366 | 366 | 0 | PASS |
| CT600: return period starts at the accounting period start | 45017 | 45017 | 0 | PASS |
| CT600: return period ends at the year end | 45382 | 45382 | 0 | PASS |
...
| CT600: marginal rate relief = the working sheet's relief | 1883.70153240741 | 1883.70153240741 | 0 | PASS |
...
| CT: first tax row tax = its gross tax less its marginal relief | 29221.272927468992 | 29221.272927469 | +7.275957614183426e-12 | PASS |
...
| CT: first tax row marginal relief = its share of the profit against its share of the limits | 1883.70153240741 | 1883.70153240741 | 0 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 covers the periods ending | 30 April 2023, 31 May 2023, 30 June 2023 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 covers the periods ending | 31 July 2023, 31 August 2023, 30 September 2023 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 covers the periods ending | 31 October 2023, 30 November 2023, 31 December 2023 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 covers the periods ending | 31 January 2024, 29 February 2024, 31 March 2024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 covers the periods ending | 30 April 2024, 31 May 2024, 30 June 2024 |
| The returns above also cover the periods ending 30 April 2024, 31 May 2024, 30 June 2024, which fall outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 180 |
| **The return forms as the package fills them in** |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 June 2023) box 1: VAT due on sales | 16,920 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 June 2023) box 4: VAT reclaimed on purchases | 6,023.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 June 2023) box 5: net VAT due | 10,896.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 September 2023) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 September 2023) box 4: VAT reclaimed on purchases | 4,473.25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 September 2023) box 5: net VAT due | 12,783.42 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 December 2023) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 December 2023) box 4: VAT reclaimed on purchases | 9,895.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 December 2023) box 5: net VAT due | 9,884.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 March 2024) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 March 2024) box 4: VAT reclaimed on purchases | 2,105.71 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 March 2024) box 5: net VAT due | 14,754.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 June 2024) box 1: VAT due on sales | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 June 2024) box 4: VAT reclaimed on purchases | 180 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 June 2024) box 5: net VAT due | 920 |
...
| AJ126 | Box 46: tax | 31104.9744598764 | gl-cor:taxAmount (ct600.box46) |
...
| A1 |  | 1025 |  |
| A2 |  | 1025 |  |
secretary.xlsx!Directors&Secretary
