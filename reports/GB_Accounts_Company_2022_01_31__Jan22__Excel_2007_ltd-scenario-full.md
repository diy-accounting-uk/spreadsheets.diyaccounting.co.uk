...
# Reconciliation Report: GB Accounts Company 2022-01-31 (Jan22) Excel 2007
...
| VAT Q1: payment due date (G7) = Vatinterface final date for payment (C8) | 44347 | 44347 | 0 | PASS |
...
| VAT Q2: payment due date (G7) = Vatinterface final date for payment (C11) | 44439 | 44439 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 44530 | 44530 | 0 | PASS |
...
| VAT Q4: payment due date (G7) = Vatinterface final date for payment (C17) | 44620 | 44620 | 0 | PASS |
...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C20) | 44712 | 44712 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 44592 | 44592 | 0 | PASS |
...
| Board minute: meeting date = the scenario's board meeting | 44592 | 44592 | 0 | PASS |
...
| Payslips!Jan K69 the monthly payroll opens in the accounting period's Jan | 44562 | 44562 | 0 | PASS |
...
| Payslips print: the period ends the day the scenario paid that month's wages | 44286 | 44286 | 0 | PASS |
...
| Payslips print: the payment date is the day the scenario paid that month's wages | 44286 | 44286 | 0 | PASS |
...
| Payslips!May M49 wages paid date | 44347 | 44347 | 0 | PASS |
...
| Payslips!Jun M49 wages paid date | 44377 | 44377 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 44592 | 44592 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 44592 | 44592 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 44592 | 44592 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 44592 | 44592 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 44592 | 44592 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 365 | 0 | PASS |
| Admin: first financial year row starts at the accounting period start | 44228 | 44228 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 44287 | 44287 | 0 | PASS |
| Admin: second financial year row ends at the year end | 44592 | 44592 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 44228 | 44228 | 0 | PASS |
| CT: working sheet heading ends at the year end | 44592 | 44592 | 0 | PASS |
| CT: the two tax rows span the accounting period | 365 | 365 | 0 | PASS |
| CT600: return period starts at the accounting period start | 44228 | 44228 | 0 | PASS |
| CT600: return period ends at the year end | 44592 | 44592 | 0 | PASS |
...
| CT600: second financial year tax = second tax row gross tax | 19772.0968777777 | 19772.0968777777 | 0 | PASS |
...
| CT600: tax payable = tax chargeable | 23584.36392283942 | 23584.3639228394 | -2.1827872842550278e-11 | PASS |
...
| CT: second tax row gross tax = its profit at its rate | 19772.09687777763 | 19772.0968777777 | +7.275957614183426e-11 | PASS |
| CT: first tax row tax = its gross tax less its marginal relief | 3812.26704506172 | 3812.26704506172 | 0 | PASS |
| CT: second tax row tax = its gross tax less its marginal relief | 19772.0968777777 | 19772.0968777777 | 0 | PASS |
| CT: charge for the year = the two tax rows | 23584.36392283942 | 23584.3639228394 | -2.1827872842550278e-11 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 covers the periods ending | 28 February 2021, 31 March 2021, 30 April 2021 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 covers the periods ending | 31 May 2021, 30 June 2021, 31 July 2021 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 covers the periods ending | 31 August 2021, 30 September 2021, 31 October 2021 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 covers the periods ending | 30 November 2021, 31 December 2021, 31 January 2022 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 covers the periods ending | 28 February 2022, 31 March 2022, 30 April 2022 |
| The returns above also cover the periods ending 28 February 2022, 31 March 2022, 30 April 2022, which fall outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 180 |
| **The return forms as the package fills them in** |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 April 2021) box 1: VAT due on sales | 16,920 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 April 2021) box 4: VAT reclaimed on purchases | 6,023.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 April 2021) box 5: net VAT due | 10,896.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 July 2021) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 July 2021) box 4: VAT reclaimed on purchases | 4,531.58 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 July 2021) box 5: net VAT due | 12,725.08 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 October 2021) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 October 2021) box 4: VAT reclaimed on purchases | 9,895.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 October 2021) box 5: net VAT due | 9,884.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 January 2022) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 January 2022) box 4: VAT reclaimed on purchases | 2,105.71 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 January 2022) box 5: net VAT due | 14,754.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 April 2022) box 1: VAT due on sales | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 April 2022) box 4: VAT reclaimed on purchases | 180 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 April 2022) box 5: net VAT due | 920 |
...
| J34 |  | 19772.0968777777 |  |
| L33 |  | 0 |  |
| L34 |  | 0 |  |
| I33 |  | 3812.26704506172 |  |
| I34 |  | 19772.0968777777 |  |
...
| AJ128 | Box 395: tax | 19772.0968777777 | gl-cor:taxAmount (ct600.box395) |
