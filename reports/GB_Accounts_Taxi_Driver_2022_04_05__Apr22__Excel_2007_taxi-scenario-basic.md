# Reconciliation Report: GB Accounts Taxi Driver 2022-04-05 (Apr22) Excel 2007
...
|-------|----------|--------|------|--------|
| Total Sales | 36045 | 36045 | 0 | PASS |
| Other business income | 500 | 500 | 0 | PASS |
| P&L: Net = Gross - General Expenses | 28245 | 28245 | 0 | PASS |
| P&L: Cost of Sales = vehicle cost lines | 6420 | 6420 | 0 | PASS |
| P&L: Gross = Turnover - Cost of Sales | 29625 | 29625 | 0 | PASS |
...
| VitalTax: Q1 turnover = P&L Q1 turnover | 9045 | 9045 | 0 | PASS |
| VitalTax: Q1 other income = P&L Q1 other income | 0 | 0 | 0 | PASS |
| VitalTax: Q1 total allowable expenses = P&L Q1 Cost of Sales + Total Expenses | 3160 | 3160 | 0 | PASS |
| VitalTax: Q2 turnover = P&L Q2 turnover | 9000 | 9000 | 0 | PASS |
| VitalTax: Q2 other income = P&L Q2 other income | 500 | 500 | 0 | PASS |
| VitalTax: Q2 total allowable expenses = P&L Q2 Cost of Sales + Total Expenses | 1380 | 1380 | 0 | PASS |
| VitalTax: Q3 turnover = P&L Q3 turnover | 9000 | 9000 | 0 | PASS |
| VitalTax: Q3 other income = P&L Q3 other income | 0 | 0 | 0 | PASS |
| VitalTax: Q3 total allowable expenses = P&L Q3 Cost of Sales + Total Expenses | 1380 | 1380 | 0 | PASS |
...
| VitalTax: annual turnover = P&L annual turnover | 36045 | 36045 | 0 | PASS |
| VitalTax: annual other income = P&L annual other income | 500 | 500 | 0 | PASS |
...
| P&L: the comparison figure = running costs plus the schedule's allowances | 6420 | 6420 | 0 | PASS |
| P&L: the route follows the comparison |  |  |  | PASS |
| SA103S: Turnover = P&L Sales | 36045 | 36045 | 0 | PASS |
| SA103S: Net profit (pre-capital-allowance) = P&L Net + Capital Allowances | 29685 | 29685 | 0 | PASS |
| SA103S: Other business income (box 30) = P&L other income | 500 | 500 | 0 | PASS |
| Fixed Assets: New asset cost recorded | 8000 | 8000 | 0 | PASS |
| Fixed Assets: written-down value = cost less the allowance | 6560 | 6560 | 0 | PASS |
...
| Income Tax | 3235 | 3235 | 0 | PASS |
| NI Class 4 (lower) | 1725.9 | 1725.93 | +0.029999999999972715 | PASS |
| Total Tax + NI | 4961 | 4960.93 | -0.06999999999970896 | PASS |
| Tax: first payment on account is half the liability | 2480.465 | 2480.465 | 0 | PASS |
| Tax: second payment on account is half the liability | 2480.465 | 2480.465 | 0 | PASS |
...
| Tax at basic rate | 3235 | 3235 | 0 | PASS |
| Tax at higher rate | 0 | 0 | 0 | PASS |
| Tax at additional rate | 0 | 0 | 0 | PASS |
| Tax: Taxable = Profit - Allowance | 16175 | 16175 | 0 | PASS |
| Tax: IT = Basic + Higher + Additional | 3235 | 3235 | 0 | PASS |
| Tax: Total = IT + NI | 4960.93 | 4960.93 | 0 | PASS |
| SA103S: Profit for tax = Draft Tax E5 | 28745 | 28745 | 0 | PASS |
...
| Forecast: turnover = the traded months plus the year spread over the rest | 36045 | 36045 | 0 | PASS |
| Forecast: cost of sales = the traded months plus the year spread over the rest | 6420 | 6420 | 0 | PASS |
| Forecast: general expenses = the traded months plus the year spread over the rest | 1380 | 1380 | 0 | PASS |
| Forecast: other business income = P&L other business income | 500 | 500 | 0 | PASS |
| Forecast: turnover = P&L turnover | 36045 | 36045 | 0 | PASS |
| Forecast: cost of sales = P&L cost of sales | 6420 | 6420 | 0 | PASS |
| Forecast: general expenses = P&L general expenses | 1380 | 1380 | 0 | PASS |
| Forecast: profit = turnover + other income - cost of sales - expenses | 28745 | 28745 | 0 | PASS |
| Forecast: personal allowance after taper | 12570 | 12570 | 0 | PASS |
| Forecast: tax at standard rate | 3235 | 3235 | 0 | PASS |
| Forecast: tax at higher rate | 0 | 0 | 0 | PASS |
| Forecast: tax at additional rate | 0 | 0 | 0 | PASS |
| Forecast: National Insurance | 1725.9 | 1725.93 | +0.029999999999972715 | PASS |
| Forecast: tax and NI liability | 4961 | 4960.93 | -0.06999999999970896 | PASS |
...
| Line | Cell | Amount |
|------|------|-------:|
| Net profit per the profit and loss account | Profit & Loss Acc!B23 | 28,245 |
| Add capital allowances charged in cost of sales | Profit & Loss Acc!B10 | 1,440 |
...
| Less other capital allowances (box 25) | SE Short!O80 | -1,440 |
| Add balancing charges (box 26) | SE Short!O85 | 0 |
| Add goods and services for own use (box 27) | SE Short!D94 | 0 |
| Add other business income (box 30) | SE Short!O99 | 500 |
| Less loss brought forward (box 29) | SE Short!O94 | 0 |
| **Tax profit the bridge computes** | | **28,745** |
| Tax profit the sheet carries | Draft Tax calculation!E5 | 28,745 |
| **Residue** | | **0** |
...
| Description of business | Owner-driver private hire and taxi services |
| Postcode | DE1 2GH |
| UTR | 5566778899 |
...
| | Amount |
|---|------:|
| Turnover (Total Fares) | 36,045 |
| &nbsp;&nbsp;&nbsp;&nbsp;Fuel | 3,600 |
| &nbsp;&nbsp;&nbsp;&nbsp;Car Hire / Rental | 0 |
| &nbsp;&nbsp;&nbsp;&nbsp;Repairs & Servicing | 0 |
| &nbsp;&nbsp;&nbsp;&nbsp;Road Tax & Insurance | 1,380 |
| &nbsp;&nbsp;&nbsp;&nbsp;Capital Allowances | 1,440 |
| &nbsp;&nbsp;&nbsp;&nbsp;Mileage Allowance | 0 |
| Cost of Sales (vehicle costs) | 6,420 |
| **Gross Profit** | 29,625 |
| &nbsp;&nbsp;&nbsp;&nbsp;Employee Costs | 0 |
| &nbsp;&nbsp;&nbsp;&nbsp;Premises Costs | 0 |
| &nbsp;&nbsp;&nbsp;&nbsp;General Admin | 480 |
...
| **Net Profit** | 28,245 |
| &nbsp;&nbsp;&nbsp;&nbsp;Any Other Business Income | 500 |
| &nbsp;&nbsp;&nbsp;&nbsp;Running costs plus capital allowances | 6,420 |
| &nbsp;&nbsp;&nbsp;&nbsp;Route the sheet takes | — |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 Turnover | 9,000 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 Turnover | 9,000 |
| **Annual Turnover** | 36,045 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 Other income | 0 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 Other income | 500 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 Other income | 0 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 Other income | 0 |
| **Annual Other income** | 500 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 Total Allowable Expenses | 3,160 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 Total Allowable Expenses | 1,380 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 Total Allowable Expenses | 1,380 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 Total Allowable Expenses | 1,880 |
| **Annual Total Allowable Expenses** | 7,800 |

## Self Assessment (SA103S)

| | Amount |
|---|------:|
| Turnover (box 9) | 36,045 |
| &nbsp;&nbsp;&nbsp;&nbsp;Other business income (box 10) | — |
| **Net profit/loss (box 21)** | 29,685 |
| &nbsp;&nbsp;&nbsp;&nbsp;Net loss (box 22) | 0 |
| &nbsp;&nbsp;&nbsp;&nbsp;Annual investment allowance (box 23) | 0 |
| &nbsp;&nbsp;&nbsp;&nbsp;Small-balance allowance (box 24) | 0 |
| &nbsp;&nbsp;&nbsp;&nbsp;Other capital allowances (box 25) | 1,440 |
| &nbsp;&nbsp;&nbsp;&nbsp;Balancing charges (box 26) | 0 |
| &nbsp;&nbsp;&nbsp;&nbsp;Goods and services for own use (box 27) | 0 |
| **Net business profit (box 28)** | 28,245 |
| &nbsp;&nbsp;&nbsp;&nbsp;Loss brought forward (box 29) | 0 |
| &nbsp;&nbsp;&nbsp;&nbsp;Other business income (box 30) | 500 |
| **Net profit for tax calc (box 31)** | 28,745 |

## Draft Tax Calculation

| | Amount |
|---|------:|
| Profit from Self Employment | 28,745 |
| &nbsp;&nbsp;&nbsp;&nbsp;Less: Personal Allowance | 12,570 |
| Taxable Income | 16,175 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Tax at Basic Rate | 3,235 |
| &nbsp;&nbsp;&nbsp;&nbsp;Tax at Higher Rate | 0 |
| &nbsp;&nbsp;&nbsp;&nbsp;Tax at Additional Rate | 0 |
| **Total Income Tax** | 3,235 |
| &nbsp;&nbsp;&nbsp;&nbsp;NI Class 4 (lower band) | 1,725.93 |
| &nbsp;&nbsp;&nbsp;&nbsp;NI Class 4 (upper band) | 0 |
| **Total Tax + NI** | 4,960.93 |
| &nbsp;&nbsp;&nbsp;&nbsp;First payment on account (31 January) | 2,480.47 |
| &nbsp;&nbsp;&nbsp;&nbsp;Second payment on account (31 July) | 2,480.47 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Forecast Sales Turnover | 36,045 |
| &nbsp;&nbsp;&nbsp;&nbsp;Forecast Investment Grants | 500 |
| &nbsp;&nbsp;&nbsp;&nbsp;Forecast Cost of Sales | 6,420 |
| &nbsp;&nbsp;&nbsp;&nbsp;Forecast General Expenses | 1,380 |
| **Forecast Profit before Tax** | 28,745 |
| &nbsp;&nbsp;&nbsp;&nbsp;Profit before Tax | 28,745 |
| &nbsp;&nbsp;&nbsp;&nbsp;Personal Allowance | 12,570 |
| &nbsp;&nbsp;&nbsp;&nbsp;Profit after Allowance | 16,175 |
| &nbsp;&nbsp;&nbsp;&nbsp;Tax at standard rate | 3,235 |
| &nbsp;&nbsp;&nbsp;&nbsp;Tax at higher rate | 0 |
| &nbsp;&nbsp;&nbsp;&nbsp;Tax at additional rate | 0 |
| &nbsp;&nbsp;&nbsp;&nbsp;National Insurance | 1,725.93 |
| **Forecast Tax & NI Liability** | 4,960.93 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Total Writing Down Allowance | 1,440 |
| &nbsp;&nbsp;&nbsp;&nbsp;Total Capital Allowance on Disposal | 0 |
| &nbsp;&nbsp;&nbsp;&nbsp;Total Balancing Charge | 0 |
| Written-down value carried forward | 6,560 |
...
| C8 | Description of business | Owner-driver private hire and taxi services | entityInformation.organizationDescription |
| C17 | Postcode | DE1 2GH | entityInformation.organizationPostcode |
| O5 | UTR | 5566778899 | entityInformation.taxRegistrationNumber |

### Profit & Loss Acc

| Cell | DIY Label | Value | diya-gl mapping |
|------|-----------|-------|-----------------|
| B5 | Turnover (Total Fares) | 36045 | gl-cor:amount (salesTurnover) |
...
| B10 | Capital Allowances | 1440 | tax.capitalAllowances |
| B11 | Mileage Allowance | 0 | tax.mileage (allowance) |
| B12 | Cost of Sales (vehicle costs) | 6420 | gl-cor:amount (costOfSales) |
| B13 | **Gross Profit** | 29625 | gl-cor:amount (grossProfit) |
...
| B23 | **Net Profit** | 28245 | gl-cor:amount (netProfit) |
| B24 | Any Other Business Income | 500 | gl-cor:amount (otherIncome) |
| J1 | Running costs plus capital allowances | 6420 | accounts.purchases (vehicleCostsCompared) |
| C5 | Apr | 3045 | gl-cor:amount (monthlyTakings.apr) |
| D5 | May | 3000 | gl-cor:amount (monthlyTakings.may) |
| E5 | Jun | 3000 | gl-cor:amount (monthlyTakings.jun) |
| F5 | Jul | 3000 | gl-cor:amount (monthlyTakings.jul) |
| G5 | Aug | 3000 | gl-cor:amount (monthlyTakings.aug) |
| H5 | Sep | 3000 | gl-cor:amount (monthlyTakings.sep) |
| I5 | Oct | 3000 | gl-cor:amount (monthlyTakings.oct) |
| J5 | Nov | 3000 | gl-cor:amount (monthlyTakings.nov) |
| K5 | Dec | 3000 | gl-cor:amount (monthlyTakings.dec) |
| L5 | Jan | 3000 | gl-cor:amount (monthlyTakings.jan) |
| M5 | Feb | 3000 | gl-cor:amount (monthlyTakings.feb) |
| N5 | Mar | 3000 | gl-cor:amount (monthlyTakings.mar) |
| C12 | Apr | 1800 | gl-cor:amount (monthlyVehicleCosts.apr) |
| D12 | May | 420 | gl-cor:amount (monthlyVehicleCosts.may) |
| E12 | Jun | 420 | gl-cor:amount (monthlyVehicleCosts.jun) |
| F12 | Jul | 420 | gl-cor:amount (monthlyVehicleCosts.jul) |
| G12 | Aug | 420 | gl-cor:amount (monthlyVehicleCosts.aug) |
| H12 | Sep | 420 | gl-cor:amount (monthlyVehicleCosts.sep) |
| I12 | Oct | 420 | gl-cor:amount (monthlyVehicleCosts.oct) |
| J12 | Nov | 420 | gl-cor:amount (monthlyVehicleCosts.nov) |
| K12 | Dec | 420 | gl-cor:amount (monthlyVehicleCosts.dec) |
| L12 | Jan | 420 | gl-cor:amount (monthlyVehicleCosts.jan) |
| M12 | Feb | 420 | gl-cor:amount (monthlyVehicleCosts.feb) |
| N12 | Mar | 420 | gl-cor:amount (monthlyVehicleCosts.mar) |
| C22 | Apr | 520 | gl-cor:amount (monthlyRunningCosts.apr) |
| D22 | May | 0 | gl-cor:amount (monthlyRunningCosts.may) |
| E22 | Jun | 0 | gl-cor:amount (monthlyRunningCosts.jun) |
| F22 | Jul | 120 | gl-cor:amount (monthlyRunningCosts.jul) |
| G22 | Aug | 0 | gl-cor:amount (monthlyRunningCosts.aug) |
| H22 | Sep | 0 | gl-cor:amount (monthlyRunningCosts.sep) |
| I22 | Oct | 120 | gl-cor:amount (monthlyRunningCosts.oct) |
| J22 | Nov | 0 | gl-cor:amount (monthlyRunningCosts.nov) |
| K22 | Dec | 0 | gl-cor:amount (monthlyRunningCosts.dec) |
| L22 | Jan | 620 | gl-cor:amount (monthlyRunningCosts.jan) |
| M22 | Feb | 0 | gl-cor:amount (monthlyRunningCosts.feb) |
| N22 | Mar | 0 | gl-cor:amount (monthlyRunningCosts.mar) |
...
| H24 | Sep | 500 | gl-cor:amount (monthlyOtherIncome.sep) |
...
| Cell | DIY Label | Value | diya-gl mapping |
|------|-----------|-------|-----------------|
| C5 | Q1 Turnover | 9045 | gl-cor:amount (vitalTax.q1Turnover) |
...
| G5 | **Annual Turnover** | 36045 | gl-cor:amount (vitalTax.annualTurnover) |
| C6 | Q1 Other income | 0 | gl-cor:amount (vitalTax.q1OtherIncome) |
| D6 | Q2 Other income | 500 | gl-cor:amount (vitalTax.q2OtherIncome) |
| E6 | Q3 Other income | 0 | gl-cor:amount (vitalTax.q3OtherIncome) |
| F6 | Q4 Other income | 0 | gl-cor:amount (vitalTax.q4OtherIncome) |
| G6 | **Annual Other income** | 500 | gl-cor:amount (vitalTax.annualOtherIncome) |
| C29 | Q1 Total Allowable Expenses | 3160 | gl-cor:amount (vitalTax.q1Expenses) |
| D29 | Q2 Total Allowable Expenses | 1380 | gl-cor:amount (vitalTax.q2Expenses) |
| E29 | Q3 Total Allowable Expenses | 1380 | gl-cor:amount (vitalTax.q3Expenses) |
| F29 | Q4 Total Allowable Expenses | 1880 | gl-cor:amount (vitalTax.q4Expenses) |
| G29 | **Annual Total Allowable Expenses** | 7800 | gl-cor:amount (vitalTax.annualExpenses) |

### SE Short

| Cell | DIY Label | Value | diya-gl mapping |
|------|-----------|-------|-----------------|
| D38 | Turnover (box 9) | 36045 | gl-cor:amount (sa103s.turnover) |
| D71 | **Net profit/loss (box 21)** | 29685 | gl-cor:amount (sa103s.netProfit) |
...
| D85 | Small-balance allowance (box 24) | 0 | tax.capitalAllowances.smallPool (sa103s) |
| O80 | Other capital allowances (box 25) | 1440 | tax.capitalAllowances.wda (sa103s) |
...
| D99 | **Net business profit (box 28)** | 28245 | gl-cor:amount (sa103s.taxableProfit) |
| O94 | Loss brought forward (box 29) | 0 | gl-cor:amount (sa103s.lossBroughtForward) |
| O99 | Other business income (box 30) | 500 | gl-cor:amount (sa103s.otherBusinessIncome) |
| D106 | **Net profit for tax calc (box 31)** | 28745 | gl-cor:amount (sa103s.profitForTax) |

### Draft Tax calculation

| Cell | DIY Label | Value | diya-gl mapping |
|------|-----------|-------|-----------------|
| E5 | Profit from Self Employment | 28745 | gl-cor:amount (profitSE) |
| E6 | Less: Personal Allowance | 12570 | tax.incomeTax.personalAllowance |
| E7 | Taxable Income | 16175 | gl-cor:amount (taxableIncome) |
...
| E8 | Tax at Basic Rate | 3235 | tax.incomeTax.basicRate |
| E9 | Tax at Higher Rate | 0 | tax.incomeTax.higherRate |
| E10 | Tax at Additional Rate | 0 | tax.incomeTax.additionalRate |
| E11 | **Total Income Tax** | 3235 | tax.incomeTax (total) |
| E14 | NI Class 4 (lower band) | 1725.93 | tax.nationalInsurance.class4MainRate |
| E15 | NI Class 4 (upper band) | 0 | tax.nationalInsurance.class4UpperRate |
| E17 | **Total Tax + NI** | 4960.93 | gl-cor:taxAmount (totalTaxNI) |
| E25 | First payment on account (31 January) | 2480.465 | gl-cor:taxAmount (paymentOnAccount1) |
| E26 | Second payment on account (31 July) | 2480.465 | gl-cor:taxAmount (paymentOnAccount2) |
...
| C20 | Forecast Sales Turnover | 36045 | gl-cor:amount (forecast.turnover) |
| C22 | Forecast Investment Grants | 500 | gl-cor:amount (forecast.otherIncome) |
...
| C30 | **Forecast Profit before Tax** | 28745 | gl-cor:amount (forecast.profit) |
| C34 | Profit before Tax | 28745 | gl-cor:amount (forecast.taxableProfit) |
| C35 | Personal Allowance | 12570 | tax.incomeTax.personalAllowance |
| C36 | Profit after Allowance | 16175 | gl-cor:amount (forecast.taxableIncome) |
| C37 | Tax at standard rate | 3235 | tax.incomeTax.basicRate |
| C38 | Tax at higher rate | 0 | tax.incomeTax.higherRate |
| C39 | Tax at additional rate | 0 | tax.incomeTax.additionalRate |
| C40 | National Insurance | 1725.93 | tax.nationalInsurance.class4 |
| C41 | **Forecast Tax & NI Liability** | 4960.93 | gl-cor:taxAmount (forecast.totalTaxNI) |
...
| K1 | Written-down value carried forward | 6560 | fixedAssets (writtenDownValue) |
