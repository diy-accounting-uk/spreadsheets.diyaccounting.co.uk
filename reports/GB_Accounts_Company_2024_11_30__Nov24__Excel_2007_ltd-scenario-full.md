...
# Reconciliation Report: GB Accounts Company 2024-11-30 (Nov24) Excel 2007
...
| VAT Q1: payment due date (G7) = Vatinterface final date for payment (C8) | 45382 | 45382 | 0 | PASS |
...
| VAT Q2: payment due date (G7) = Vatinterface final date for payment (C11) | 45473 | 45473 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 45565 | 45565 | 0 | PASS |
...
| VAT Q4: payment due date (G7) = Vatinterface final date for payment (C17) | 45657 | 45657 | 0 | PASS |
...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C20) | 45747 | 45747 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 45626 | 45626 | 0 | PASS |
...
| Board minute: meeting date = the scenario's board meeting | 45626 | 45626 | 0 | PASS |
...
| Payslips!Nov K69 the monthly payroll opens in the accounting period's Nov | 45597 | 45597 | 0 | PASS |
...
| Payslips print: the period ends the day the scenario paid that month's wages | 45322 | 45322 | 0 | PASS |
...
| Payslips print: the payment date is the day the scenario paid that month's wages | 45322 | 45322 | 0 | PASS |
...
| Payslips!Mar M49 wages paid date | 45382 | 45382 | 0 | PASS |
...
| Payslips!Apr M49 wages paid date | 45412 | 45412 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 45626 | 45626 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 45626 | 45626 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 45626 | 45626 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 45626 | 45626 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 45626 | 45626 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 366 | +1 | PASS |
| Admin: first financial year row starts at the accounting period start | 45261 | 45261 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 45383 | 45383 | 0 | PASS |
| Admin: second financial year row ends at the year end | 45626 | 45626 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 45261 | 45261 | 0 | PASS |
| CT: working sheet heading ends at the year end | 45626 | 45626 | 0 | PASS |
| CT: the two tax rows span the accounting period | 366 | 366 | 0 | PASS |
| CT600: return period starts at the accounting period start | 45261 | 45261 | 0 | PASS |
| CT600: return period ends at the year end | 45626 | 45626 | 0 | PASS |
...
| CT600: amount of profit = first tax row profit | 41376.077057613 | 41376.077057613 | 0 | PASS |
| CT600: tax rate = first tax row rate | 25 | 25 | 0 | PASS |
| CT600: corporation tax = first tax row gross tax | 10344.0192644033 | 10344.0192644033 | 0 | PASS |
| CT600: second financial year tax = second tax row gross tax | 20688.0385288065 | 20688.0385288065 | 0 | PASS |
| CT600: second financial year = second tax row financial year | 2024 | 2024 | 0 | PASS |
| CT600: second financial year profit = second tax row profit | 82752.1541152261 | 82752.1541152261 | 0 | PASS |
...
| CT: first tax row profit = chargeable profit by its share of those days | 41376.077057613 | 41376.077057613 | 0 | PASS |
| CT: second tax row profit = chargeable profit by its share of those days | 82752.154115226 | 82752.1541152261 | +1.0186340659856796e-10 | PASS |
| CT: first tax row gross tax = its profit at its rate | 10344.01926440325 | 10344.0192644033 | +4.9112713895738125e-11 | PASS |
| CT: second tax row gross tax = its profit at its rate | 20688.038528806526 | 20688.0385288065 | -2.546585164964199e-11 | PASS |
| CT: first tax row tax = its gross tax less its marginal relief | 9888.11706922907 | 9888.11706922903 | -4.001776687800884e-11 | PASS |
| CT: second tax row tax = its gross tax less its marginal relief | 19776.234138458043 | 19776.2341384581 | +5.820766091346741e-11 | PASS |
...
| CT: first tax row marginal relief = its share of the augmented profits against its share of the limits | 455.90219517422906 | 455.902195174228 | -1.0800249583553523e-12 | PASS |
| CT: second tax row marginal relief = its share of the augmented profits against its share of the limits | 911.8043903484592 | 911.804390348457 | -2.1600499167107046e-12 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Box 335: amount of profit | 41,376.08 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 340: rate of tax | 25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 345: tax | 10,344.02 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 380: financial year | 2,024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 385: amount of profit | 82,752.15 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 390: rate of tax | 25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 395: tax | 20,688.04 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 covers the periods ending | 31 December 2023, 31 January 2024, 29 February 2024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 covers the periods ending | 31 March 2024, 30 April 2024, 31 May 2024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 covers the periods ending | 30 June 2024, 31 July 2024, 31 August 2024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 covers the periods ending | 30 September 2024, 31 October 2024, 30 November 2024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 covers the periods ending | 31 December 2024, 31 January 2025, 28 February 2025 |
| The returns above also cover the periods ending 31 December 2024, 31 January 2025, 28 February 2025, which fall outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 180 |
| **The return forms as the package fills them in** |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 29 February 2024) box 1: VAT due on sales | 16,920 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 29 February 2024) box 4: VAT reclaimed on purchases | 6,023.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 29 February 2024) box 5: net VAT due | 10,896.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 May 2024) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 May 2024) box 4: VAT reclaimed on purchases | 4,531.58 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 May 2024) box 5: net VAT due | 12,725.08 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 August 2024) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 August 2024) box 4: VAT reclaimed on purchases | 9,895.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 August 2024) box 5: net VAT due | 9,884.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 November 2024) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 November 2024) box 4: VAT reclaimed on purchases | 2,105.71 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 November 2024) box 5: net VAT due | 14,754.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 28 February 2025) box 1: VAT due on sales | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 28 February 2025) box 4: VAT reclaimed on purchases | 180 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 28 February 2025) box 5: net VAT due | 920 |
...
| E34 |  | 2024 |  |
| F33 |  | 41376.077057613 |  |
| F34 |  | 82752.1541152261 |  |
| G33 |  | 25 |  |
| G34 |  | 25 |  |
| J33 |  | 10344.0192644033 |  |
| J34 |  | 20688.0385288065 |  |
| L33 |  | 455.902195174228 |  |
| L34 |  | 911.804390348457 |  |
| I33 |  | 9888.11706922903 |  |
| I34 |  | 19776.2341384581 |  |
...
| N126 | Box 335: amount of profit | 41376.077057613 | gl-cor:amount (ct600.box335) |
| AA126 | Box 340: rate of tax | 25 | gl-cor:rate (ct600.box340) |
| AJ126 | Box 345: tax | 10344.0192644033 | gl-cor:taxAmount (ct600.box345) |
| C128 | Box 380: financial year | 2024 | gl-cor:period (ct600.box380) |
| N128 | Box 385: amount of profit | 82752.1541152261 | gl-cor:amount (ct600.box385) |
| AA128 | Box 390: rate of tax | 25 | gl-cor:rate (ct600.box390) |
| AJ128 | Box 395: tax | 20688.0385288065 | gl-cor:taxAmount (ct600.box395) |
