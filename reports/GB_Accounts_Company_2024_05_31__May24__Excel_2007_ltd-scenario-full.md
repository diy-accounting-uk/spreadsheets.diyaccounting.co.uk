...
# Reconciliation Report: GB Accounts Company 2024-05-31 (May24) Excel 2007
...
| VAT Q1: payment due date (G7) = Vatinterface final date for payment (C8) | 45199 | 45199 | 0 | PASS |
...
| VAT Q2: payment due date (G7) = Vatinterface final date for payment (C11) | 45291 | 45291 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 45382 | 45382 | 0 | PASS |
...
| VAT Q4: payment due date (G7) = Vatinterface final date for payment (C17) | 45473 | 45473 | 0 | PASS |
...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C20) | 45565 | 45565 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 45443 | 45443 | 0 | PASS |
...
| Board minute: meeting date = the scenario's board meeting | 45443 | 45443 | 0 | PASS |
...
| Payslips!Jun K49 the monthly payroll opens in the accounting period's Jun | 45078 | 45078 | 0 | PASS |
| Payslips!Jul K49 the monthly payroll opens in the accounting period's Jul | 45108 | 45108 | 0 | PASS |
| Payslips!Aug K59 the monthly payroll opens in the accounting period's Aug | 45139 | 45139 | 0 | PASS |
...
| Payslips!Nov K59 the monthly payroll opens in the accounting period's Nov | 45231 | 45231 | 0 | PASS |
...
| Payslips!Feb K59 the monthly payroll opens in the accounting period's Feb | 45323 | 45323 | 0 | PASS |
...
| Payslips!May K69 the monthly payroll opens in the accounting period's May | 45413 | 45413 | 0 | PASS |
...
| Payslips print: the period ends the day the scenario paid that month's wages | 45138 | 45138 | 0 | PASS |
...
| Payslips print: the payment date is the day the scenario paid that month's wages | 45138 | 45138 | 0 | PASS |
...
| Payslips!Sep M49 wages paid date | 45199 | 45199 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 45443 | 45443 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 45443 | 45443 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 45443 | 45443 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 45443 | 45443 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 45443 | 45443 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 366 | +1 | PASS |
| Admin: first financial year row starts at the accounting period start | 45078 | 45078 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 45383 | 45383 | 0 | PASS |
| Admin: second financial year row ends at the year end | 45443 | 45443 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 45078 | 45078 | 0 | PASS |
| CT: working sheet heading ends at the year end | 45443 | 45443 | 0 | PASS |
| CT: the two tax rows span the accounting period | 366 | 366 | 0 | PASS |
| CT600: return period starts at the accounting period start | 45078 | 45078 | 0 | PASS |
| CT600: return period ends at the year end | 45443 | 45443 | 0 | PASS |
...
| CT600: amount of profit = first tax row profit | 103440.192644033 | 103440.192644033 | 0 | PASS |
| CT600: tax rate = first tax row rate | 25 | 25 | 0 | PASS |
| CT600: corporation tax = first tax row gross tax | 25860.0481610081 | 25860.0481610081 | 0 | PASS |
| CT600: second financial year tax = second tax row gross tax | 5172.00963220163 | 5172.00963220163 | 0 | PASS |
| CT600: second financial year = second tax row financial year | 2024 | 2024 | 0 | PASS |
| CT600: second financial year profit = second tax row profit | 20688.0385288065 | 20688.0385288065 | 0 | PASS |
...
| CT600: tax payable = tax chargeable | 31032.05779320973 | 31032.0577932098 | +6.912159733474255e-11 | PASS |
| CT600: marginal rate relief = the working sheet's relief | 1367.706585522684 | 1367.70658552269 | +5.9117155615240335e-12 | PASS |
...
| CT: first tax row profit = chargeable profit by its share of those days | 103440.1926440325 | 103440.192644033 | +4.94765117764473e-10 | PASS |
| CT: second tax row profit = chargeable profit by its share of those days | 20688.0385288065 | 20688.0385288065 | 0 | PASS |
| CT: first tax row gross tax = its profit at its rate | 25860.04816100825 | 25860.0481610081 | -1.4915713109076023e-10 | PASS |
| CT: second tax row gross tax = its profit at its rate | 5172.009632201625 | 5172.00963220163 | +4.547473508864641e-12 | PASS |
| CT: first tax row tax = its gross tax less its marginal relief | 24720.29267307253 | 24720.2926730726 | +6.912159733474255e-11 | PASS |
| CT: second tax row tax = its gross tax less its marginal relief | 4944.058534614515 | 4944.05853461452 | +4.547473508864641e-12 | PASS |
...
| CT: first tax row marginal relief = its share of the augmented profits against its share of the limits | 1139.7554879355782 | 1139.75548793557 | -8.185452315956354e-12 | PASS |
| CT: second tax row marginal relief = its share of the augmented profits against its share of the limits | 227.95109758711453 | 227.951097587114 | -5.400124791776761e-13 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Box 335: amount of profit | 103,440.19 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 340: rate of tax | 25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 345: tax | 25,860.05 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 380: financial year | 2,024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 385: amount of profit | 20,688.04 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 390: rate of tax | 25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 395: tax | 5,172.01 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 covers the periods ending | 30 June 2023, 31 July 2023, 31 August 2023 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 covers the periods ending | 30 September 2023, 31 October 2023, 30 November 2023 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 covers the periods ending | 31 December 2023, 31 January 2024, 29 February 2024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 covers the periods ending | 31 March 2024, 30 April 2024, 31 May 2024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 covers the periods ending | 30 June 2024, 31 July 2024, 31 August 2024 |
| The returns above also cover the periods ending 30 June 2024, 31 July 2024, 31 August 2024, which fall outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 180 |
| **The return forms as the package fills them in** |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 August 2023) box 1: VAT due on sales | 16,920 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 August 2023) box 4: VAT reclaimed on purchases | 6,023.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 August 2023) box 5: net VAT due | 10,896.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 November 2023) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 November 2023) box 4: VAT reclaimed on purchases | 4,531.58 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 November 2023) box 5: net VAT due | 12,725.08 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 29 February 2024) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 29 February 2024) box 4: VAT reclaimed on purchases | 9,895.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 29 February 2024) box 5: net VAT due | 9,884.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 May 2024) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 May 2024) box 4: VAT reclaimed on purchases | 2,105.71 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 May 2024) box 5: net VAT due | 14,754.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 August 2024) box 1: VAT due on sales | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 August 2024) box 4: VAT reclaimed on purchases | 180 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 August 2024) box 5: net VAT due | 920 |
...
| E33 |  | 2023 |  |
| E34 |  | 2024 |  |
| F33 |  | 103440.192644033 |  |
| F34 |  | 20688.0385288065 |  |
| G33 |  | 25 |  |
| G34 |  | 25 |  |
| J33 |  | 25860.0481610081 |  |
| J34 |  | 5172.00963220163 |  |
| L33 |  | 1139.75548793557 |  |
| L34 |  | 227.951097587114 |  |
| I33 |  | 24720.2926730726 |  |
| I34 |  | 4944.05853461452 |  |
...
| N126 | Box 335: amount of profit | 103440.192644033 | gl-cor:amount (ct600.box335) |
| AA126 | Box 340: rate of tax | 25 | gl-cor:rate (ct600.box340) |
| AJ126 | Box 345: tax | 25860.0481610081 | gl-cor:taxAmount (ct600.box345) |
| C128 | Box 380: financial year | 2024 | gl-cor:period (ct600.box380) |
| N128 | Box 385: amount of profit | 20688.0385288065 | gl-cor:amount (ct600.box385) |
| AA128 | Box 390: rate of tax | 25 | gl-cor:rate (ct600.box390) |
| AJ128 | Box 395: tax | 5172.00963220163 | gl-cor:taxAmount (ct600.box395) |
