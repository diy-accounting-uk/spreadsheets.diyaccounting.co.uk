...
| | Amount |
|---|------:|
| Audit Accuracy Check | -1,788,709 |
...
| D29 | Directors Loan | 1897369 | accounts.liabilities.2500 (pubBS) |
...
| Cell | DIY Label | Value | diya-gl mapping |
|------|-----------|-------|-----------------|
| EJ91 | Audit Accuracy Check | -1788709 | gl-cor:amount (trialBalanceCheck) |
