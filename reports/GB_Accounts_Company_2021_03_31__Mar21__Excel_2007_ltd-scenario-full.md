...
# Reconciliation Report: GB Accounts Company 2021-03-31 (Mar21) Excel 2007
...
| Vatinterface H10: Aug purchases net = Purchases.xlsx Aug | 3962.70833333333 | 3962.70833333333 | 0 | PASS |
| Vatinterface J10: Aug input VAT = Purchases.xlsx Aug | 792.541666666667 | 792.541666666667 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 44227 | 44227 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 44286 | 44286 | 0 | PASS |
...
| Board minute: meeting date = the scenario's board meeting | 44286 | 44286 | 0 | PASS |
...
| P&L Apr C7 = Sales.xlsx "d" net | 700 | 700 | 0 | PASS |
| P&L Apr C8 = Sales.xlsx "g" net | 0 | 0 | 0 | PASS |
| P&L Apr C34 = negated Sales.xlsx "o" net | 0 | 0 | 0 | PASS |
| P&L May D4 = Sales.xlsx "a" net | 25633.33 | 25633.3333333333 | +0.0033333332976326346 | PASS |
| P&L May D5 = Sales.xlsx "b" net | 800 | 800 | 0 | PASS |
| P&L May D6 = Sales.xlsx "c" net | 1000 | 1000 | 0 | PASS |
...
| P&L Jun E4 = Sales.xlsx "a" net | 26533.33 | 26533.3333333333 | +0.0033333332976326346 | PASS |
| P&L Jun E5 = Sales.xlsx "b" net | 800 | 800 | 0 | PASS |
| P&L Jun E6 = Sales.xlsx "c" net | 2000 | 2000 | 0 | PASS |
...
| P&L Jul F4 = Sales.xlsx "a" net | 25633.33 | 25633.3333333333 | +0.0033333332976326346 | PASS |
| P&L Jul F5 = Sales.xlsx "b" net | 1800 | 1800 | 0 | PASS |
| P&L Jul F6 = Sales.xlsx "c" net | 0 | 0 | 0 | PASS |
| P&L Jul F7 = Sales.xlsx "d" net | 700 | 700 | 0 | PASS |
| P&L Jul F8 = Sales.xlsx "g" net | 0 | 0 | 0 | PASS |
| P&L Jul F34 = negated Sales.xlsx "o" net | 0 | 0 | 0 | PASS |
| P&L Aug G4 = Sales.xlsx "a" net | 27133.33 | 27133.3333333333 | +0.0033333332976326346 | PASS |
| P&L Aug G5 = Sales.xlsx "b" net | 800 | 800 | 0 | PASS |
| P&L Aug G6 = Sales.xlsx "c" net | 0 | 0 | 0 | PASS |
| P&L Aug G7 = Sales.xlsx "d" net | 0 | 0 | 0 | PASS |
| P&L Aug G8 = Sales.xlsx "g" net | 2083.33 | 2083.33333333333 | +0.0033333333299196966 | PASS |
| P&L Aug G34 = negated Sales.xlsx "o" net | 0 | 0 | 0 | PASS |
| P&L Sep H4 = Sales.xlsx "a" net | 25033.33 | 25033.3333333333 | +0.0033333332976326346 | PASS |
| P&L Sep H5 = Sales.xlsx "b" net | 800 | 800 | 0 | PASS |
| P&L Sep H6 = Sales.xlsx "c" net | 1800 | 1800 | 0 | PASS |
| P&L Sep H7 = Sales.xlsx "d" net | 500 | 500 | 0 | PASS |
| P&L Sep H8 = Sales.xlsx "g" net | 0 | 0 | 0 | PASS |
| P&L Sep H34 = negated Sales.xlsx "o" net | 0 | 0 | 0 | PASS |
| P&L Oct I4 = Sales.xlsx "a" net | 27133.33 | 27133.3333333333 | +0.0033333332976326346 | PASS |
| P&L Oct I5 = Sales.xlsx "b" net | 1800 | 1800 | 0 | PASS |
| P&L Oct I6 = Sales.xlsx "c" net | 0 | 0 | 0 | PASS |
| P&L Oct I7 = Sales.xlsx "d" net | 700 | 700 | 0 | PASS |
| P&L Oct I8 = Sales.xlsx "g" net | 0 | 0 | 0 | PASS |
| P&L Oct I34 = negated Sales.xlsx "o" net | 0 | 0 | 0 | PASS |
| P&L Nov J4 = Sales.xlsx "a" net | 25633.33 | 25633.3333333333 | +0.0033333332976326346 | PASS |
| P&L Nov J5 = Sales.xlsx "b" net | 800 | 800 | 0 | PASS |
| P&L Nov J6 = Sales.xlsx "c" net | 3000 | 3000 | 0 | PASS |
...
| P&L Dec K4 = Sales.xlsx "a" net | 26533.33 | 26533.3333333333 | +0.0033333332976326346 | PASS |
| P&L Dec K5 = Sales.xlsx "b" net | 800 | 800 | 0 | PASS |
...
| P&L Jan L4 = Sales.xlsx "a" net | 25633.33 | 25633.3333333333 | +0.0033333332976326346 | PASS |
| P&L Jan L5 = Sales.xlsx "b" net | 1800 | 1800 | 0 | PASS |
| P&L Jan L6 = Sales.xlsx "c" net | 1000 | 1000 | 0 | PASS |
| P&L Jan L7 = Sales.xlsx "d" net | 1100 | 1100 | 0 | PASS |
| P&L Jan L8 = Sales.xlsx "g" net | 0 | 0 | 0 | PASS |
| P&L Jan L34 = negated Sales.xlsx "o" net | 0 | 0 | 0 | PASS |
| P&L Feb M4 = Sales.xlsx "a" net | 26333.33 | 26333.3333333333 | +0.0033333332976326346 | PASS |
| P&L Feb M5 = Sales.xlsx "b" net | 800 | 800 | 0 | PASS |
| P&L Feb M6 = Sales.xlsx "c" net | 1500 | 1500 | 0 | PASS |
...
| P&L Mar N4 = Sales.xlsx "a" net | 25033.33 | 25033.3333333333 | +0.0033333332976326346 | PASS |
| P&L Mar N5 = Sales.xlsx "b" net | 800 | 800 | 0 | PASS |
| P&L Mar N6 = Sales.xlsx "c" net | 0 | 0 | 0 | PASS |
| P&L Mar N7 = Sales.xlsx "d" net | 0 | 0 | 0 | PASS |
| P&L Mar N8 = Sales.xlsx "g" net | 0 | 0 | 0 | PASS |
| P&L Mar N34 = negated Sales.xlsx "o" net | -300 | -300 | 0 | PASS |
| P&L Apr C12 = Purchases.xlsx "c" net | 0 | 0 | 0 | PASS |
| P&L Apr C13 = Purchases.xlsx "o" net | 237.5 | 237.5 | 0 | PASS |
| P&L Apr C21 = Purchases.xlsx "r" net | 1000 | 1000 | 0 | PASS |
...
| P&L Apr C25 = Purchases.xlsx "m" net | 100 | 100 | 0 | PASS |
| P&L Apr C26 = Purchases.xlsx "u" net | 130.83 | 130.833333333333 | +0.003333333332989241 | PASS |
| P&L Apr C27 = Purchases.xlsx "a" net | 0 | 0 | 0 | PASS |
| P&L Apr C28 = Purchases.xlsx "g" net | 112.5 | 112.5 | 0 | PASS |
| P&L Apr C29 = Purchases.xlsx "h" net | 76.67 | 76.6666666666667 | -0.00333333333330188 | PASS |
| P&L Apr C30 = Purchases.xlsx "v" net | 501.88 | 501.875 | -0.0049999999999954525 | PASS |
| P&L Apr C31 = Purchases.xlsx "n" net | 1200 | 1200 | 0 | PASS |
| P&L Apr C32 = Purchases.xlsx "f" net | 150 | 150 | 0 | PASS |
| P&L Apr C33 = Purchases.xlsx "l" net | 250 | 250 | 0 | PASS |
| P&L Apr C37 = Purchases.xlsx "y" net | 0 | 0 | 0 | PASS |
| P&L Apr C38 = Purchases.xlsx "z" net | 0 | 0 | 0 | PASS |
| P&L May D12 = Purchases.xlsx "c" net | 0 | 0 | 0 | PASS |
| P&L May D13 = Purchases.xlsx "o" net | 207.5 | 207.5 | 0 | PASS |
| P&L May D21 = Purchases.xlsx "r" net | 1000 | 1000 | 0 | PASS |
| P&L May D22 = Purchases.xlsx "p" net | 0 | 0 | 0 | PASS |
| P&L May D23 = Purchases.xlsx "t" net | 150 | 150 | 0 | PASS |
| P&L May D24 = Purchases.xlsx "q" net | 200 | 200 | 0 | PASS |
| P&L May D25 = Purchases.xlsx "m" net | 0 | 0 | 0 | PASS |
| P&L May D26 = Purchases.xlsx "u" net | 95.83 | 95.8333333333333 | +0.00333333333330188 | PASS |
| P&L May D27 = Purchases.xlsx "a" net | 500 | 500 | 0 | PASS |
| P&L May D28 = Purchases.xlsx "g" net | 127.5 | 127.5 | 0 | PASS |
| P&L May D29 = Purchases.xlsx "h" net | 126.67 | 126.666666666667 | -0.003333333333003452 | PASS |
| P&L May D30 = Purchases.xlsx "v" net | 555 | 555 | 0 | PASS |
| P&L May D31 = Purchases.xlsx "n" net | 0 | 0 | 0 | PASS |
| P&L May D32 = Purchases.xlsx "f" net | 0 | 0 | 0 | PASS |
| P&L May D33 = Purchases.xlsx "l" net | 250 | 250 | 0 | PASS |
| P&L May D37 = Purchases.xlsx "y" net | 0 | 0 | 0 | PASS |
| P&L May D38 = Purchases.xlsx "z" net | 0 | 0 | 0 | PASS |
| P&L Jun E12 = Purchases.xlsx "c" net | 4166.67 | 4166.66666666667 | -0.003333333330374444 | PASS |
| P&L Jun E13 = Purchases.xlsx "o" net | 237.5 | 237.5 | 0 | PASS |
| P&L Jun E21 = Purchases.xlsx "r" net | 1000 | 1000 | 0 | PASS |
| P&L Jun E22 = Purchases.xlsx "p" net | 300 | 300 | 0 | PASS |
...
| P&L Jun E26 = Purchases.xlsx "u" net | 120.83 | 120.833333333333 | +0.003333333333003452 | PASS |
| P&L Jun E27 = Purchases.xlsx "a" net | 0 | 0 | 0 | PASS |
| P&L Jun E28 = Purchases.xlsx "g" net | 192.5 | 192.5 | 0 | PASS |
| P&L Jun E29 = Purchases.xlsx "h" net | 226.67 | 226.666666666667 | -0.003333333332989241 | PASS |
| P&L Jun E30 = Purchases.xlsx "v" net | 545 | 545 | 0 | PASS |
| P&L Jun E31 = Purchases.xlsx "n" net | 0 | 0 | 0 | PASS |
| P&L Jun E32 = Purchases.xlsx "f" net | 0 | 0 | 0 | PASS |
| P&L Jun E33 = Purchases.xlsx "l" net | 458.33 | 458.333333333333 | +0.003333333332989241 | PASS |
...
| P&L Jul F13 = Purchases.xlsx "o" net | 207.5 | 207.5 | 0 | PASS |
| P&L Jul F21 = Purchases.xlsx "r" net | 1000 | 1000 | 0 | PASS |
| P&L Jul F22 = Purchases.xlsx "p" net | 0 | 0 | 0 | PASS |
| P&L Jul F23 = Purchases.xlsx "t" net | 100 | 100 | 0 | PASS |
| P&L Jul F24 = Purchases.xlsx "q" net | 400 | 400 | 0 | PASS |
| P&L Jul F25 = Purchases.xlsx "m" net | 150 | 150 | 0 | PASS |
| P&L Jul F26 = Purchases.xlsx "u" net | 95.83 | 95.8333333333333 | +0.00333333333330188 | PASS |
| P&L Jul F27 = Purchases.xlsx "a" net | 400 | 400 | 0 | PASS |
| P&L Jul F28 = Purchases.xlsx "g" net | 132.5 | 132.5 | 0 | PASS |
| P&L Jul F29 = Purchases.xlsx "h" net | 76.67 | 76.6666666666667 | -0.00333333333330188 | PASS |
| P&L Jul F30 = Purchases.xlsx "v" net | 486.88 | 486.875 | -0.0049999999999954525 | PASS |
| P&L Jul F31 = Purchases.xlsx "n" net | 0 | 0 | 0 | PASS |
| P&L Jul F32 = Purchases.xlsx "f" net | 150 | 150 | 0 | PASS |
| P&L Jul F33 = Purchases.xlsx "l" net | 250 | 250 | 0 | PASS |
| P&L Jul F37 = Purchases.xlsx "y" net | 0 | 0 | 0 | PASS |
| P&L Jul F38 = Purchases.xlsx "z" net | 2500 | 2500 | 0 | PASS |
| P&L Aug G12 = Purchases.xlsx "c" net | 0 | 0 | 0 | PASS |
| P&L Aug G13 = Purchases.xlsx "o" net | 237.5 | 237.5 | 0 | PASS |
| P&L Aug G21 = Purchases.xlsx "r" net | 1000 | 1000 | 0 | PASS |
...
| P&L Aug G25 = Purchases.xlsx "m" net | 200 | 200 | 0 | PASS |
| P&L Aug G26 = Purchases.xlsx "u" net | 135.83 | 135.833333333333 | +0.003333333332989241 | PASS |
| P&L Aug G27 = Purchases.xlsx "a" net | 291.67 | 291.666666666667 | -0.003333333332989241 | PASS |
| P&L Aug G28 = Purchases.xlsx "g" net | 112.5 | 112.5 | 0 | PASS |
| P&L Aug G29 = Purchases.xlsx "h" net | 116.67 | 116.666666666667 | -0.003333333333003452 | PASS |
| P&L Aug G30 = Purchases.xlsx "v" net | 501.88 | 501.875 | -0.0049999999999954525 | PASS |
| P&L Aug G31 = Purchases.xlsx "n" net | 0 | 0 | 0 | PASS |
| P&L Aug G32 = Purchases.xlsx "f" net | 0 | 0 | 0 | PASS |
| P&L Aug G33 = Purchases.xlsx "l" net | 250 | 250 | 0 | PASS |
...
| P&L Sep H13 = Purchases.xlsx "o" net | 207.5 | 207.5 | 0 | PASS |
| P&L Sep H21 = Purchases.xlsx "r" net | 1000 | 1000 | 0 | PASS |
| P&L Sep H22 = Purchases.xlsx "p" net | 250 | 250 | 0 | PASS |
| P&L Sep H23 = Purchases.xlsx "t" net | 80 | 80 | 0 | PASS |
| P&L Sep H24 = Purchases.xlsx "q" net | 300 | 300 | 0 | PASS |
| P&L Sep H25 = Purchases.xlsx "m" net | 0 | 0 | 0 | PASS |
| P&L Sep H26 = Purchases.xlsx "u" net | 95.83 | 95.8333333333333 | +0.00333333333330188 | PASS |
| P&L Sep H27 = Purchases.xlsx "a" net | 0 | 0 | 0 | PASS |
| P&L Sep H28 = Purchases.xlsx "g" net | 122.5 | 122.5 | 0 | PASS |
| P&L Sep H29 = Purchases.xlsx "h" net | 76.67 | 76.6666666666667 | -0.00333333333330188 | PASS |
| P&L Sep H30 = Purchases.xlsx "v" net | 590 | 590 | 0 | PASS |
| P&L Sep H31 = Purchases.xlsx "n" net | 0 | 0 | 0 | PASS |
| P&L Sep H32 = Purchases.xlsx "f" net | 0 | 0 | 0 | PASS |
| P&L Sep H33 = Purchases.xlsx "l" net | 1223.33 | 1223.33333333333 | +0.0033333333301470702 | PASS |
...
| P&L Oct I13 = Purchases.xlsx "o" net | 237.5 | 237.5 | 0 | PASS |
| P&L Oct I21 = Purchases.xlsx "r" net | 1000 | 1000 | 0 | PASS |
...
| P&L Oct I25 = Purchases.xlsx "m" net | 80 | 80 | 0 | PASS |
| P&L Oct I26 = Purchases.xlsx "u" net | 125.83 | 125.833333333333 | +0.003333333333003452 | PASS |
| P&L Oct I27 = Purchases.xlsx "a" net | 2500 | 2500 | 0 | PASS |
| P&L Oct I28 = Purchases.xlsx "g" net | 112.5 | 112.5 | 0 | PASS |
| P&L Oct I29 = Purchases.xlsx "h" net | 176.67 | 176.666666666667 | -0.003333333332989241 | PASS |
| P&L Oct I30 = Purchases.xlsx "v" net | 505.63 | 505.625 | -0.0049999999999954525 | PASS |
| P&L Oct I31 = Purchases.xlsx "n" net | 300 | 300 | 0 | PASS |
| P&L Oct I32 = Purchases.xlsx "f" net | 150 | 150 | 0 | PASS |
| P&L Oct I33 = Purchases.xlsx "l" net | 250 | 250 | 0 | PASS |
| P&L Oct I37 = Purchases.xlsx "y" net | 0 | 0 | 0 | PASS |
| P&L Oct I38 = Purchases.xlsx "z" net | 0 | 0 | 0 | PASS |
| P&L Nov J12 = Purchases.xlsx "c" net | 2500 | 2500 | 0 | PASS |
| P&L Nov J13 = Purchases.xlsx "o" net | 207.5 | 207.5 | 0 | PASS |
| P&L Nov J21 = Purchases.xlsx "r" net | 1000 | 1000 | 0 | PASS |
| P&L Nov J22 = Purchases.xlsx "p" net | 0 | 0 | 0 | PASS |
| P&L Nov J23 = Purchases.xlsx "t" net | 200 | 200 | 0 | PASS |
| P&L Nov J24 = Purchases.xlsx "q" net | 0 | 0 | 0 | PASS |
| P&L Nov J25 = Purchases.xlsx "m" net | 0 | 0 | 0 | PASS |
| P&L Nov J26 = Purchases.xlsx "u" net | 95.83 | 95.8333333333333 | +0.00333333333330188 | PASS |
| P&L Nov J27 = Purchases.xlsx "a" net | 0 | 0 | 0 | PASS |
| P&L Nov J28 = Purchases.xlsx "g" net | 137.5 | 137.5 | 0 | PASS |
| P&L Nov J29 = Purchases.xlsx "h" net | 136.67 | 136.666666666667 | -0.003333333332989241 | PASS |
| P&L Nov J30 = Purchases.xlsx "v" net | 537.5 | 537.5 | 0 | PASS |
| P&L Nov J31 = Purchases.xlsx "n" net | 0 | 0 | 0 | PASS |
| P&L Nov J32 = Purchases.xlsx "f" net | 0 | 0 | 0 | PASS |
| P&L Nov J33 = Purchases.xlsx "l" net | 250 | 250 | 0 | PASS |
...
| P&L Dec K13 = Purchases.xlsx "o" net | 237.5 | 237.5 | 0 | PASS |
| P&L Dec K21 = Purchases.xlsx "r" net | 1000 | 1000 | 0 | PASS |
| P&L Dec K22 = Purchases.xlsx "p" net | 350 | 350 | 0 | PASS |
...
| P&L Dec K26 = Purchases.xlsx "u" net | 115.83 | 115.833333333333 | +0.003333333333003452 | PASS |
| P&L Dec K27 = Purchases.xlsx "a" net | 0 | 0 | 0 | PASS |
| P&L Dec K28 = Purchases.xlsx "g" net | 212.5 | 212.5 | 0 | PASS |
| P&L Dec K29 = Purchases.xlsx "h" net | 76.67 | 76.6666666666667 | -0.00333333333330188 | PASS |
| P&L Dec K30 = Purchases.xlsx "v" net | 511.25 | 511.25 | 0 | PASS |
| P&L Dec K31 = Purchases.xlsx "n" net | 0 | 0 | 0 | PASS |
| P&L Dec K32 = Purchases.xlsx "f" net | 0 | 0 | 0 | PASS |
| P&L Dec K33 = Purchases.xlsx "l" net | 389.17 | 389.166666666667 | -0.003333333332989241 | PASS |
| P&L Dec K37 = Purchases.xlsx "y" net | 416.67 | 416.666666666667 | -0.003333333332989241 | PASS |
| P&L Dec K38 = Purchases.xlsx "z" net | 0 | 0 | 0 | PASS |
| P&L Jan L12 = Purchases.xlsx "c" net | 0 | 0 | 0 | PASS |
| P&L Jan L13 = Purchases.xlsx "o" net | 207.5 | 207.5 | 0 | PASS |
| P&L Jan L21 = Purchases.xlsx "r" net | 1000 | 1000 | 0 | PASS |
| P&L Jan L22 = Purchases.xlsx "p" net | 0 | 0 | 0 | PASS |
| P&L Jan L23 = Purchases.xlsx "t" net | 150 | 150 | 0 | PASS |
| P&L Jan L24 = Purchases.xlsx "q" net | 150 | 150 | 0 | PASS |
| P&L Jan L25 = Purchases.xlsx "m" net | 120 | 120 | 0 | PASS |
| P&L Jan L26 = Purchases.xlsx "u" net | 95.83 | 95.8333333333333 | +0.00333333333330188 | PASS |
| P&L Jan L27 = Purchases.xlsx "a" net | 400 | 400 | 0 | PASS |
| P&L Jan L28 = Purchases.xlsx "g" net | 127.5 | 127.5 | 0 | PASS |
| P&L Jan L29 = Purchases.xlsx "h" net | 76.67 | 76.6666666666667 | -0.00333333333330188 | PASS |
| P&L Jan L30 = Purchases.xlsx "v" net | 531.88 | 531.875 | -0.0049999999999954525 | PASS |
| P&L Jan L31 = Purchases.xlsx "n" net | 0 | 0 | 0 | PASS |
| P&L Jan L32 = Purchases.xlsx "f" net | 150 | 150 | 0 | PASS |
| P&L Jan L33 = Purchases.xlsx "l" net | 250 | 250 | 0 | PASS |
| P&L Jan L37 = Purchases.xlsx "y" net | 0 | 0 | 0 | PASS |
| P&L Jan L38 = Purchases.xlsx "z" net | 0 | 0 | 0 | PASS |
| P&L Feb M12 = Purchases.xlsx "c" net | 0 | 0 | 0 | PASS |
| P&L Feb M13 = Purchases.xlsx "o" net | 237.5 | 237.5 | 0 | PASS |
| P&L Feb M21 = Purchases.xlsx "r" net | 1000 | 1000 | 0 | PASS |
| P&L Feb M22 = Purchases.xlsx "p" net | 0 | 0 | 0 | PASS |
| P&L Feb M23 = Purchases.xlsx "t" net | 0 | 0 | 0 | PASS |
| P&L Feb M24 = Purchases.xlsx "q" net | 300 | 300 | 0 | PASS |
| P&L Feb M25 = Purchases.xlsx "m" net | 300 | 300 | 0 | PASS |
| P&L Feb M26 = Purchases.xlsx "u" net | 110.83 | 110.833333333333 | +0.003333333333003452 | PASS |
| P&L Feb M27 = Purchases.xlsx "a" net | 0 | 0 | 0 | PASS |
| P&L Feb M28 = Purchases.xlsx "g" net | 112.5 | 112.5 | 0 | PASS |
| P&L Feb M29 = Purchases.xlsx "h" net | 306.67 | 306.666666666667 | -0.003333333332989241 | PASS |
| P&L Feb M30 = Purchases.xlsx "v" net | 496.25 | 496.25 | 0 | PASS |
| P&L Feb M31 = Purchases.xlsx "n" net | 0 | 0 | 0 | PASS |
| P&L Feb M32 = Purchases.xlsx "f" net | 0 | 0 | 0 | PASS |
| P&L Feb M33 = Purchases.xlsx "l" net | 250 | 250 | 0 | PASS |
...
| P&L Mar N13 = Purchases.xlsx "o" net | 207.5 | 207.5 | 0 | PASS |
| P&L Mar N21 = Purchases.xlsx "r" net | 1000 | 1000 | 0 | PASS |
| P&L Mar N22 = Purchases.xlsx "p" net | 300 | 300 | 0 | PASS |
| P&L Mar N23 = Purchases.xlsx "t" net | 120 | 120 | 0 | PASS |
| P&L Mar N24 = Purchases.xlsx "q" net | 0 | 0 | 0 | PASS |
| P&L Mar N25 = Purchases.xlsx "m" net | 0 | 0 | 0 | PASS |
| P&L Mar N26 = Purchases.xlsx "u" net | 95.83 | 95.8333333333333 | +0.00333333333330188 | PASS |
| P&L Mar N27 = Purchases.xlsx "a" net | 0 | 0 | 0 | PASS |
| P&L Mar N28 = Purchases.xlsx "g" net | 132.5 | 132.5 | 0 | PASS |
| P&L Mar N29 = Purchases.xlsx "h" net | 76.67 | 76.6666666666667 | -0.00333333333330188 | PASS |
| P&L Mar N30 = Purchases.xlsx "v" net | 568.75 | 568.75 | 0 | PASS |
| P&L Mar N31 = Purchases.xlsx "n" net | 0 | 0 | 0 | PASS |
| P&L Mar N32 = Purchases.xlsx "f" net | 0 | 0 | 0 | PASS |
| P&L Mar N33 = Purchases.xlsx "l" net | 354.17 | 354.166666666667 | -0.003333333332989241 | PASS |
| P&L Mar N37 = Purchases.xlsx "y" net | 0 | 0 | 0 | PASS |
| P&L Mar N38 = Purchases.xlsx "z" net | 0 | 0 | 0 | PASS |
| P&L Apr turnover = Sales.xlsx Apr net less bad debts and asset sales | 27833.3333333333 | 27833.3333333333 | 0 | PASS |
| P&L Apr expense lines = Purchases.xlsx Apr net less materials, wages and asset purchases | 3759.375 | 3759.375 | 0 | PASS |
| P&L May turnover = Sales.xlsx May net less bad debts and asset sales | 27433.3333333333 | 27433.3333333333 | 0 | PASS |
| P&L May expense lines = Purchases.xlsx May net less materials, wages and asset purchases | 3212.5 | 3212.5 | 0 | PASS |
| P&L Jun turnover = Sales.xlsx Jun net less bad debts and asset sales | 29333.3333333333 | 29333.3333333333 | 0 | PASS |
| P&L Jun expense lines = Purchases.xlsx Jun net less materials, wages and asset purchases | 7247.5 | 7247.500000000003 | +2.7284841053187847e-12 | PASS |
| P&L Jul turnover = Sales.xlsx Jul net less bad debts and asset sales | 28133.3333333333 | 28133.3333333333 | 0 | PASS |
| P&L Jul expense lines = Purchases.xlsx Jul net less materials, wages and asset purchases | 5949.375 | 5949.375 | 0 | PASS |
...
| P&L Aug expense lines = Purchases.xlsx Aug net less materials, wages and asset purchases | 2846.041666666663 | 2846.041666666667 | +4.092726157978177e-12 | PASS |
...
| P&L Nov expense lines = Purchases.xlsx Nov net less materials, wages and asset purchases | 5065 | 5065.000000000001 | +9.094947017729282e-13 | PASS |
| P&L Dec turnover = Sales.xlsx Dec net less bad debts and asset sales | 27333.3333333333 | 27333.3333333333 | 0 | PASS |
| P&L Dec expense lines = Purchases.xlsx Dec net less materials, wages and asset purchases | 3309.5833333333303 | 3309.583333333334 | +3.637978807091713e-12 | PASS |
| P&L Jan turnover = Sales.xlsx Jan net less bad debts and asset sales | 29533.3333333333 | 29533.3333333333 | 0 | PASS |
| P&L Jan expense lines = Purchases.xlsx Jan net less materials, wages and asset purchases | 3259.375 | 3259.3749999999995 | -4.547473508864641e-13 | PASS |
| P&L Feb turnover = Sales.xlsx Feb net less bad debts and asset sales | 28633.3333333333 | 28633.3333333333 | 0 | PASS |
| P&L Feb expense lines = Purchases.xlsx Feb net less materials, wages and asset purchases | 3113.75 | 3113.75 | 0 | PASS |
| P&L Mar turnover = Sales.xlsx Mar net less bad debts and asset sales | 25833.3333333333 | 25833.3333333333 | 0 | PASS |
| P&L Mar expense lines = Purchases.xlsx Mar net less materials, wages and asset purchases | 2855.41666666667 | 2855.416666666667 | -3.183231456205249e-12 | PASS |
...
| Payslips!Apr K49 the monthly payroll opens in the accounting period's Apr | 43927 | 43927 | 0 | PASS |
...
| Payslips!Mar K69 the monthly payroll opens in the accounting period's Mar | 44256 | 44256 | 0 | PASS |
...
| Payslips print: the period ends the day the scenario paid that month's wages | 43982 | 43982 | 0 | PASS |
...
| Payslips print: the payment date is the day the scenario paid that month's wages | 43982 | 43982 | 0 | PASS |
...
| Payslips!Jul M49 wages paid date | 44043 | 44043 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 44286 | 44286 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 44286 | 44286 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 44286 | 44286 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 44286 | 44286 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 44286 | 44286 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 365 | 0 | PASS |
| Admin: first financial year row starts at the accounting period start | 43922 | 43922 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 44287 | 44287 | 0 | PASS |
| Admin: second financial year row ends at the year end | 44286 | 44286 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 43922 | 43922 | 0 | PASS |
| CT: working sheet heading ends at the year end | 44286 | 44286 | 0 | PASS |
| CT: the two tax rows span the accounting period | 365 | 365 | 0 | PASS |
| CT600: return period starts at the accounting period start | 43922 | 43922 | 0 | PASS |
| CT600: return period ends at the year end | 44286 | 44286 | 0 | PASS |
...
| CT600: amount of profit = first tax row profit | 124128.231172839 | 124128.231172839 | 0 | PASS |
| CT600: tax rate = first tax row rate | 19 | 19 | 0 | PASS |
| CT600: corporation tax = first tax row gross tax | 23584.3639228394 | 23584.3639228394 | 0 | PASS |
...
| CT: first tax row profit = chargeable profit by its share of those days | 124128.231172839 | 124128.231172839 | 0 | PASS |
| CT: second tax row profit = chargeable profit by its share of those days | 0 | 0 | 0 | PASS |
| CT: first tax row gross tax = its profit at its rate | 23584.363922839413 | 23584.3639228394 | -1.4551915228366852e-11 | PASS |
| CT: second tax row gross tax = its profit at its rate | 0 | 0 | 0 | PASS |
| CT: first tax row tax = its gross tax less its marginal relief | 23584.3639228394 | 23584.3639228394 | 0 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Box 335: amount of profit | 124,128.23 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 340: rate of tax | 19 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 345: tax | 23,584.36 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Box 328: associated companies, second financial year | — |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 September 2020) box 4: VAT reclaimed on purchases | 4,531.58 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 September 2020) box 5: net VAT due | 12,725.08 |
...
| E33 |  | 2020 |  |
| E34 |  | 2021 |  |
| F33 |  | 124128.231172839 |  |
| F34 |  | 0 |  |
| G33 |  | 19 |  |
| G34 |  | 19 |  |
| J33 |  | 23584.3639228394 |  |
| J34 |  | 0 |  |
| L33 |  | 0 |  |
| L34 |  | 0 |  |
| I33 |  | 23584.3639228394 |  |
| I34 |  | 0 |  |
...
| N126 | Box 335: amount of profit | 124128.231172839 | gl-cor:amount (ct600.box335) |
| AA126 | Box 340: rate of tax | 19 | gl-cor:rate (ct600.box340) |
| AJ126 | Box 345: tax | 23584.3639228394 | gl-cor:taxAmount (ct600.box345) |
