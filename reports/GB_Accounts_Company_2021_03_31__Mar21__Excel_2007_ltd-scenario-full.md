...
| | Amount |
|---|------:|
| Audit Accuracy Check | -1,774,985 |
...
| D29 | Directors Loan | 1883645 | accounts.liabilities.2500 (pubBS) |
...
| Cell | DIY Label | Value | diya-gl mapping |
|------|-----------|-------|-----------------|
| EJ91 | Audit Accuracy Check | -1774985 | gl-cor:amount (trialBalanceCheck) |
