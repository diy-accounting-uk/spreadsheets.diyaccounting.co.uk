# Reconciliation Report: GB Accounts Company 2024-08-31 (Aug24) Excel 2007
...
| Vatinterface H10: Jan purchases net = Purchases.xlsx Jan | 3671.04166666667 | 3671.04166666667 | 0 | PASS |
| Vatinterface J10: Jan input VAT = Purchases.xlsx Jan | 734.208333333333 | 734.208333333333 | 0 | PASS |
...
| VAT Q1: payment due date (G7) = Vatinterface final date for payment (C8) | 45291 | 45291 | 0 | PASS |
...
| VAT Q2: payment due date (G7) = Vatinterface final date for payment (C11) | 45382 | 45382 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 45473 | 45473 | 0 | PASS |
...
| VAT Q4: payment due date (G7) = Vatinterface final date for payment (C17) | 45565 | 45565 | 0 | PASS |
...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C20) | 45657 | 45657 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 45535 | 45535 | 0 | PASS |
...
| P&L Jan G27 = Purchases.xlsx "a" net | 0 | 0 | 0 | PASS |
...
| P&L Jan expense lines = Purchases.xlsx Jan net less materials, wages and asset purchases | 2554.375000000003 | 2554.375 | -3.183231456205249e-12 | PASS |
...
| Payslips!May K59 the monthly payroll opens in the accounting period's May | 45413 | 45413 | 0 | PASS |
...
| Payslips!Aug K69 the monthly payroll opens in the accounting period's Aug | 45505 | 45505 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 45535 | 45535 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 45535 | 45535 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 45535 | 45535 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 45535 | 45535 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 45535 | 45535 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 366 | +1 | PASS |
| Admin: first financial year row starts at the accounting period start | 45170 | 45170 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 45383 | 45383 | 0 | PASS |
| Admin: second financial year row ends at the year end | 45535 | 45535 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 45170 | 45170 | 0 | PASS |
| CT: working sheet heading ends at the year end | 45535 | 45535 | 0 | PASS |
| CT: the two tax rows span the accounting period | 366 | 366 | 0 | PASS |
| CT600: return period starts at the accounting period start | 45170 | 45170 | 0 | PASS |
| CT600: return period ends at the year end | 45535 | 45535 | 0 | PASS |
...
| CT600: amount of profit = first tax row profit | 72408.3012016796 | 72408.3012016796 | 0 | PASS |
| CT600: tax rate = first tax row rate | 25 | 25 | 0 | PASS |
| CT600: corporation tax = first tax row gross tax | 18102.0753004199 | 18102.0753004199 | 0 | PASS |
| CT600: second financial year tax = second tax row gross tax | 13002.8991594565 | 13002.8991594565 | 0 | PASS |
| CT600: second financial year = second tax row financial year | 2024 | 2024 | 0 | PASS |
| CT600: second financial year profit = second tax row profit | 52011.5966378262 | 52011.5966378262 | 0 | PASS |
...
| CT: first tax row profit = chargeable profit by its share of those days | 72408.30120167971 | 72408.3012016796 | -1.1641532182693481e-10 | PASS |
| CT: second tax row profit = chargeable profit by its share of those days | 52011.59663782628 | 52011.5966378262 | -8.003553375601768e-11 | PASS |
| CT: first tax row gross tax = its profit at its rate | 18102.0753004199 | 18102.0753004199 | 0 | PASS |
| CT: second tax row gross tax = its profit at its rate | 13002.89915945655 | 13002.8991594565 | -5.093170329928398e-11 | PASS |
| CT: first tax row tax = its gross tax less its marginal relief | 17005.82276926477 | 17005.8227692648 | +2.9103830456733704e-11 | PASS |
| CT: second tax row tax = its gross tax less its marginal relief | 12215.450158204221 | 12215.4501582043 | +7.821654435247183e-11 | PASS |
...
| CT: first tax row marginal relief = its share of the profit against its share of the limits | 1096.2525311551337 | 1096.25253115513 | -3.637978807091713e-12 | PASS |
| CT: second tax row marginal relief = its share of the profit against its share of the limits | 787.449001252279 | 787.449001252279 | 0 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 covers the periods ending | 30 September 2023, 31 October 2023, 30 November 2023 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 covers the periods ending | 31 December 2023, 31 January 2024, 29 February 2024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 covers the periods ending | 31 March 2024, 30 April 2024, 31 May 2024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 covers the periods ending | 30 June 2024, 31 July 2024, 31 August 2024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 covers the periods ending | 30 September 2024, 31 October 2024, 30 November 2024 |
| The returns above also cover the periods ending 30 September 2024, 31 October 2024, 30 November 2024, which fall outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 180 |
| **The return forms as the package fills them in** |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 November 2023) box 1: VAT due on sales | 16,920 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 November 2023) box 4: VAT reclaimed on purchases | 6,023.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 November 2023) box 5: net VAT due | 10,896.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 29 February 2024) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 29 February 2024) box 4: VAT reclaimed on purchases | 4,473.25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 29 February 2024) box 5: net VAT due | 12,783.42 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 May 2024) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 May 2024) box 4: VAT reclaimed on purchases | 9,895.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 May 2024) box 5: net VAT due | 9,884.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 August 2024) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 August 2024) box 4: VAT reclaimed on purchases | 2,105.71 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 August 2024) box 5: net VAT due | 14,754.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 November 2024) box 1: VAT due on sales | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 November 2024) box 4: VAT reclaimed on purchases | 180 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 November 2024) box 5: net VAT due | 920 |
...
| E33 |  | 2023 |  |
| E34 |  | 2024 |  |
| F33 |  | 72408.3012016796 |  |
| F34 |  | 52011.5966378262 |  |
| G33 |  | 25 |  |
| G34 |  | 25 |  |
| J33 |  | 18102.0753004199 |  |
| J34 |  | 13002.8991594565 |  |
| L33 |  | 1096.25253115513 |  |
| L34 |  | 787.449001252279 |  |
| I33 |  | 17005.8227692648 |  |
| I34 |  | 12215.4501582043 |  |
...
| AJ126 | Box 46: tax | 18102.0753004199 | gl-cor:taxAmount (ct600.box46) |
...
| AJ128 | Box 56: tax | 13002.8991594565 | gl-cor:taxAmount (ct600.box56) |
