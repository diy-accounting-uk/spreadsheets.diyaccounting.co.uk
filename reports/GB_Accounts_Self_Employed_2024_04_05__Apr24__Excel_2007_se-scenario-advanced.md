...
# Reconciliation Report: GB Accounts Self Employed 2024-04-05 (Apr24) Excel 2007
...
| Total Tax + NI, less the CIS already deducted | 47811.919995000004 | 47811.9199949998 | -2.0372681319713593e-10 | PASS |
...
| Tax: Total = IT + CIS deduction line + NI | 47811.919994999786 | 47811.9199949998 | +1.4551915228366852e-11 | PASS |
...
| Forecast: National Insurance | 4804.667 | 4804.66699999999 | -1.000444171950221e-11 | PASS |
| Forecast: tax and NI liability | 44748.67700000001 | 44748.6769999997 | -3.128661774098873e-10 | PASS |
...
| SA103F: the period the return covers starts on the Admin tax year start (Q2 = B4) | 45022 | 45022 | 0 | PASS |
| SA103F: the period the return covers ends on the Admin tax year end (V2 = B17) | 45387 | 45387 | 0 | PASS |
...
| SA103F: the online filing deadline banner (G1) names 31 January the year after the tax year ends | COPY DETAILS TO HMRC FORM          Submit HMRC RETURN ONLINE                   by 31st January 2025 | COPY DETAILS TO HMRC FORM          Submit HMRC RETURN ONLINE                   by 31st January 2025 |  | PASS |
...
| Payslips print: the period ends the day the scenario paid that month's wages | 45077 | 45077 | 0 | PASS |
...
| Payslips print: the payment date is the day the scenario paid that month's wages | 45077 | 45077 | 0 | PASS |
...
| Payslips!Jul M49 wages paid date | 45138 | 45138 | 0 | PASS |
...
| Payslips!Aug M49 wages paid date | 45169 | 45169 | 0 | PASS |
...
| Admin: Amounts Payable By date (B21) = 31 January the year after the tax year ends | 45688 | 45688 | 0 | PASS |
| Payslips calendar: the payroll year starts on the accounts tax year start (B2 = Admin B4) | 45022 | 45022 | 0 | PASS |
| Payslips calendar: the year the calendar runs to (I1) = the accounts tax year end (Admin B17) | 45387 | 45387 | 0 | PASS |
| Payslips calendar: the tax year the payslips print (N1) = the tax year the package was generated for | 2023-24 | 2023-24 |  | PASS |
| Payslips calendar row 2: the date runs on unbroken from the tax year start | 45022 | 45022 | 0 | PASS |
| Payslips calendar row 2: the month name is its payroll month counted from the tax year start | Apr | Apr |  | PASS |
| Payslips calendar row 33: the date runs on unbroken from the tax year start | 45053 | 45053 | 0 | PASS |
| Payslips calendar row 33: the month name is its payroll month counted from the tax year start | May | May |  | PASS |
| Payslips calendar row 64: the date runs on unbroken from the tax year start | 45084 | 45084 | 0 | PASS |
| Payslips calendar row 64: the month name is its payroll month counted from the tax year start | Jun | Jun |  | PASS |
| Payslips calendar row 95: the date runs on unbroken from the tax year start | 45115 | 45115 | 0 | PASS |
| Payslips calendar row 95: the month name is its payroll month counted from the tax year start | Jul | Jul |  | PASS |
| Payslips calendar row 126: the date runs on unbroken from the tax year start | 45146 | 45146 | 0 | PASS |
| Payslips calendar row 126: the month name is its payroll month counted from the tax year start | Aug | Aug |  | PASS |
| Payslips calendar row 157: the date runs on unbroken from the tax year start | 45177 | 45177 | 0 | PASS |
| Payslips calendar row 157: the month name is its payroll month counted from the tax year start | Sep | Sep |  | PASS |
| Payslips calendar row 188: the date runs on unbroken from the tax year start | 45208 | 45208 | 0 | PASS |
| Payslips calendar row 188: the month name is its payroll month counted from the tax year start | Oct | Oct |  | PASS |
| Payslips calendar row 219: the date runs on unbroken from the tax year start | 45239 | 45239 | 0 | PASS |
| Payslips calendar row 219: the month name is its payroll month counted from the tax year start | Nov | Nov |  | PASS |
| Payslips calendar row 250: the date runs on unbroken from the tax year start | 45270 | 45270 | 0 | PASS |
| Payslips calendar row 250: the month name is its payroll month counted from the tax year start | Dec | Dec |  | PASS |
| Payslips calendar row 281: the date runs on unbroken from the tax year start | 45301 | 45301 | 0 | PASS |
| Payslips calendar row 281: the month name is its payroll month counted from the tax year start | Jan | Jan |  | PASS |
| Payslips calendar row 312: the date runs on unbroken from the tax year start | 45332 | 45332 | 0 | PASS |
| Payslips calendar row 312: the month name is its payroll month counted from the tax year start | Feb | Feb |  | PASS |
| Payslips calendar row 343: the date runs on unbroken from the tax year start | 45363 | 45363 | 0 | PASS |
| Payslips calendar row 343: the month name is its payroll month counted from the tax year start | Mar | Mar |  | PASS |
| Payslips calendar row 366: the date runs on unbroken from the tax year start | 45386 | 45386 | 0 | PASS |
| Payslips calendar row 366: the month name is its payroll month counted from the tax year start | Mar | Mar |  | PASS |
| Payslips calendar row 381: the date runs on unbroken from the tax year start | 45401 | 45401 | 0 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;National Insurance | 4,804.67 |
| **Forecast Tax & NI Liability** | 44,748.68 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 June 2023) box 4: VAT reclaimed on purchases | 5,993.5 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 June 2023) box 5: net VAT due | 10,926.5 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 September 2023) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 September 2023) box 4: VAT reclaimed on purchases | 4,509.83 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 September 2023) box 5: net VAT due | 12,746.83 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 December 2023) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 December 2023) box 4: VAT reclaimed on purchases | 9,867 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 December 2023) box 5: net VAT due | 9,913 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 March 2024) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 March 2024) box 4: VAT reclaimed on purchases | 2,084.33 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 March 2024) box 5: net VAT due | 14,775.67 |
...
| E18 | **Total Tax + NI** | 47811.9199949998 | gl-cor:taxAmount (totalTaxNI) |
...
| C45 | National Insurance | 4804.66699999999 | tax.nationalInsurance.class4 |
| C46 | **Forecast Tax & NI Liability** | 44748.6769999997 | gl-cor:taxAmount (forecast.totalTaxNI) |
...
| G1 |  | COPY DETAILS TO HMRC FORM          Submit HMRC RETURN ONLINE                   by 31st January 2025 |  |
| Q2 |  | 45022 |  |
| V2 |  | 45387 |  |
| G141 |  | 0.18 |  |
| J280 |  | 12570 |  |
