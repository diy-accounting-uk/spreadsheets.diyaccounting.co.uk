...
# Reconciliation Report: GB Accounts Company 2021-06-30 (Jun21) Excel 2007
...
| VAT Q1: payment due date (G7) = Vatinterface final date for payment (C8) | 44135 | 44135 | 0 | PASS |
...
| VAT Q2: payment due date (G7) = Vatinterface final date for payment (C11) | 44227 | 44227 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 44316 | 44316 | 0 | PASS |
...
| VAT Q4: payment due date (G7) = Vatinterface final date for payment (C17) | 44408 | 44408 | 0 | PASS |
...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C20) | 44500 | 44500 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 44377 | 44377 | 0 | PASS |
...
| Board minute: meeting date = the scenario's board meeting | 44377 | 44377 | 0 | PASS |
...
| Payslips!Dec K59 the monthly payroll opens in the accounting period's Dec | 44166 | 44166 | 0 | PASS |
| Payslips!Jan K49 the monthly payroll opens in the accounting period's Jan | 44197 | 44197 | 0 | PASS |
| Payslips!Feb K49 the monthly payroll opens in the accounting period's Feb | 44228 | 44228 | 0 | PASS |
| Payslips!Mar K59 the monthly payroll opens in the accounting period's Mar | 44256 | 44256 | 0 | PASS |
| Payslips!Apr K49 the monthly payroll opens in the accounting period's Apr | 44287 | 44287 | 0 | PASS |
| Payslips!May K49 the monthly payroll opens in the accounting period's May | 44317 | 44317 | 0 | PASS |
| Payslips!Jun K69 the monthly payroll opens in the accounting period's Jun | 44348 | 44348 | 0 | PASS |
...
| Payslips print: the period ends the day the scenario paid that month's wages | 44074 | 44074 | 0 | PASS |
...
| Payslips print: the payment date is the day the scenario paid that month's wages | 44074 | 44074 | 0 | PASS |
...
| Payslips!Oct M49 wages paid date | 44135 | 44135 | 0 | PASS |
...
| Payslips!Nov M49 wages paid date | 44165 | 44165 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 44377 | 44377 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 44377 | 44377 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 44377 | 44377 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 44377 | 44377 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 44377 | 44377 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 365 | 0 | PASS |
| Admin: first financial year row starts at the accounting period start | 44013 | 44013 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 44287 | 44287 | 0 | PASS |
| Admin: second financial year row ends at the year end | 44377 | 44377 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 44013 | 44013 | 0 | PASS |
| CT: working sheet heading ends at the year end | 44377 | 44377 | 0 | PASS |
| CT: the two tax rows span the accounting period | 365 | 365 | 0 | PASS |
| CT600: return period starts at the accounting period start | 44013 | 44013 | 0 | PASS |
| CT600: return period ends at the year end | 44377 | 44377 | 0 | PASS |
...
| CT600: second financial year tax = second tax row gross tax | 5879.9373067901 | 5879.9373067901 | 0 | PASS |
| CT600: second financial year = second tax row financial year | 2021 | 2021 | 0 | PASS |
...
| CT600: tax payable = tax chargeable | 23584.3639228394 | 23584.3639228394 | 0 | PASS |
...
| CT: second tax row gross tax = its profit at its rate | 5879.937306790101 | 5879.9373067901 | -9.094947017729282e-13 | PASS |
| CT: first tax row tax = its gross tax less its marginal relief | 17704.4266160493 | 17704.4266160493 | 0 | PASS |
| CT: second tax row tax = its gross tax less its marginal relief | 5879.9373067901 | 5879.9373067901 | 0 | PASS |
| CT: charge for the year = the two tax rows | 23584.3639228394 | 23584.3639228394 | 0 | PASS |
...
| CT: charge for the year = the statutory computation with marginal relief | 23584.363922839413 | 23584.3639228394 | -1.4551915228366852e-11 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 covers the periods ending | 31 July 2020, 31 August 2020, 30 September 2020 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 covers the periods ending | 31 October 2020, 30 November 2020, 31 December 2020 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 covers the periods ending | 31 January 2021, 28 February 2021, 31 March 2021 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 covers the periods ending | 30 April 2021, 31 May 2021, 30 June 2021 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 covers the periods ending | 31 July 2021, 31 August 2021, 30 September 2021 |
| The returns above also cover the periods ending 31 July 2021, 31 August 2021, 30 September 2021, which fall outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 180 |
| **The return forms as the package fills them in** |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 September 2020) box 1: VAT due on sales | 16,920 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 September 2020) box 4: VAT reclaimed on purchases | 6,023.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 September 2020) box 5: net VAT due | 10,896.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 December 2020) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 December 2020) box 4: VAT reclaimed on purchases | 4,531.58 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 December 2020) box 5: net VAT due | 12,725.08 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 March 2021) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 March 2021) box 4: VAT reclaimed on purchases | 9,895.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 March 2021) box 5: net VAT due | 9,884.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 June 2021) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 June 2021) box 4: VAT reclaimed on purchases | 2,105.71 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 June 2021) box 5: net VAT due | 14,754.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 September 2021) box 1: VAT due on sales | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 September 2021) box 4: VAT reclaimed on purchases | 180 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 September 2021) box 5: net VAT due | 920 |
...
| Cell | DIY Label | Value | diya-gl mapping |
|------|-----------|-------|-----------------|
| C126 | Box 330: financial year | 2020 | gl-cor:period (ct600.box330) |
...
| C128 | Box 380: financial year | 2021 | gl-cor:period (ct600.box380) |
...
| AJ128 | Box 395: tax | 5879.9373067901 | gl-cor:taxAmount (ct600.box395) |
