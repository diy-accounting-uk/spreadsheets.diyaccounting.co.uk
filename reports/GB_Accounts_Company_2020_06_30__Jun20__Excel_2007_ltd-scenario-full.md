# Reconciliation Report: GB Accounts Company 2020-06-30 (Jun20) Excel 2007
...
| VAT Q1: payment due date (G7) = Vatinterface final date for payment (C8) | 43769 | 43769 | 0 | PASS |
...
| VAT Q2: payment due date (G7) = Vatinterface final date for payment (C11) | 43861 | 43861 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 43951 | 43951 | 0 | PASS |
...
| VAT Q4: box 7 (G23) = Vatinterface quarter purchases net (I17) | 10528.5416666667 0 | PASS |
| VAT Q4: box 6 (G21) = Vatinterface quarter sales net of VAT | 84299.9999999999 | 84299.9999999999 | 0 | PASS |
| VAT Q4: payment due date (G7) = Vatinterface final date for payment (C17) | 44043 | 44043 | 0 | PASS |
...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C20) | 44135 | 44135 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 44012 | 44012 | 0 | PASS |
...
| Payslips!Jul K49 the monthly payroll opens in the accounting period's Jul | 43647 | 43647 | 0 | PASS |
| Payslips!Aug K49 the monthly payroll opens in the accounting period's Aug | 43678 | 43678 | 0 | PASS |
| Payslips!Sep K59 the monthly payroll opens in the accounting period's Sep | 43709 | 43709 | 0 | PASS |
| Payslips!Oct K49 the monthly payroll opens in the accounting period's Oct | 43739 | 43739 | 0 | PASS |
| Payslips!Nov K49 the monthly payroll opens in the accounting period's Nov | 43770 | 43770 | 0 | PASS |
| Payslips!Dec K59 the monthly payroll opens in the accounting period's Dec | 43800 | 43800 | 0 | PASS |
...
| Payslips!Jun K69 the monthly payroll opens in the accounting period's Jun | 43983 | 43983 | 0 | PASS |
...
| Admin P8: corporation tax main rate | 19 | 19 | 0 | PASS |
| Admin P9: marginal relief fraction | 0 | 0 | 0 | PASS |
| Admin P12: marginal relief lower limit | 0 | 0 | 0 | PASS |
| Admin P13: marginal relief upper limit | 0 | 0 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 44012 | 44012 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 44012 | 44012 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 44012 | 44012 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 44012 | 44012 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 44012 | 44012 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 366 | +1 | PASS |
| Admin: first financial year row starts at the accounting period start | 43647 | 43647 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 43922 | 43922 | 0 | PASS |
| Admin: second financial year row ends at the year end | 44012 | 44012 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 43647 | 43647 | 0 | PASS |
| CT: working sheet heading ends at the year end | 44012 | 44012 | 0 | PASS |
| CT: the two tax rows span the accounting period | 366 | 366 | 0 | PASS |
| CT600: return period starts at the accounting period start | 43647 | 43647 | 0 | PASS |
| CT600: return period ends at the year end | 44012 | 44012 | 0 | PASS |
...
| CT600: corporation tax = first tax row gross tax | 17762.1302243557 | 17762.1302243557 | 0 | PASS |
| CT600: second financial year tax = second tax row gross tax | 5877.65036515042 | 5877.65036515042 | 0 | PASS |
...
| CT600: tax payable = tax chargeable | 23639.78058950612 | 23639.7805895061 | -2.1827872842550278e-11 | PASS |
...
| CT: first tax row gross tax = its profit at its rate | 17762.130224355667 | 17762.1302243557 | +3.2741809263825417e-11 | PASS |
| CT: second tax row gross tax = its profit at its rate | 5877.650365150417 | 5877.65036515042 | +2.7284841053187847e-12 | PASS |
| CT: first tax row tax = its gross tax less its marginal relief | 17762.1302243557 | 17762.1302243557 | 0 | PASS |
| CT: second tax row tax = its gross tax less its marginal relief | 5877.65036515042 | 5877.65036515042 | 0 | PASS |
| CT: charge for the year = the two tax rows | 23639.78058950612 | 23639.7805895061 | -2.1827872842550278e-11 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 covers the periods ending | 31 July 2019, 31 August 2019, 30 September 2019 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 covers the periods ending | 31 October 2019, 30 November 2019, 31 December 2019 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 covers the periods ending | 31 January 2020, 29 February 2020, 31 March 2020 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 covers the periods ending | 30 April 2020, 31 May 2020, 30 June 2020 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 covers the periods ending | 31 July 2020, 31 August 2020, 30 September 2020 |
| The returns above also cover the periods ending 31 July 2020, 31 August 2020, 30 September 2020, which fall outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 180 |
| **The return forms as the package fills them in** |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 September 2019) box 1: VAT due on sales | 16,920 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 September 2019) box 4: VAT reclaimed on purchases | 6,023.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 September 2019) box 5: net VAT due | 10,896.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 December 2019) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 December 2019) box 4: VAT reclaimed on purchases | 4,473.25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 December 2019) box 5: net VAT due | 12,783.42 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 March 2020) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 March 2020) box 4: VAT reclaimed on purchases | 9,895.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 March 2020) box 5: net VAT due | 9,884.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 June 2020) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 June 2020) box 4: VAT reclaimed on purchases | 2,105.71 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 June 2020) box 5: net VAT due | 14,754.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 September 2020) box 1: VAT due on sales | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 September 2020) box 4: VAT reclaimed on purchases | 180 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 September 2020) box 5: net VAT due | 920 |
...
| G33 |  | 19 |  |
| G34 |  | 19 |  |
| J33 |  | 17762.1302243557 |  |
| J34 |  | 5877.65036515042 |  |
| L33 |  | 0 |  |
| L34 |  | 0 |  |
| I33 |  | 17762.1302243557 |  |
| I34 |  | 5877.65036515042 |  |
...
| AJ126 | Box 46: tax | 17762.1302243557 | gl-cor:taxAmount (ct600.box46) |
...
| AJ128 | Box 56: tax | 5877.65036515042 | gl-cor:taxAmount (ct600.box56) |
