...
| VAT Q1: payment due date (G7) = Vatinterface final date for payment (C8) | 45688 | 45688 | 0 | PASS |
...
| VAT Q2: payment due date (G7) = Vatinterface final date for payment (C11) | 45777 | 45777 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 45869 | 45869 | 0 | PASS |
...
| VAT Q4: payment due date (G7) = Vatinterface final date for payment (C17) | 45961 | 45961 | 0 | PASS |
...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C20) | 46053 | 46053 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 45930 | 45930 | 0 | PASS |
...
| Payslips!Sep K69 the monthly payroll opens in the accounting period's Sep | 45901 | 45901 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 45930 | 45930 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 45930 | 45930 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 45930 | 45930 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 45930 | 45930 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 45930 | 45930 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 365 | 0 | PASS |
| Admin: first financial year row starts at the accounting period start | 45566 | 45566 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 45748 | 45748 | 0 | PASS |
| Admin: second financial year row ends at the year end | 45930 | 45930 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 45566 | 45566 | 0 | PASS |
| CT: working sheet heading ends at the year end | 45930 | 45930 | 0 | PASS |
| CT: the two tax rows span the accounting period | 365 | 365 | 0 | PASS |
| CT600: return period starts at the accounting period start | 45566 | 45566 | 0 | PASS |
| CT600: return period ends at the year end | 45930 | 45930 | 0 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 covers the periods ending | 31 October 2024, 30 November 2024, 31 December 2024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 covers the periods ending | 31 January 2025, 28 February 2025, 31 March 2025 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 covers the periods ending | 30 April 2025, 31 May 2025, 30 June 2025 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 covers the periods ending | 31 July 2025, 31 August 2025, 30 September 2025 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 covers the periods ending | 31 October 2025, 30 November 2025, 31 December 2025 |
| The returns above also cover the periods ending 31 October 2025, 30 November 2025, 31 December 2025, which fall outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 180 |
| **The return forms as the package fills them in** |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 December 2024) box 1: VAT due on sales | 16,920 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 December 2024) box 4: VAT reclaimed on purchases | 6,023.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 December 2024) box 5: net VAT due | 10,896.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 March 2025) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 March 2025) box 4: VAT reclaimed on purchases | 4,473.25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 March 2025) box 5: net VAT due | 12,783.42 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 June 2025) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 June 2025) box 4: VAT reclaimed on purchases | 9,895.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 June 2025) box 5: net VAT due | 9,884.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 September 2025) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 September 2025) box 4: VAT reclaimed on purchases | 2,105.71 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 September 2025) box 5: net VAT due | 14,754.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 December 2025) box 1: VAT due on sales | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 December 2025) box 4: VAT reclaimed on purchases | 180 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 December 2025) box 5: net VAT due | 920 |
