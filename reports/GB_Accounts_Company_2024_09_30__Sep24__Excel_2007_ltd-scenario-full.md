# Reconciliation Report: GB Accounts Company 2024-09-30 (Sep24) Excel 2007
...
| Vatinterface H10: Feb purchases net = Purchases.xlsx Feb | 3671.04166666667 | 3671.04166666667 | 0 | PASS |
| Vatinterface J10: Feb input VAT = Purchases.xlsx Feb | 734.208333333333 | 734.208333333333 | 0 | PASS |
...
| VAT Q1: payment due date (G7) = Vatinterface final date for payment (C8) | 45322 | 45322 | 0 | PASS |
...
| VAT Q2: payment due date (G7) = Vatinterface final date for payment (C11) | 45412 | 45412 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 45504 | 45504 | 0 | PASS |
...
| VAT Q4: payment due date (G7) = Vatinterface final date for payment (C17) | 45596 | 45596 | 0 | PASS |
...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C20) | 45688 | 45688 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 45565 | 45565 | 0 | PASS |
...
| Board minute: meeting date = the scenario's board meeting | 46295 | 46295 | 0 | PASS |
...
| P&L Feb expense lines = Purchases.xlsx Feb net less materials, wages and asset purchases | 2554.375000000003 | 2554.375 | -3.183231456205249e-12 | PASS |
...
| Payslips!Sep K69 the monthly payroll opens in the accounting period's Sep | 45536 | 45536 | 0 | PASS |
...
| Payslips print: the period ends the day the scenario paid that month's wages | 45991 | 45991 | 0 | PASS |
...
| Payslips print: the payment date is the day the scenario paid that month's wages | 45991 | 45991 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 45565 | 45565 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 45565 | 45565 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 45565 | 45565 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 45565 | 45565 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 45565 | 45565 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 366 | +1 | PASS |
| Admin: first financial year row starts at the accounting period start | 45200 | 45200 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 45383 | 45383 | 0 | PASS |
| Admin: second financial year row ends at the year end | 45565 | 45565 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 45200 | 45200 | 0 | PASS |
| CT: working sheet heading ends at the year end | 45565 | 45565 | 0 | PASS |
| CT: the two tax rows span the accounting period | 366 | 366 | 0 | PASS |
| CT600: return period starts at the accounting period start | 45200 | 45200 | 0 | PASS |
| CT600: return period ends at the year end | 45565 | 45565 | 0 | PASS |
...
| CT600: amount of profit = first tax row profit | 62209.9489197529 | 62209.9489197529 | 0 | PASS |
| CT600: tax rate = first tax row rate | 25 | 25 | 0 | PASS |
| CT600: corporation tax = first tax row gross tax | 15552.4872299382 | 15552.4872299382 | 0 | PASS |
| CT600: second financial year tax = second tax row gross tax | 15552.4872299382 | 15552.4872299382 | 0 | PASS |
| CT600: second financial year = second tax row financial year | 2024 | 2024 | 0 | PASS |
| CT600: second financial year profit = second tax row profit | 62209.9489197529 | 62209.9489197529 | 0 | PASS |
...
| CT600: marginal rate relief = the working sheet's relief | 1883.701532407414 | 1883.70153240741 | -4.092726157978177e-12 | PASS |
...
| CT: first tax row profit = chargeable profit by its share of those days | 62209.948919753 | 62209.9489197529 | -1.0186340659856796e-10 | PASS |
| CT: second tax row profit = chargeable profit by its share of those days | 62209.948919753 | 62209.9489197529 | -1.0186340659856796e-10 | PASS |
| CT: first tax row gross tax = its profit at its rate | 15552.487229938222 | 15552.4872299382 | -2.1827872842550278e-11 | PASS |
| CT: second tax row gross tax = its profit at its rate | 15552.487229938222 | 15552.4872299382 | -2.1827872842550278e-11 | PASS |
| CT: first tax row tax = its gross tax less its marginal relief | 14610.636463734494 | 14610.6364637345 | +5.4569682106375694e-12 | PASS |
| CT: second tax row tax = its gross tax less its marginal relief | 14610.636463734494 | 14610.6364637345 | +5.4569682106375694e-12 | PASS |
...
| CT: first tax row marginal relief = its share of the profit against its share of the limits | 941.8507662037065 | 941.850766203707 | +5.684341886080801e-13 | PASS |
| CT: second tax row marginal relief = its share of the profit against its share of the limits | 941.8507662037065 | 941.850766203707 | +5.684341886080801e-13 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Box 44: amount of profit | 62,209.95 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 45: rate of tax | 25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 46: tax | 15,552.49 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 53: financial year | 2,024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 54: amount of profit | 62,209.95 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 55: rate of tax | 25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 56: tax | 15,552.49 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 covers the periods ending | 31 October 2023, 30 November 2023, 31 December 2023 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 covers the periods ending | 31 January 2024, 29 February 2024, 31 March 2024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 covers the periods ending | 30 April 2024, 31 May 2024, 30 June 2024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 covers the periods ending | 31 July 2024, 31 August 2024, 30 September 2024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 covers the periods ending | 31 October 2024, 30 November 2024, 31 December 2024 |
| The returns above also cover the periods ending 31 October 2024, 30 November 2024, 31 December 2024, which fall outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 180 |
| **The return forms as the package fills them in** |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 December 2023) box 1: VAT due on sales | 16,920 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 December 2023) box 4: VAT reclaimed on purchases | 6,023.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 December 2023) box 5: net VAT due | 10,896.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 March 2024) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 March 2024) box 4: VAT reclaimed on purchases | 4,473.25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 March 2024) box 5: net VAT due | 12,783.42 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 June 2024) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 June 2024) box 4: VAT reclaimed on purchases | 9,895.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 June 2024) box 5: net VAT due | 9,884.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 September 2024) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 September 2024) box 4: VAT reclaimed on purchases | 2,105.71 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 September 2024) box 5: net VAT due | 14,754.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 December 2024) box 1: VAT due on sales | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 December 2024) box 4: VAT reclaimed on purchases | 180 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 December 2024) box 5: net VAT due | 920 |
...
| E33 |  | 2023 |  |
| E34 |  | 2024 |  |
| F33 |  | 62209.9489197529 |  |
| F34 |  | 62209.9489197529 |  |
| G33 |  | 25 |  |
| G34 |  | 25 |  |
| J33 |  | 15552.4872299382 |  |
| J34 |  | 15552.4872299382 |  |
| L33 |  | 941.850766203707 |  |
| L34 |  | 941.850766203707 |  |
| I33 |  | 14610.6364637345 |  |
| I34 |  | 14610.6364637345 |  |
...
| N126 | Box 44: amount of profit | 62209.9489197529 | gl-cor:amount (ct600.box44) |
| AA126 | Box 45: rate of tax | 25 | gl-cor:rate (ct600.box45) |
| AJ126 | Box 46: tax | 15552.4872299382 | gl-cor:taxAmount (ct600.box46) |
| C128 | Box 53: financial year | 2024 | gl-cor:period (ct600.box53) |
| N128 | Box 54: amount of profit | 62209.9489197529 | gl-cor:amount (ct600.box54) |
| AA128 | Box 55: rate of tax | 25 | gl-cor:rate (ct600.box55) |
| AJ128 | Box 56: tax | 15552.4872299382 | gl-cor:taxAmount (ct600.box56) |
