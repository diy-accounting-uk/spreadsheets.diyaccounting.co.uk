...
| | Amount |
|---|------:|
| Audit Accuracy Check | -1,776,238 |
...
| D29 | Directors Loan | 1884898 | accounts.liabilities.2500 (pubBS) |
...
| Cell | DIY Label | Value | diya-gl mapping |
|------|-----------|-------|-----------------|
| EJ91 | Audit Accuracy Check | -1776238 | gl-cor:amount (trialBalanceCheck) |
