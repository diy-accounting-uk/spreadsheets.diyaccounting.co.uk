...
# Reconciliation Report: GB Accounts Company 2021-04-30 (Apr21) Excel 2007
...
| Vatinterface H10: Sep purchases net = Purchases.xlsx Sep | 3962.70833333333 | 3962.70833333333 | 0 | PASS |
| Vatinterface J10: Sep input VAT = Purchases.xlsx Sep | 792.541666666667 | 792.541666666667 | 0 | PASS |
...
| VAT Q1: payment due date (G7) = Vatinterface final date for payment (C8) | 44074 | 44074 | 0 | PASS |
...
| VAT Q2: payment due date (G7) = Vatinterface final date for payment (C11) | 44165 | 44165 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 44255 | 44255 | 0 | PASS |
...
| VAT Q4: payment due date (G7) = Vatinterface final date for payment (C17) | 44347 | 44347 | 0 | PASS |
...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C20) | 44439 | 44439 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 44316 | 44316 | 0 | PASS |
...
| Board minute: meeting date = the scenario's board meeting | 44316 | 44316 | 0 | PASS |
...
| P&L Sep G27 = Purchases.xlsx "a" net | 291.67 | 291.666666666667 | -0.003333333332989241 | PASS |
...
| P&L Sep expense lines = Purchases.xlsx Sep net less materials, wages and asset purchases | 2846.041666666663 | 2846.041666666667 | +4.092726157978177e-12 | PASS |
...
| Payslips!Jul K59 the monthly payroll opens in the accounting period's Jul | 44013 | 44013 | 0 | PASS |
...
| Payslips!Apr K69 the monthly payroll opens in the accounting period's Apr | 44287 | 44287 | 0 | PASS |
...
| Payslips print: the period ends the day the scenario paid that month's wages | 44012 | 44012 | 0 | PASS |
...
| Payslips print: the payment date is the day the scenario paid that month's wages | 44012 | 44012 | 0 | PASS |
...
| Payslips!Aug M49 wages paid date | 44074 | 44074 | 0 | PASS |
...
| Payslips!Sep M49 wages paid date | 44104 | 44104 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 44316 | 44316 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 44316 | 44316 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 44316 | 44316 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 44316 | 44316 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 44316 | 44316 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 365 | 0 | PASS |
| Admin: first financial year row starts at the accounting period start | 43952 | 43952 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 44287 | 44287 | 0 | PASS |
| Admin: second financial year row ends at the year end | 44316 | 44316 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 43952 | 43952 | 0 | PASS |
| CT: working sheet heading ends at the year end | 44316 | 44316 | 0 | PASS |
| CT: the two tax rows span the accounting period | 365 | 365 | 0 | PASS |
| CT600: return period starts at the accounting period start | 43952 | 43952 | 0 | PASS |
| CT600: return period ends at the year end | 44316 | 44316 | 0 | PASS |
...
| CT600: amount of profit = first tax row profit | 113925.910802469 | 113925.910802469 | 0 | PASS |
| CT600: tax rate = first tax row rate | 19 | 19 | 0 | PASS |
| CT600: corporation tax = first tax row gross tax | 21645.9230524691 | 21645.9230524691 | 0 | PASS |
| CT600: second financial year tax = second tax row gross tax | 1938.44087037036 | 1938.44087037036 | 0 | PASS |
| CT600: second financial year = second tax row financial year | 2021 | 2021 | 0 | PASS |
| CT600: second financial year profit = second tax row profit | 10202.3203703703 | 10202.3203703703 | 0 | PASS |
...
| CT: first tax row profit = chargeable profit by its share of those days | 113925.91080246867 | 113925.910802469 | +3.346940502524376e-10 | PASS |
| CT: second tax row profit = chargeable profit by its share of those days | 10202.32037037033 | 10202.3203703703 | -2.9103830456733704e-11 | PASS |
| CT: first tax row gross tax = its profit at its rate | 21645.92305246911 | 21645.9230524691 | -7.275957614183426e-12 | PASS |
| CT: second tax row gross tax = its profit at its rate | 1938.440870370357 | 1938.44087037036 | +2.9558577807620168e-12 | PASS |
| CT: first tax row tax = its gross tax less its marginal relief | 21645.9230524691 | 21645.9230524691 | 0 | PASS |
| CT: second tax row tax = its gross tax less its marginal relief | 1938.44087037036 | 1938.44087037036 | 0 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Box 335: amount of profit | 113,925.91 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 340: rate of tax | 19 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 345: tax | 21,645.92 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 380: financial year | 2,021 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 385: amount of profit | 10,202.32 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 390: rate of tax | 19 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 395: tax | 1,938.44 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 covers the periods ending | 31 May 2020, 30 June 2020, 31 July 2020 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 covers the periods ending | 31 August 2020, 30 September 2020, 31 October 2020 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 covers the periods ending | 30 November 2020, 31 December 2020, 31 January 2021 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 covers the periods ending | 28 February 2021, 31 March 2021, 30 April 2021 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 covers the periods ending | 31 May 2021, 30 June 2021, 31 July 2021 |
| The returns above also cover the periods ending 31 May 2021, 30 June 2021, 31 July 2021, which fall outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 180 |
| **The return forms as the package fills them in** |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 July 2020) box 1: VAT due on sales | 16,920 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 July 2020) box 4: VAT reclaimed on purchases | 6,023.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 July 2020) box 5: net VAT due | 10,896.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 October 2020) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 October 2020) box 4: VAT reclaimed on purchases | 4,531.58 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 October 2020) box 5: net VAT due | 12,725.08 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 January 2021) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 January 2021) box 4: VAT reclaimed on purchases | 9,895.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 January 2021) box 5: net VAT due | 9,884.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 April 2021) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 April 2021) box 4: VAT reclaimed on purchases | 2,105.71 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 April 2021) box 5: net VAT due | 14,754.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 July 2021) box 1: VAT due on sales | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 July 2021) box 4: VAT reclaimed on purchases | 180 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 July 2021) box 5: net VAT due | 920 |
...
| E33 |  | 2020 |  |
| E34 |  | 2021 |  |
| F33 |  | 113925.910802469 |  |
| F34 |  | 10202.3203703703 |  |
| G33 |  | 19 |  |
| G34 |  | 19 |  |
| J33 |  | 21645.9230524691 |  |
| J34 |  | 1938.44087037036 |  |
| L33 |  | 0 |  |
| L34 |  | 0 |  |
| I33 |  | 21645.9230524691 |  |
| I34 |  | 1938.44087037036 |  |
...
| N126 | Box 335: amount of profit | 113925.910802469 | gl-cor:amount (ct600.box335) |
| AA126 | Box 340: rate of tax | 19 | gl-cor:rate (ct600.box340) |
| AJ126 | Box 345: tax | 21645.9230524691 | gl-cor:taxAmount (ct600.box345) |
| C128 | Box 380: financial year | 2021 | gl-cor:period (ct600.box380) |
| N128 | Box 385: amount of profit | 10202.3203703703 | gl-cor:amount (ct600.box385) |
| AA128 | Box 390: rate of tax | 19 | gl-cor:rate (ct600.box390) |
| AJ128 | Box 395: tax | 1938.44087037036 | gl-cor:taxAmount (ct600.box395) |
