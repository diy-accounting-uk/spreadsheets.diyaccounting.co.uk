# Reconciliation Report: GB Accounts Company 2020-10-31 (Oct20) Excel 2007
...
| VAT Q1: payment due date (G7) = Vatinterface final date for payment (C8) | 43890 | 43890 | 0 | PASS |
...
| VAT Q2: payment due date (G7) = Vatinterface final date for payment (C11) | 43982 | 43982 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 44074 | 44074 | 0 | PASS |
...
| VAT Q4: payment due date (G7) = Vatinterface final date for payment (C17) | 44165 | 44165 | 0 | PASS |
...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C19) | 44227 | 44227 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 44135 | 44135 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 44135 | 44135 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 44135 | 44135 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 44135 | 44135 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 44135 | 44135 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 44135 | 44135 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 366 | +1 | PASS |
| Admin: first financial year row starts at the accounting period start | 43770 | 43770 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 43922 | 43922 | 0 | PASS |
| Admin: second financial year row ends at the year end | 44135 | 44135 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 43770 | 43770 | 0 | PASS |
| CT: working sheet heading ends at the year end | 44135 | 44135 | 0 | PASS |
| CT: the two tax rows span the accounting period | 366 | 366 | 0 | PASS |
| CT600: return period starts at the accounting period start | 43770 | 43770 | 0 | PASS |
| CT600: return period ends at the year end | 44135 | 44135 | 0 | PASS |
...
| CT600: corporation tax = first tax row gross tax | 11395.7558732375 | 11395.7558732375 | 0 | PASS |
| CT600: second financial year tax = second tax row gross tax | 16044.0247162686 | 16044.0247162686 | 0 | PASS |
...
| CT: first tax row gross tax = its profit at its rate | 11395.755873237504 | 11395.7558732375 | -3.637978807091713e-12 | PASS |
| CT: second tax row gross tax = its profit at its rate | 16044.0247162686 | 16044.0247162686 | 0 | PASS |
| CT: first tax row tax = its gross tax less its marginal relief | 11395.7558732375 | 11395.7558732375 | 0 | PASS |
| CT: second tax row tax = its gross tax less its marginal relief | 16044.0247162686 | 16044.0247162686 | 0 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 covers the periods ending | 30 November 2019, 31 December 2019, 31 January 2020 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 covers the periods ending | 29 February 2020, 31 March 2020, 30 April 2020 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 covers the periods ending | 31 May 2020, 30 June 2020, 31 July 2020 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 covers the periods ending | 31 August 2020, 30 September 2020, 31 October 2020 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 covers the periods ending | 31 October 2020, 30 November 2020, 31 December 2020 |
| The returns above also cover the periods ending 30 November 2020, 31 December 2020, which fall outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 900 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 100 |
| Q4 and Q5 both cover the period ending 31 October 2020. The last form is a spare, for a business whose quarter stagger puts five returns across the accounting year; each form takes its period from a dropdown of the month ends the book carries. The book stops two months after the year end, so there is no row to total the quarter after the fourth return and the spare lands on the last period the book carries instead. Filing all five as they stand would declare that period twice. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on it | 5,226.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on it | 621.08 |
| **The return forms as the package fills them in** |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 January 2020) box 1: VAT due on sales | 16,920 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 January 2020) box 4: VAT reclaimed on purchases | 3,423.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 January 2020) box 5: net VAT due | 13,496.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 April 2020) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 April 2020) box 4: VAT reclaimed on purchases | 3,073.25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 April 2020) box 5: net VAT due | 14,183.42 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 July 2020) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 July 2020) box 4: VAT reclaimed on purchases | 9,895.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 July 2020) box 5: net VAT due | 9,884.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 October 2020) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 October 2020) box 4: VAT reclaimed on purchases | 2,105.71 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 October 2020) box 5: net VAT due | 14,754.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 December 2020) box 1: VAT due on sales | 6,126.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 December 2020) box 4: VAT reclaimed on purchases | 721.08 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 December 2020) box 5: net VAT due | 5,405.58 |
...
| G33 |  | 19 |  |
| G34 |  | 19 |  |
| J33 |  | 11395.7558732375 |  |
| J34 |  | 16044.0247162686 |  |
| L33 |  | 0 |  |
| L34 |  | 0 |  |
| I33 |  | 11395.7558732375 |  |
| I34 |  | 16044.0247162686 |  |
...
| AJ126 | Box 46: tax | 11395.7558732375 | gl-cor:taxAmount (ct600.box46) |
...
| AJ128 | Box 56: tax | 16044.0247162686 | gl-cor:taxAmount (ct600.box56) |
