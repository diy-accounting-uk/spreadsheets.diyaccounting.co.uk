...
# Reconciliation Report: GB Accounts Company 2024-01-31 (Jan24) Excel 2007
...
| Vatinterface H10: Jun purchases net = Purchases.xlsx Jun | 3962.70833333333 | 3962.70833333333 | 0 | PASS |
| Vatinterface J10: Jun input VAT = Purchases.xlsx Jun | 792.541666666667 | 792.541666666667 | 0 | PASS |
...
| VAT Q1: payment due date (G7) = Vatinterface final date for payment (C8) | 45077 | 45077 | 0 | PASS |
...
| VAT Q2: payment due date (G7) = Vatinterface final date for payment (C11) | 45169 | 45169 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 45260 | 45260 | 0 | PASS |
...
| VAT Q4: payment due date (G7) = Vatinterface final date for payment (C17) | 45351 | 45351 | 0 | PASS |
...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C20) | 45443 | 45443 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 45322 | 45322 | 0 | PASS |
...
| Board minute: meeting date = the scenario's board meeting | 45322 | 45322 | 0 | PASS |
...
| Trial Balance: corporation tax creditor = opening plus the year's charge, less the interest tax credit and the payments coded RT | 28617.052569625594 | 28617.0525696256 | +7.275957614183426e-12 | PASS |
...
| P&L Jun G27 = Purchases.xlsx "a" net | 291.67 | 291.666666666667 | -0.003333333332989241 | PASS |
...
| P&L Jun expense lines = Purchases.xlsx Jun net less materials, wages and asset purchases | 2846.041666666663 | 2846.041666666667 | +4.092726157978177e-12 | PASS |
...
| Payslips!Jan K69 the monthly payroll opens in the accounting period's Jan | 45292 | 45292 | 0 | PASS |
...
| Payslips print: the period ends the day the scenario paid that month's wages | 45016 | 45016 | 0 | PASS |
...
| Payslips print: the payment date is the day the scenario paid that month's wages | 45016 | 45016 | 0 | PASS |
...
| Payslips!Jun M49 wages paid date | 45107 | 45107 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 45322 | 45322 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 45322 | 45322 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 45322 | 45322 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 45322 | 45322 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 45322 | 45322 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 365 | 0 | PASS |
| Admin: first financial year row starts at the accounting period start | 44958 | 44958 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 45017 | 45017 | 0 | PASS |
| Admin: second financial year row ends at the year end | 45322 | 45322 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 44958 | 44958 | 0 | PASS |
| CT: working sheet heading ends at the year end | 45322 | 45322 | 0 | PASS |
| CT: the two tax rows span the accounting period | 365 | 365 | 0 | PASS |
| CT600: return period starts at the accounting period start | 44958 | 44958 | 0 | PASS |
| CT600: return period ends at the year end | 45322 | 45322 | 0 | PASS |
...
| CT600: amount of profit = first tax row profit | 20064.5633950617 | 20064.5633950617 | 0 | PASS |
| CT600: tax rate = first tax row rate | 19 | 19 | 0 | PASS |
| CT600: corporation tax = first tax row gross tax | 3812.26704506172 | 3812.26704506172 | 0 | PASS |
| CT600: second financial year tax = second tax row gross tax | 26015.9169444444 | 26015.9169444444 | 0 | PASS |
| CT600: second financial year = second tax row financial year | 2023 | 2023 | 0 | PASS |
| CT600: second financial year profit = second tax row profit | 104063.667777777 | 104063.667777777 | 0 | PASS |
...
| CT600: tax payable = tax chargeable | 29828.18398950612 | 29828.1839895061 | -2.1827872842550278e-11 | PASS |
| CT600: marginal rate relief = the working sheet's relief | 1146.62524704094 | 1146.62524704094 | 0 | PASS |
| CT600: tax net of marginal relief = the working sheet's charge | 28681.5587424651 | 28681.5587424651 | 0 | PASS |
| CT600: corporation tax chargeable = tax net of marginal relief | 28681.5587424651 | 28681.5587424651 | 0 | PASS |
| CT600: underlying rate of corporation tax = the tax it bears over the profits chargeable | 23.10639446922291 | 23.1063944692229 | -1.0658141036401503e-14 | PASS |
| CT600: tax outstanding | 28617.0525696256 | 28617.0525696256 | 0 | PASS |
| Fixed asset note: corporation tax for the year = CT charge | 28681.5587424651 | 28681.5587424651 | 0 | PASS |
...
| CT: first tax row profit = chargeable profit by its share of those days | 20064.563395061647 | 20064.5633950617 | +5.4569682106375694e-11 | PASS |
| CT: second tax row profit = chargeable profit by its share of those days | 104063.66777777734 | 104063.667777777 | -3.4924596548080444e-10 | PASS |
| CT: first tax row gross tax = its profit at its rate | 3812.2670450617234 | 3812.26704506172 | -3.183231456205249e-12 | PASS |
| CT: second tax row gross tax = its profit at its rate | 26015.91694444425 | 26015.9169444444 | +1.5279510989785194e-10 | PASS |
| CT: first tax row tax = its gross tax less its marginal relief | 3812.26704506172 | 3812.26704506172 | 0 | PASS |
| CT: second tax row tax = its gross tax less its marginal relief | 24869.29169740346 | 24869.2916974034 | -5.820766091346741e-11 | PASS |
| CT: charge for the year = the two tax rows | 28681.55874246512 | 28681.5587424651 | -2.1827872842550278e-11 | PASS |
...
| CT: second tax row marginal relief = its share of the augmented profits against its share of the limits | 1146.625247040934 | 1146.62524704094 | +5.9117155615240335e-12 | PASS |
...
| CT: charge for the year = the statutory computation with marginal relief | 28681.558742465113 | 28681.5587424651 | -1.4551915228366852e-11 | PASS |
| CT: Tax outstanding = CT less tax deducted at source | 28617.052569625594 | 28617.0525696256 | +7.275957614183426e-12 | PASS |
...
| **Corporation Tax** | 28,681.56 |
| Tax Outstanding | 28,617.05 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Box 335: amount of profit | 20,064.56 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 340: rate of tax | 19 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 345: tax | 3,812.27 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 380: financial year | 2,023 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 385: amount of profit | 104,063.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 390: rate of tax | 25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 395: tax | 26,015.92 |
| **Box 430: corporation tax** | 29,828.18 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 435: marginal rate relief | 1,146.63 |
| **Box 440: corporation tax net of marginal rate relief** | 28,681.56 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Corporation tax | 28,681.56 |
| **Profit after Tax** | 143,206.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Dividends | 15,000 |
| **Retained Profit for the year** | 128,206.67 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Corporation Tax | 28,617.05 |
| &nbsp;&nbsp;&nbsp;&nbsp;Taxation and Social Security | 9,077.46 |
| &nbsp;&nbsp;&nbsp;&nbsp;Current Liabilities | 48,876.76 |
| **Net Current Assets** | 158,018.67 |
| **Total Assets less CL** | 367,008.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Directors Loan | 13,000 |
| &nbsp;&nbsp;&nbsp;&nbsp;Creditors due after more than one year | 45,000 |
| &nbsp;&nbsp;&nbsp;&nbsp;Other Creditors | 58,000 |
| **Net Assets** | 309,008.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Called up share capital | 100 |
| **Shareholders' Funds** | 309,008.67 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Corporation tax for the year | 28,681.56 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 covers the periods ending | 28 February 2023, 31 March 2023, 30 April 2023 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 covers the periods ending | 31 May 2023, 30 June 2023, 31 July 2023 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 covers the periods ending | 31 August 2023, 30 September 2023, 31 October 2023 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 covers the periods ending | 30 November 2023, 31 December 2023, 31 January 2024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 covers the periods ending | 29 February 2024, 31 March 2024, 30 April 2024 |
| The returns above also cover the periods ending 29 February 2024, 31 March 2024, 30 April 2024, which fall outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 180 |
| **The return forms as the package fills them in** |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 April 2023) box 1: VAT due on sales | 16,920 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 April 2023) box 4: VAT reclaimed on purchases | 6,023.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 April 2023) box 5: net VAT due | 10,896.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 July 2023) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 July 2023) box 4: VAT reclaimed on purchases | 4,531.58 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 July 2023) box 5: net VAT due | 12,725.08 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 October 2023) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 October 2023) box 4: VAT reclaimed on purchases | 9,895.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 October 2023) box 5: net VAT due | 9,884.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 January 2024) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 January 2024) box 4: VAT reclaimed on purchases | 2,105.71 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 January 2024) box 5: net VAT due | 14,754.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 April 2024) box 1: VAT due on sales | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 April 2024) box 4: VAT reclaimed on purchases | 180 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 April 2024) box 5: net VAT due | 920 |
...
| K35 | **Corporation Tax** | 28681.5587424651 | gl-cor:taxAmount (ct600.box430) |
| K39 | Tax Outstanding | 28617.0525696256 | gl-cor:taxAmount (ct600.box600) |
| E5 |  | 44958 |  |
| H5 |  | 45322 |  |
| I15 |  | 52500 |  |
| I16 |  | 0 |  |
...
| E33 |  | 2022 |  |
| E34 |  | 2023 |  |
| F33 |  | 20064.5633950617 |  |
| F34 |  | 104063.667777777 |  |
| G33 |  | 19 |  |
| G34 |  | 25 |  |
| J33 |  | 3812.26704506172 |  |
| J34 |  | 26015.9169444444 |  |
| L33 |  | 0 |  |
| L34 |  | 1146.62524704094 |  |
| I33 |  | 3812.26704506172 |  |
| I34 |  | 24869.2916974034 |  |
...
| N126 | Box 335: amount of profit | 20064.5633950617 | gl-cor:amount (ct600.box335) |
| AA126 | Box 340: rate of tax | 19 | gl-cor:rate (ct600.box340) |
| AJ126 | Box 345: tax | 3812.26704506172 | gl-cor:taxAmount (ct600.box345) |
| C128 | Box 380: financial year | 2023 | gl-cor:period (ct600.box380) |
| N128 | Box 385: amount of profit | 104063.667777777 | gl-cor:amount (ct600.box385) |
| AA128 | Box 390: rate of tax | 25 | gl-cor:rate (ct600.box390) |
| AJ128 | Box 395: tax | 26015.9169444444 | gl-cor:taxAmount (ct600.box395) |
| AJ131 | **Box 430: corporation tax** | 29828.1839895061 | gl-cor:taxAmount (ct600.box430) |
| Y133 | Box 435: marginal rate relief | 1146.62524704094 | gl-cor:taxAmount (ct600.box435) |
| Y135 | **Box 440: corporation tax net of marginal rate relief** | 28681.5587424651 | gl-cor:taxAmount (ct600.box440) |
...
| AJ145 |  | 28681.5587424651 |  |
| AJ154 |  | 64.5061728395062 |  |
| AJ159 |  | 28617.0525696256 |  |
| AJ166 |  | 28617.0525696256 |  |
...
| F50 | Corporation tax | 28681.5587424651 | gl-cor:taxAmount (pubPL.tax) |
| F51 | **Profit after Tax** | 143206.672430374 | gl-cor:amount (pubPL.pat) |
| F52 | Dividends | 15000 | gl-cor:amount (pubPL.dividends) |
| F54 | **Retained Profit for the year** | 128206.672430374 | gl-cor:amount (pubPL.retained) |
| D3 |  | 45322 |  |
| B9 |  | 0 |  |
| B14 |  | 0 |  |
| B18 |  | 0 |  |
...
| E17 | Corporation Tax | 28617.0525696256 | accounts.liabilities.2300 (pubBS) |
| E18 | Taxation and Social Security | 9077.45500000003 | gl-cor:amount (pubBS.taxAndSocial) |
| E20 | Current Liabilities | 48876.7575696257 | gl-cor:amount (pubBS.creditors) |
| F22 | **Net Current Assets** | 158018.672430374 | gl-cor:amount (pubBS.netCurrent) |
| F26 | **Total Assets less CL** | 367008.672430374 | gl-cor:amount (pubBS.totalAssetsLessCL) |
...
| F33 | **Net Assets** | 309008.672430374 | gl-cor:amount (pubBS.netAssets) |
| F36 | Called up share capital | 100 | accounts.capital.3000 (pubBS) |
| F39 | **Shareholders' Funds** | 309008.672430374 | gl-cor:amount (pubBS.equity) |
| D2 |  | 45322 |  |
...
| D41 | Corporation tax for the year | 28681.5587424651 | gl-cor:taxAmount (note4.ct) |
| B8 |  | 200000 |  |
| B9 |  | 0 |  |
| B10 |  | 0 |  |
| B11 |  | 200000 |  |
