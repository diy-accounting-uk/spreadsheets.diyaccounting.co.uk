# Reconciliation Report: GB Accounts Company 2025-02-28 (Feb25) Excel 2007
...
| VAT Q1: payment due date (G7) = Vatinterface final date for payment (C8) | 45473 | 45473 | 0 | PASS |
...
| VAT Q2: payment due date (G7) = Vatinterface final date for payment (C11) | 45565 | 45565 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 45657 | 45657 | 0 | PASS |
...
| VAT Q4: payment due date (G7) = Vatinterface final date for payment (C17) | 45747 | 45747 | 0 | PASS |
...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C20) | 45838 | 45838 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 45716 | 45716 | 0 | PASS |
...
| Payslips!Feb K69 the monthly payroll opens in the accounting period's Feb | 45689 | 45689 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 45716 | 45716 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 45716 | 45716 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 45716 | 45716 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 45716 | 45716 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 45716 | 45716 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 365 | 0 | PASS |
| Admin: first financial year row starts at the accounting period start | 45352 | 45352 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 45383 | 45383 | 0 | PASS |
| Admin: second financial year row ends at the year end | 45716 | 45716 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 45352 | 45352 | 0 | PASS |
| CT: working sheet heading ends at the year end | 45716 | 45716 | 0 | PASS |
| CT: the two tax rows span the accounting period | 365 | 365 | 0 | PASS |
| CT600: return period starts at the accounting period start | 45352 | 45352 | 0 | PASS |
| CT600: return period ends at the year end | 45716 | 45716 | 0 | PASS |
...
| CT600: amount of profit = first tax row profit | 10567.1694055471 | 10567.1694055471 | 0 | PASS |
| CT600: tax rate = first tax row rate | 25 | 25 | 0 | PASS |
| CT600: corporation tax = first tax row gross tax | 2641.79235138677 | 2641.79235138677 | 0 | PASS |
| CT600: second financial year tax = second tax row gross tax | 28463.1821084897 | 28463.1821084897 | 0 | PASS |
| CT600: second financial year = second tax row financial year | 2024 | 2024 | 0 | PASS |
| CT600: second financial year profit = second tax row profit | 113852.728433959 | 113852.728433959 | 0 | PASS |
| CT600: second financial year rate = second tax row rate | 25 | 25 | 0 | PASS |
| CT600: tax payable = tax chargeable | 31104.974459876466 | 31104.9744598764 | -6.548361852765083e-11 | PASS |
...
| CT: first tax row profit = chargeable profit by its share of those days | 10567.169405547083 | 10567.1694055471 | +1.6370904631912708e-11 | PASS |
| CT: second tax row profit = chargeable profit by its share of those days | 113852.72843395892 | 113852.728433959 | +7.275957614183426e-11 | PASS |
| CT: first tax row gross tax = its profit at its rate | 2641.7923513867745 | 2641.79235138677 | -4.547473508864641e-12 | PASS |
| CT: second tax row gross tax = its profit at its rate | 28463.18210848975 | 28463.1821084897 | -5.093170329928398e-11 | PASS |
| CT: first tax row tax = its gross tax less its marginal relief | 2481.806741785044 | 2481.80674178504 | -4.092726157978177e-12 | PASS |
| CT: second tax row tax = its gross tax less its marginal relief | 26739.466185684007 | 26739.466185684 | -7.275957614183426e-12 | PASS |
| CT: charge for the year = the two tax rows | 29221.27292746904 | 29221.272927469 | -4.001776687800884e-11 | PASS |
...
| CT: first tax row marginal relief = its share of the profit against its share of the limits | 159.98560960172503 | 159.985609601726 | +9.663381206337363e-13 | PASS |
| CT: second tax row marginal relief = its share of the profit against its share of the limits | 1723.7159228056837 | 1723.71592280569 | +6.366462912410498e-12 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 covers the periods ending | 31 March 2024, 30 April 2024, 31 May 2024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 covers the periods ending | 30 June 2024, 31 July 2024, 31 August 2024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 covers the periods ending | 30 September 2024, 31 October 2024, 30 November 2024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 covers the periods ending | 31 December 2024, 31 January 2025, 28 February 2025 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 covers the periods ending | 31 March 2025, 30 April 2025, 31 May 2025 |
| The returns above also cover the periods ending 31 March 2025, 30 April 2025, 31 May 2025, which fall outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 180 |
| **The return forms as the package fills them in** |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 May 2024) box 1: VAT due on sales | 16,920 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 May 2024) box 4: VAT reclaimed on purchases | 6,023.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 May 2024) box 5: net VAT due | 10,896.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 August 2024) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 August 2024) box 4: VAT reclaimed on purchases | 4,473.25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 August 2024) box 5: net VAT due | 12,783.42 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 November 2024) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 November 2024) box 4: VAT reclaimed on purchases | 9,895.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 November 2024) box 5: net VAT due | 9,884.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 28 February 2025) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 28 February 2025) box 4: VAT reclaimed on purchases | 2,105.71 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 28 February 2025) box 5: net VAT due | 14,754.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 May 2025) box 1: VAT due on sales | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 May 2025) box 4: VAT reclaimed on purchases | 180 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 May 2025) box 5: net VAT due | 920 |
...
| E33 |  | 2023 |  |
| E34 |  | 2024 |  |
| F33 |  | 10567.1694055471 |  |
| F34 |  | 113852.728433959 |  |
| G33 |  | 25 |  |
| G34 |  | 25 |  |
| J33 |  | 2641.79235138677 |  |
| J34 |  | 28463.1821084897 |  |
| L33 |  | 159.985609601726 |  |
| L34 |  | 1723.71592280569 |  |
| I33 |  | 2481.80674178504 |  |
| I34 |  | 26739.466185684 |  |
