# Reconciliation Report: GB Accounts Company 2023-04-30 (Apr23) Excel 2007
...
| VAT Q1: payment due date (G7) = Vatinterface final date for payment (C8) | 44804 | 44804 | 0 | PASS |
...
| VAT Q2: payment due date (G7) = Vatinterface final date for payment (C11) | 44895 | 44895 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 44985 | 44985 | 0 | PASS |
...
| VAT Q4: payment due date (G7) = Vatinterface final date for payment (C17) | 45077 | 45077 | 0 | PASS |
...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C20) | 45169 | 45169 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 45046 | 45046 | 0 | PASS |
...
| Payslips!Jul K59 the monthly payroll opens in the accounting period's Jul | 44743 | 44743 | 0 | PASS |
...
| Payslips!Apr K69 the monthly payroll opens in the accounting period's Apr | 45017 | 45017 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 45046 | 45046 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 45046 | 45046 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 45046 | 45046 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 45046 | 45046 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 45046 | 45046 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 365 | 0 | PASS |
| Admin: first financial year row starts at the accounting period start | 44682 | 44682 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 45017 | 45017 | 0 | PASS |
| Admin: second financial year row ends at the year end | 45046 | 45046 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 44682 | 44682 | 0 | PASS |
| CT: working sheet heading ends at the year end | 45046 | 45046 | 0 | PASS |
| CT: the two tax rows span the accounting period | 365 | 365 | 0 | PASS |
| CT600: return period starts at the accounting period start | 44682 | 44682 | 0 | PASS |
| CT600: return period ends at the year end | 45046 | 45046 | 0 | PASS |
...
| CT600: amount of profit = first tax row profit | 114193.604866396 | 114193.604866396 | 0 | PASS |
| CT600: tax rate = first tax row rate | 25 | 25 | 0 | PASS |
| CT600: corporation tax = first tax row gross tax | 28548.4012165989 | 28548.4012165989 | 0 | PASS |
| CT600: second financial year tax = second tax row gross tax | 2556.57324327752 | 2556.57324327752 | 0 | PASS |
| CT600: second financial year = second tax row financial year | 2023 | 2023 | 0 | PASS |
| CT600: second financial year profit = second tax row profit | 10226.2929731101 | 10226.2929731101 | 0 | PASS |
| CT600: second financial year rate = second tax row rate | 25 | 25 | 0 | PASS |
| CT600: tax payable = tax chargeable | 31104.97445987642 | 31104.9744598765 | +8.003553375601768e-11 | PASS |
| CT600: marginal rate relief = the working sheet's relief | 1883.7015324074112 | 1883.70153240741 | -1.1368683772161603e-12 | PASS |
...
| CT: first tax row profit = chargeable profit by its share of those days | 114193.60486639591 | 114193.604866396 | +8.731149137020111e-11 | PASS |
| CT: second tax row profit = chargeable profit by its share of those days | 10226.292973110083 | 10226.2929731101 | +1.6370904631912708e-11 | PASS |
| CT: first tax row gross tax = its profit at its rate | 28548.401216599 | 28548.4012165989 | -9.822542779147625e-11 | PASS |
| CT: second tax row gross tax = its profit at its rate | 2556.573243277525 | 2556.57324327752 | -5.002220859751105e-12 | PASS |
| CT: first tax row tax = its gross tax less its marginal relief | 26819.52446767703 | 26819.5244676771 | +6.912159733474255e-11 | PASS |
| CT: second tax row tax = its gross tax less its marginal relief | 2401.748459791979 | 2401.74845979198 | +1.3642420526593924e-12 | PASS |
| CT: charge for the year = the two tax rows | 29221.27292746908 | 29221.272927469 | -8.003553375601768e-11 | PASS |
...
| CT: first tax row marginal relief = its share of the profit against its share of the limits | 1728.8767489218683 | 1728.87674892187 | +1.8189894035458565e-12 | PASS |
| CT: second tax row marginal relief = its share of the profit against its share of the limits | 154.8247834855403 | 154.824783485541 | +6.821210263296962e-13 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Box 44: amount of profit | 114,193.6 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 45: rate of tax | 25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 46: tax | 28,548.4 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 53: financial year | 2,023 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 54: amount of profit | 10,226.29 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 covers the periods ending | 31 May 2022, 30 June 2022, 31 July 2022 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 covers the periods ending | 31 August 2022, 30 September 2022, 31 October 2022 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 covers the periods ending | 30 November 2022, 31 December 2022, 31 January 2023 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 covers the periods ending | 28 February 2023, 31 March 2023, 30 April 2023 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 covers the periods ending | 31 May 2023, 30 June 2023, 31 July 2023 |
| The returns above also cover the periods ending 31 May 2023, 30 June 2023, 31 July 2023, which fall outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 180 |
| **The return forms as the package fills them in** |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 July 2022) box 1: VAT due on sales | 16,920 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 July 2022) box 4: VAT reclaimed on purchases | 6,023.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 July 2022) box 5: net VAT due | 10,896.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 October 2022) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 October 2022) box 4: VAT reclaimed on purchases | 4,473.25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 October 2022) box 5: net VAT due | 12,783.42 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 January 2023) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 January 2023) box 4: VAT reclaimed on purchases | 9,895.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 January 2023) box 5: net VAT due | 9,884.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 April 2023) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 April 2023) box 4: VAT reclaimed on purchases | 2,105.71 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 April 2023) box 5: net VAT due | 14,754.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 July 2023) box 1: VAT due on sales | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 July 2023) box 4: VAT reclaimed on purchases | 180 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 July 2023) box 5: net VAT due | 920 |
...
| E33 |  | 2022 |  |
| E34 |  | 2023 |  |
| F33 |  | 114193.604866396 |  |
| F34 |  | 10226.2929731101 |  |
| G33 |  | 25 |  |
| G34 |  | 25 |  |
| J33 |  | 28548.4012165989 |  |
| J34 |  | 2556.57324327752 |  |
| L33 |  | 1728.87674892187 |  |
| L34 |  | 154.824783485541 |  |
| I33 |  | 26819.5244676771 |  |
| I34 |  | 2401.74845979198 |  |
...
| N126 | Box 44: amount of profit | 114193.604866396 | gl-cor:amount (ct600.box44) |
| AA126 | Box 45: rate of tax | 25 | gl-cor:rate (ct600.box45) |
| AJ126 | Box 46: tax | 28548.4012165989 | gl-cor:taxAmount (ct600.box46) |
| C128 | Box 53: financial year | 2023 | gl-cor:period (ct600.box53) |
| N128 | Box 54: amount of profit | 10226.2929731101 | gl-cor:amount (ct600.box54) |
| AA128 | Box 55: rate of tax | 25 | gl-cor:rate (ct600.box55) |
| AJ128 | Box 56: tax | 2556.57324327752 | gl-cor:taxAmount (ct600.box56) |
