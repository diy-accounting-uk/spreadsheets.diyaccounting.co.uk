...
| Board minute: meeting date = the scenario's board meeting | 46568 | 46568 | 0 | PASS |
...
| P&L Jul C27 = Purchases.xlsx "a" and "e" net | 0 | 0 | 0 | PASS |
...
| P&L Aug D27 = Purchases.xlsx "a" and "e" net | 500 | 500 | 0 | PASS |
...
| P&L Sep E27 = Purchases.xlsx "a" and "e" net | 0 | 0 | 0 | PASS |
...
| P&L Oct F27 = Purchases.xlsx "a" and "e" net | 400 | 400 | 0 | PASS |
...
| P&L Nov G27 = Purchases.xlsx "a" and "e" net | 291.67 | 291.666666666667 | -0.003333333332989241 | PASS |
...
| P&L Dec H27 = Purchases.xlsx "a" and "e" net | 0 | 0 | 0 | PASS |
...
| P&L Jan I27 = Purchases.xlsx "a" and "e" net | 2500 | 2500 | 0 | PASS |
...
| P&L Feb J27 = Purchases.xlsx "a" and "e" net | 0 | 0 | 0 | PASS |
...
| P&L Mar K27 = Purchases.xlsx "a" and "e" net | 0 | 0 | 0 | PASS |
...
| P&L Apr L27 = Purchases.xlsx "a" and "e" net | 400 | 400 | 0 | PASS |
...
| P&L May M27 = Purchases.xlsx "a" and "e" net | 0 | 0 | 0 | PASS |
...
| P&L Jun N27 = Purchases.xlsx "a" and "e" net | 0 | 0 | 0 | PASS |
...
| Payslips!Jul K49 the monthly payroll opens in the accounting period's Jul | 46204 | 46204 | 0 | PASS |
| Payslips!Aug K49 the monthly payroll opens in the accounting period's Aug | 46235 | 46235 | 0 | PASS |
| Payslips!Sep K59 the monthly payroll opens in the accounting period's Sep | 46266 | 46266 | 0 | PASS |
| Payslips!Oct K49 the monthly payroll opens in the accounting period's Oct | 46296 | 46296 | 0 | PASS |
| Payslips!Nov K49 the monthly payroll opens in the accounting period's Nov | 46327 | 46327 | 0 | PASS |
| Payslips!Dec K59 the monthly payroll opens in the accounting period's Dec | 46357 | 46357 | 0 | PASS |
| Payslips!Jan K49 the monthly payroll opens in the accounting period's Jan | 46388 | 46388 | 0 | PASS |
| Payslips!Feb K49 the monthly payroll opens in the accounting period's Feb | 46419 | 46419 | 0 | PASS |
| Payslips!Mar K59 the monthly payroll opens in the accounting period's Mar | 46447 | 46447 | 0 | PASS |
| Payslips!Apr K49 the monthly payroll opens in the accounting period's Apr | 46478 | 46478 | 0 | PASS |
| Payslips!May K49 the monthly payroll opens in the accounting period's May | 46508 | 46508 | 0 | PASS |
| Payslips!Jun K69 the monthly payroll opens in the accounting period's Jun | 46539 | 46539 | 0 | PASS |
...
| Payslips print: the period ends the day the scenario paid that month's wages | 46265 | 46265 | 0 | PASS |
...
| Payslips print: the payment date is the day the scenario paid that month's wages | 46265 | 46265 | 0 | PASS |
...
| Payslips!Oct M49 wages paid date | 46326 | 46326 | 0 | PASS |
...
| Payslips!Nov M49 wages paid date | 46356 | 46356 | 0 | PASS |
...
| CT600: corporation tax = first tax row gross tax | 23350.0356219346 | 23350.0356219346 | 0 | PASS |
...
| CT600: marginal rate relief = the working sheet's relief | 1364.3825111230499 | 1364.38251112305 | +2.2737367544323206e-13 | PASS |
...
| CT: first tax row gross tax = its profit at its rate | 23350.03562193465 | 23350.0356219346 | -5.093170329928398e-11 | PASS |
| CT: second tax row gross tax = its profit at its rate | 7754.9388379418 | 7754.9388379418 | 0 | PASS |
| CT: first tax row tax = its gross tax less its marginal relief | 22325.81423002305 | 22325.8142300231 | +5.093170329928398e-11 | PASS |
| CT: second tax row tax = its gross tax less its marginal relief | 7414.7777187303 | 7414.7777187303 | 0 | PASS |
...
| CT: first tax row marginal relief = its share of the augmented profits against its share of the limits | 1024.2213919115454 | 1024.22139191155 | +4.547473508864641e-12 | PASS |
| CT: second tax row marginal relief = its share of the augmented profits against its share of the limits | 340.1611192114987 | 340.1611192115 | +1.3073986337985843e-12 | PASS |
...
| Category netting: Advertising, Promotion & Entertainment (purchases a) net reaches MnthP&L!B27 with no residue | 0 | -3.637978807091713e-12 | -3.637978807091713e-12 | PASS |
...
| Add back business entertainment | CorporationTax!I9 | 291.67 |
...
| Advertising, Promotion & Entertainment (purchases a) | 4,910 | 818.33 | 4,091.67 | MnthP&L!B27 | 4,091.67 | 0 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Advertising & Entertainment (codes a, e) | 4,091.67 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Box 335: amount of profit | 93,400.14 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 340: rate of tax | 25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 345: tax | 23,350.04 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 380: financial year | 2,027 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 385: amount of profit | 31,019.76 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 390: rate of tax | 25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 395: tax | 7,754.94 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Final: Business Entertainment (code e) | 291.67 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 December 2026) box 4: VAT reclaimed on purchases | 4,531.58 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 December 2026) box 5: net VAT due | 12,725.08 |
...
| B27 | Advertising & Entertainment (codes a, e) | 4091.66666666667 | accounts.purchases.5500 + 5502 |
...
| G33 |  | 25 |  |
| G34 |  | 25 |  |
| J33 |  | 23350.0356219346 |  |
| J34 |  | 7754.9388379418 |  |
| L33 |  | 1024.22139191155 |  |
| L34 |  | 340.1611192115 |  |
| I33 |  | 22325.8142300231 |  |
| I34 |  | 7414.7777187303 |  |
...
| N126 | Box 335: amount of profit | 93400.1424877386 | gl-cor:amount (ct600.box335) |
| AA126 | Box 340: rate of tax | 25 | gl-cor:rate (ct600.box340) |
| AJ126 | Box 345: tax | 23350.0356219346 | gl-cor:taxAmount (ct600.box345) |
| C128 | Box 380: financial year | 2027 | gl-cor:period (ct600.box380) |
| N128 | Box 385: amount of profit | 31019.7553517672 | gl-cor:amount (ct600.box385) |
| AA128 | Box 390: rate of tax | 25 | gl-cor:rate (ct600.box390) |
| AJ128 | Box 395: tax | 7754.9388379418 | gl-cor:taxAmount (ct600.box395) |
