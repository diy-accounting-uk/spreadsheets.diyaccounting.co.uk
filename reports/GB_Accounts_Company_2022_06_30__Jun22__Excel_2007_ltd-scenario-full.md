# Reconciliation Report: GB Accounts Company 2022-06-30 (Jun22) Excel 2007
...
| VAT Q1: payment due date (G7) = Vatinterface final date for payment (C8) | 44500 | 44500 | 0 | PASS |
...
| VAT Q2: payment due date (G7) = Vatinterface final date for payment (C11) | 44592 | 44592 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 44681 | 44681 | 0 | PASS |
...
| VAT Q4: payment due date (G7) = Vatinterface final date for payment (C17) | 44773 | 44773 | 0 | PASS |
...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C20) | 44865 | 44865 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 44742 | 44742 | 0 | PASS |
...
| Payslips!Aug K49 the monthly payroll opens in the accounting period's Aug | 44409 | 44409 | 0 | PASS |
| Payslips!Sep K59 the monthly payroll opens in the accounting period's Sep | 44440 | 44440 | 0 | PASS |
| Payslips!Oct K49 the monthly payroll opens in the accounting period's Oct | 44470 | 44470 | 0 | PASS |
| Payslips!Nov K49 the monthly payroll opens in the accounting period's Nov | 44501 | 44501 | 0 | PASS |
| Payslips!Dec K59 the monthly payroll opens in the accounting period's Dec | 44531 | 44531 | 0 | PASS |
| Payslips!Jan K49 the monthly payroll opens in the accounting period's Jan | 44562 | 44562 | 0 | PASS |
| Payslips!Feb K49 the monthly payroll opens in the accounting period's Feb | 44593 | 44593 | 0 | PASS |
| Payslips!Mar K59 the monthly payroll opens in the accounting period's Mar | 44621 | 44621 | 0 | PASS |
| Payslips!Apr K49 the monthly payroll opens in the accounting period's Apr | 44652 | 44652 | 0 | PASS |
| Payslips!May K49 the monthly payroll opens in the accounting period's May | 44682 | 44682 | 0 | PASS |
| Payslips!Jun K69 the monthly payroll opens in the accounting period's Jun | 44713 | 44713 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 44742 | 44742 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 44742 | 44742 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 44742 | 44742 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 44742 | 44742 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 44742 | 44742 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 365 | 0 | PASS |
| Admin: first financial year row starts at the accounting period start | 44378 | 44378 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 44652 | 44652 | 0 | PASS |
| Admin: second financial year row ends at the year end | 44742 | 44742 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 44378 | 44378 | 0 | PASS |
| CT: working sheet heading ends at the year end | 44742 | 44742 | 0 | PASS |
| CT: the two tax rows span the accounting period | 365 | 365 | 0 | PASS |
| CT600: return period starts at the accounting period start | 44378 | 44378 | 0 | PASS |
| CT600: return period ends at the year end | 44742 | 44742 | 0 | PASS |
...
| CT600: corporation tax = first tax row gross tax | 17746.0270726703 | 17746.0270726703 | 0 | PASS |
| CT600: second financial year tax = second tax row gross tax | 5893.75351683577 | 5893.75351683577 | 0 | PASS |
...
| CT600: tax payable = tax chargeable | 23639.780589506066 | 23639.7805895061 | +3.2741809263825417e-11 | PASS |
...
| CT: first tax row gross tax = its profit at its rate | 17746.027072670335 | 17746.0270726703 | -3.637978807091713e-11 | PASS |
| CT: second tax row gross tax = its profit at its rate | 5893.753516835768 | 5893.75351683577 | +1.8189894035458565e-12 | PASS |
| CT: first tax row tax = its gross tax less its marginal relief | 17746.0270726703 | 17746.0270726703 | 0 | PASS |
| CT: second tax row tax = its gross tax less its marginal relief | 5893.75351683577 | 5893.75351683577 | 0 | PASS |
| CT: charge for the year = the two tax rows | 23639.780589506066 | 23639.7805895061 | +3.2741809263825417e-11 | PASS |
...
| | Amount |
|---|------:|
| &nbsp;&nbsp;&nbsp;&nbsp;Box 43: financial year | 2,021 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 44: amount of profit | 93,400.14 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 45: rate of tax | 19 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 46: tax | 17,746.03 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 53: financial year | 2,022 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 covers the periods ending | 31 July 2021, 31 August 2021, 30 September 2021 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 covers the periods ending | 31 October 2021, 30 November 2021, 31 December 2021 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 covers the periods ending | 31 January 2022, 28 February 2022, 31 March 2022 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 covers the periods ending | 30 April 2022, 31 May 2022, 30 June 2022 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 covers the periods ending | 31 July 2022, 31 August 2022, 30 September 2022 |
| The returns above also cover the periods ending 31 July 2022, 31 August 2022, 30 September 2022, which fall outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 180 |
| **The return forms as the package fills them in** |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 September 2021) box 1: VAT due on sales | 16,920 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 September 2021) box 4: VAT reclaimed on purchases | 6,023.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 September 2021) box 5: net VAT due | 10,896.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 December 2021) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 December 2021) box 4: VAT reclaimed on purchases | 4,473.25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 December 2021) box 5: net VAT due | 12,783.42 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 March 2022) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 March 2022) box 4: VAT reclaimed on purchases | 9,895.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 March 2022) box 5: net VAT due | 9,884.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 June 2022) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 June 2022) box 4: VAT reclaimed on purchases | 2,105.71 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 June 2022) box 5: net VAT due | 14,754.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 September 2022) box 1: VAT due on sales | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 September 2022) box 4: VAT reclaimed on purchases | 180 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 September 2022) box 5: net VAT due | 920 |
...
| G33 |  | 19 |  |
| G34 |  | 19 |  |
| J33 |  | 17746.0270726703 |  |
| J34 |  | 5893.75351683577 |  |
| L33 |  | 0 |  |
| L34 |  | 0 |  |
| I33 |  | 17746.0270726703 |  |
| I34 |  | 5893.75351683577 |  |
...
| Cell | DIY Label | Value | diya-gl mapping |
|------|-----------|-------|-----------------|
| C126 | Box 43: financial year | 2021 | gl-cor:period (ct600.box43) |
...
| AJ126 | Box 46: tax | 17746.0270726703 | gl-cor:taxAmount (ct600.box46) |
| C128 | Box 53: financial year | 2022 | gl-cor:period (ct600.box53) |
...
| AJ128 | Box 56: tax | 5893.75351683577 | gl-cor:taxAmount (ct600.box56) |
