...
| | Amount |
|---|------:|
| Audit Accuracy Check | -1,781,222 |
...
| D29 | Directors Loan | 1889882 | accounts.liabilities.2500 (pubBS) |
...
| Cell | DIY Label | Value | diya-gl mapping |
|------|-----------|-------|-----------------|
| EJ91 | Audit Accuracy Check | -1781222 | gl-cor:amount (trialBalanceCheck) |
