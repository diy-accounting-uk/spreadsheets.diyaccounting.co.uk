...
# Reconciliation Report: GB Accounts Company 2023-12-31 (Dec23) Excel 2007
...
| Trial Balance: audit accuracy (EJ91) | 0 | 2.96495272777975e-10 | +2.96495272777975e-10 | PASS |
...
| VAT Q1: payment due date (G7) = Vatinterface final date for payment (C8) | 45046 | 45046 | 0 | PASS |
...
| VAT Q2: payment due date (G7) = Vatinterface final date for payment (C11) | 45138 | 45138 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 45230 | 45230 | 0 | PASS |
...
| VAT Q4: payment due date (G7) = Vatinterface final date for payment (C17) | 45322 | 45322 | 0 | PASS |
...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C20) | 45412 | 45412 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 45291 | 45291 | 0 | PASS |
...
| Board minute: meeting date = the scenario's board meeting | 45291 | 45291 | 0 | PASS |
...
| Trial Balance: corporation tax creditor = opening plus the year's charge, less the interest tax credit and the payments coded RT | 28100.670087898896 | 28100.6700878989 | +3.637978807091713e-12 | PASS |
...
| Payslips!Jun K59 the monthly payroll opens in the accounting period's Jun | 45078 | 45078 | 0 | PASS |
...
| Payslips!Dec K69 the monthly payroll opens in the accounting period's Dec | 45261 | 45261 | 0 | PASS |
...
| Payslips print: the period ends the day the scenario paid that month's wages | 44985 | 44985 | 0 | PASS |
...
| Payslips print: the payment date is the day the scenario paid that month's wages | 44985 | 44985 | 0 | PASS |
...
| Payslips!Apr M49 wages paid date | 45046 | 45046 | 0 | PASS |
...
| Payslips!May M49 wages paid date | 45077 | 45077 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 45291 | 45291 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 45291 | 45291 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 45291 | 45291 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 45291 | 45291 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 45291 | 45291 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 365 | 0 | PASS |
| Admin: first financial year row starts at the accounting period start | 44927 | 44927 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 45017 | 45017 | 0 | PASS |
| Admin: second financial year row ends at the year end | 45291 | 45291 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 44927 | 44927 | 0 | PASS |
| CT: working sheet heading ends at the year end | 45291 | 45291 | 0 | PASS |
| CT: the two tax rows span the accounting period | 365 | 365 | 0 | PASS |
| CT600: return period starts at the accounting period start | 44927 | 44927 | 0 | PASS |
| CT600: return period ends at the year end | 45291 | 45291 | 0 | PASS |
...
| CT600: amount of profit = first tax row profit | 30606.961111111 | 30606.961111111 | 0 | PASS |
| CT600: tax rate = first tax row rate | 19 | 19 | 0 | PASS |
| CT600: corporation tax = first tax row gross tax | 5815.32261111109 | 5815.32261111109 | 0 | PASS |
| CT600: second financial year tax = second tax row gross tax | 23380.317515432 | 23380.317515432 | 0 | PASS |
| CT600: second financial year = second tax row financial year | 2023 | 2023 | 0 | PASS |
| CT600: second financial year profit = second tax row profit | 93521.2700617281 | 93521.2700617281 | 0 | PASS |
...
| CT600: tax payable = tax chargeable | 29195.64012654309 | 29195.6401265431 | +1.0913936421275139e-11 | PASS |
| CT600: marginal rate relief = the working sheet's relief | 1030.46386580476 | 1030.46386580476 | 0 | PASS |
| CT600: tax net of marginal relief = the working sheet's charge | 28165.1762607384 | 28165.1762607384 | 0 | PASS |
| CT600: corporation tax chargeable = tax net of marginal relief | 28165.1762607384 | 28165.1762607384 | 0 | PASS |
| CT600: underlying rate of corporation tax = the tax it bears over the profits chargeable | 22.690387186393206 | 22.6903871863932 | -7.105427357601002e-15 | PASS |
| CT600: tax outstanding | 28100.6700878989 | 28100.6700878989 | 0 | PASS |
| Fixed asset note: corporation tax for the year = CT charge | 28165.1762607384 | 28165.1762607384 | 0 | PASS |
...
| CT: first tax row profit = chargeable profit by its share of those days | 30606.961111110988 | 30606.961111111 | +1.0913936421275139e-11 | PASS |
| CT: second tax row profit = chargeable profit by its share of those days | 93521.270061728 | 93521.2700617281 | +8.731149137020111e-11 | PASS |
| CT: first tax row gross tax = its profit at its rate | 5815.322611111089 | 5815.32261111109 | +9.094947017729282e-13 | PASS |
| CT: second tax row gross tax = its profit at its rate | 23380.317515432023 | 23380.317515432 | -2.1827872842550278e-11 | PASS |
| CT: first tax row tax = its gross tax less its marginal relief | 5815.32261111109 | 5815.32261111109 | 0 | PASS |
| CT: second tax row tax = its gross tax less its marginal relief | 22349.853649627243 | 22349.8536496273 | +5.820766091346741e-11 | PASS |
| CT: charge for the year = the two tax rows | 28165.17626073839 | 28165.1762607384 | +1.0913936421275139e-11 | PASS |
...
| CT: second tax row marginal relief = its share of the augmented profits against its share of the limits | 1030.4638658047652 | 1030.46386580476 | -5.229594535194337e-12 | PASS |
...
| CT: charge for the year = the statutory computation with marginal relief | 28165.176260738328 | 28165.1762607384 | +7.275957614183426e-11 | PASS |
| CT: Tax outstanding = CT less tax deducted at source | 28100.670087898896 | 28100.6700878989 | +3.637978807091713e-12 | PASS |
...
| **Corporation Tax** | 28,165.18 |
| Tax Outstanding | 28,100.67 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Box 345: tax | 5,815.32 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 380: financial year | 2,023 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 385: amount of profit | 93,521.27 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 390: rate of tax | 25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 395: tax | 23,380.32 |
| **Box 430: corporation tax** | 29,195.64 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 435: marginal rate relief | 1,030.46 |
| **Box 440: corporation tax net of marginal rate relief** | 28,165.18 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Corporation tax | 28,165.18 |
| **Profit after Tax** | 143,723.05 |
| &nbsp;&nbsp;&nbsp;&nbsp;Dividends | 15,000 |
| **Retained Profit for the year** | 128,723.05 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Corporation Tax | 28,100.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Taxation and Social Security | 9,077.46 |
| &nbsp;&nbsp;&nbsp;&nbsp;Current Liabilities | 48,360.38 |
| **Net Current Assets** | 158,535.05 |
| **Total Assets less CL** | 367,525.05 |
| &nbsp;&nbsp;&nbsp;&nbsp;Directors Loan | 13,000 |
| &nbsp;&nbsp;&nbsp;&nbsp;Creditors due after more than one year | 45,000 |
| &nbsp;&nbsp;&nbsp;&nbsp;Other Creditors | 58,000 |
| **Net Assets** | 309,525.05 |
| &nbsp;&nbsp;&nbsp;&nbsp;Called up share capital | 100 |
| **Shareholders' Funds** | 309,525.05 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Corporation tax for the year | 28,165.18 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 covers the periods ending | 31 January 2023, 28 February 2023, 31 March 2023 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 covers the periods ending | 30 April 2023, 31 May 2023, 30 June 2023 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 covers the periods ending | 31 July 2023, 31 August 2023, 30 September 2023 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 covers the periods ending | 31 October 2023, 30 November 2023, 31 December 2023 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 covers the periods ending | 31 January 2024, 29 February 2024, 31 March 2024 |
| The returns above also cover the periods ending 31 January 2024, 29 February 2024, 31 March 2024, which fall outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 180 |
| **The return forms as the package fills them in** |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 March 2023) box 1: VAT due on sales | 16,920 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 March 2023) box 4: VAT reclaimed on purchases | 6,023.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 March 2023) box 5: net VAT due | 10,896.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 June 2023) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 June 2023) box 4: VAT reclaimed on purchases | 4,531.58 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 June 2023) box 5: net VAT due | 12,725.08 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 September 2023) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 September 2023) box 4: VAT reclaimed on purchases | 9,895.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 September 2023) box 5: net VAT due | 9,884.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 December 2023) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 December 2023) box 4: VAT reclaimed on purchases | 2,105.71 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 December 2023) box 5: net VAT due | 14,754.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 March 2024) box 1: VAT due on sales | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 March 2024) box 4: VAT reclaimed on purchases | 180 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 March 2024) box 5: net VAT due | 920 |
...
| K35 | **Corporation Tax** | 28165.1762607384 | gl-cor:taxAmount (ct600.box430) |
| K39 | Tax Outstanding | 28100.6700878989 | gl-cor:taxAmount (ct600.box600) |
| E5 |  | 44927 |  |
| H5 |  | 45291 |  |
| I15 |  | 52500 |  |
| I16 |  | 0 |  |
...
| G33 |  | 19 |  |
| G34 |  | 25 |  |
| J33 |  | 5815.32261111109 |  |
| J34 |  | 23380.317515432 |  |
| L33 |  | 0 |  |
| L34 |  | 1030.46386580476 |  |
| I33 |  | 5815.32261111109 |  |
...
| AJ126 | Box 345: tax | 5815.32261111109 | gl-cor:taxAmount (ct600.box345) |
...
| AJ131 | **Box 430: corporation tax** | 29195.6401265431 | gl-cor:taxAmount (ct600.box430) |
| Y133 | Box 435: marginal rate relief | 1030.46386580476 | gl-cor:taxAmount (ct600.box435) |
| Y135 | **Box 440: corporation tax net of marginal rate relief** | 28165.1762607384 | gl-cor:taxAmount (ct600.box440) |
...
| AJ145 |  | 28165.1762607384 |  |
| AJ154 |  | 64.5061728395062 |  |
| AJ159 |  | 28100.6700878989 |  |
| AJ166 |  | 28100.6700878989 |  |
...
| F50 | Corporation tax | 28165.1762607384 | gl-cor:taxAmount (pubPL.tax) |
| F51 | **Profit after Tax** | 143723.054912101 | gl-cor:amount (pubPL.pat) |
| F52 | Dividends | 15000 | gl-cor:amount (pubPL.dividends) |
| F54 | **Retained Profit for the year** | 128723.054912101 | gl-cor:amount (pubPL.retained) |
| D3 |  | 45291 |  |
| B9 |  | 0 |  |
| B14 |  | 0 |  |
| B18 |  | 0 |  |
...
| E17 | Corporation Tax | 28100.6700878989 | accounts.liabilities.2300 (pubBS) |
| E18 | Taxation and Social Security | 9077.45500000003 | gl-cor:amount (pubBS.taxAndSocial) |
| E20 | Current Liabilities | 48360.3750878989 | gl-cor:amount (pubBS.creditors) |
| F22 | **Net Current Assets** | 158535.054912101 | gl-cor:amount (pubBS.netCurrent) |
| F26 | **Total Assets less CL** | 367525.054912101 | gl-cor:amount (pubBS.totalAssetsLessCL) |
...
| F33 | **Net Assets** | 309525.054912101 | gl-cor:amount (pubBS.netAssets) |
| F36 | Called up share capital | 100 | accounts.capital.3000 (pubBS) |
| F39 | **Shareholders' Funds** | 309525.054912101 | gl-cor:amount (pubBS.equity) |
| D2 |  | 45291 |  |
...
| D41 | Corporation tax for the year | 28165.1762607384 | gl-cor:taxAmount (note4.ct) |
| B8 |  | 200000 |  |
| B9 |  | 0 |  |
| B10 |  | 0 |  |
| B11 |  | 200000 |  |
...
| EJ91 | **Audit Accuracy Check** | 2.96495272777975e-10 | gl-cor:amount (trialBalanceCheck) |
| EJ66 |  | 16742.6666666667 |  |
| EJ28 |  | -11182.25 |  |
| EJ32 |  | 0 |  |
| EJ33 |  | -9077.45500000003 |  |
| EJ34 |  | 0 |  |
| EJ35 |  | -28100.6700878989 |  |
