...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C18) | 44592 | 44592 | 0 | PASS |
...
| The returns above also cover the period ending 31 December 2021, which falls outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 600 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 40 |
| Q4 and Q5 end one month apart rather than one quarter, so both cover the periods ending 31 October 2021 and 30 November 2021. The last form is a spare, for a business whose quarter stagger puts five returns across the accounting year; each form takes its period from a dropdown of the month ends the book carries. As shipped it is dated a month after the fourth, so filing all of them as they stand would declare those periods twice. |  |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 December 2021) box 1: VAT due on sales | 11,553.33 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 December 2021) box 4: VAT reclaimed on purchases | 1,393.83 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 December 2021) box 5: net VAT due | 10,159.5 |
