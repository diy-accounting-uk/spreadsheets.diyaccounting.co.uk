...
# Reconciliation Report: GB Accounts Company 2021-01-31 (Jan21) Excel 2007
...
| VAT Q1: payment due date (G7) = Vatinterface final date for payment (C8) | 43982 | 43982 | 0 | PASS |
...
| VAT Q2: payment due date (G7) = Vatinterface final date for payment (C11) | 44074 | 44074 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 44165 | 44165 | 0 | PASS |
...
| VAT Q4: payment due date (G7) = Vatinterface final date for payment (C17) | 44255 | 44255 | 0 | PASS |
...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C20) | 44347 | 44347 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 44227 | 44227 | 0 | PASS |
...
| Board minute: meeting date = the scenario's board meeting | 44227 | 44227 | 0 | PASS |
...
| Payslips!Jan K69 the monthly payroll opens in the accounting period's Jan | 44197 | 44197 | 0 | PASS |
...
| Payslips print: the period ends the day the scenario paid that month's wages | 43921 | 43921 | 0 | PASS |
...
| Payslips print: the payment date is the day the scenario paid that month's wages | 43921 | 43921 | 0 | PASS |
...
| Payslips!Jun M49 wages paid date | 44012 | 44012 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 44227 | 44227 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 44227 | 44227 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 44227 | 44227 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 44227 | 44227 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 44227 | 44227 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 366 | +1 | PASS |
| Admin: first financial year row starts at the accounting period start | 43862 | 43862 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 43922 | 43922 | 0 | PASS |
| Admin: second financial year row ends at the year end | 44227 | 44227 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 43862 | 43862 | 0 | PASS |
| CT: working sheet heading ends at the year end | 44227 | 44227 | 0 | PASS |
| CT: the two tax rows span the accounting period | 366 | 366 | 0 | PASS |
| CT600: return period starts at the accounting period start | 43862 | 43862 | 0 | PASS |
| CT600: return period ends at the year end | 44227 | 44227 | 0 | PASS |
...
| CT600: amount of profit = first tax row profit | 20348.8903562031 | 20348.8903562031 | 0 | PASS |
| CT600: tax rate = first tax row rate | 19 | 19 | 0 | PASS |
| CT600: corporation tax = first tax row gross tax | 3866.2891676786 | 3866.2891676786 | 0 | PASS |
| CT600: second financial year tax = second tax row gross tax | 19718.0747551608 | 19718.0747551608 | 0 | PASS |
| CT600: second financial year = second tax row financial year | 2020 | 2020 | 0 | PASS |
| CT600: second financial year profit = second tax row profit | 103779.340816636 | 103779.340816636 | 0 | PASS |
...
| CT: first tax row profit = chargeable profit by its share of those days | 20348.890356203116 | 20348.8903562031 | -1.4551915228366852e-11 | PASS |
| CT: second tax row profit = chargeable profit by its share of those days | 103779.34081663589 | 103779.340816636 | +1.1641532182693481e-10 | PASS |
| CT: first tax row gross tax = its profit at its rate | 3866.289167678589 | 3866.2891676786 | +1.0913936421275139e-11 | PASS |
| CT: second tax row gross tax = its profit at its rate | 19718.07475516084 | 19718.0747551608 | -4.001776687800884e-11 | PASS |
| CT: first tax row tax = its gross tax less its marginal relief | 3866.2891676786 | 3866.2891676786 | 0 | PASS |
| CT: second tax row tax = its gross tax less its marginal relief | 19718.0747551608 | 19718.0747551608 | 0 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Box 335: amount of profit | 20,348.89 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 340: rate of tax | 19 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 345: tax | 3,866.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 380: financial year | 2,020 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 385: amount of profit | 103,779.34 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 390: rate of tax | 19 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 395: tax | 19,718.07 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 covers the periods ending | 29 February 2020, 31 March 2020, 30 April 2020 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 covers the periods ending | 31 May 2020, 30 June 2020, 31 July 2020 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 covers the periods ending | 31 August 2020, 30 September 2020, 31 October 2020 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 covers the periods ending | 30 November 2020, 31 December 2020, 31 January 2021 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 covers the periods ending | 28 February 2021, 31 March 2021, 30 April 2021 |
| The returns above also cover the periods ending 28 February 2021, 31 March 2021, 30 April 2021, which fall outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 180 |
| **The return forms as the package fills them in** |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 April 2020) box 1: VAT due on sales | 16,920 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 April 2020) box 4: VAT reclaimed on purchases | 6,023.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 April 2020) box 5: net VAT due | 10,896.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 July 2020) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 July 2020) box 4: VAT reclaimed on purchases | 4,531.58 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 July 2020) box 5: net VAT due | 12,725.08 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 October 2020) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 October 2020) box 4: VAT reclaimed on purchases | 9,895.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 October 2020) box 5: net VAT due | 9,884.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 January 2021) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 January 2021) box 4: VAT reclaimed on purchases | 2,105.71 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 January 2021) box 5: net VAT due | 14,754.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 April 2021) box 1: VAT due on sales | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 April 2021) box 4: VAT reclaimed on purchases | 180 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 April 2021) box 5: net VAT due | 920 |
...
| E33 |  | 2019 |  |
| E34 |  | 2020 |  |
| F33 |  | 20348.8903562031 |  |
| F34 |  | 103779.340816636 |  |
| G33 |  | 19 |  |
| G34 |  | 19 |  |
| J33 |  | 3866.2891676786 |  |
| J34 |  | 19718.0747551608 |  |
| L33 |  | 0 |  |
| L34 |  | 0 |  |
| I33 |  | 3866.2891676786 |  |
| I34 |  | 19718.0747551608 |  |
...
| N126 | Box 335: amount of profit | 20348.8903562031 | gl-cor:amount (ct600.box335) |
| AA126 | Box 340: rate of tax | 19 | gl-cor:rate (ct600.box340) |
| AJ126 | Box 345: tax | 3866.2891676786 | gl-cor:taxAmount (ct600.box345) |
| C128 | Box 380: financial year | 2020 | gl-cor:period (ct600.box380) |
| N128 | Box 385: amount of profit | 103779.340816636 | gl-cor:amount (ct600.box385) |
| AA128 | Box 390: rate of tax | 19 | gl-cor:rate (ct600.box390) |
| AJ128 | Box 395: tax | 19718.0747551608 | gl-cor:taxAmount (ct600.box395) |
