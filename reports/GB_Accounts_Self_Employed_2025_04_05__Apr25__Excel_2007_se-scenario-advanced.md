...
# Reconciliation Report: GB Accounts Self Employed 2025-04-05 (Apr25) Excel 2007
...
| Forecast: National Insurance | 3673.6670000000004 | 3673.66699999999 | -1.0459189070388675e-11 | PASS |
| Forecast: tax and NI liability | 43617.67700000001 | 43617.6769999997 | -3.128661774098873e-10 | PASS |
...
| SA103F: the period the return covers starts on the Admin tax year start (Q2 = B4) | 45388 | 45388 | 0 | PASS |
| SA103F: the period the return covers ends on the Admin tax year end (V2 = B17) | 45752 | 45752 | 0 | PASS |
...
| SA103F: the online filing deadline banner (G1) names 31 January the year after the tax year ends | COPY DETAILS TO HMRC FORM          Submit HMRC RETURN ONLINE                   by 31st January 2026 | COPY DETAILS TO HMRC FORM          Submit HMRC RETURN ONLINE                   by 31st January 2026 |  | PASS |
...
| Admin: Amounts Payable By date (B21) = 31 January the year after the tax year ends | 46053 | 46053 | 0 | PASS |
| Payslips calendar: the payroll year starts on the accounts tax year start (B2 = Admin B4) | 45388 | 45388 | 0 | PASS |
| Payslips calendar: the year the calendar runs to (I1) = the accounts tax year end (Admin B17) | 45752 | 45752 | 0 | PASS |
| Payslips calendar: the tax year the payslips print (N1) = the tax year the package was generated for | 2024-25 | 2024-25 |  | PASS |
| Payslips calendar row 2: the date runs on unbroken from the tax year start | 45388 | 45388 | 0 | PASS |
| Payslips calendar row 2: the month name is its payroll month counted from the tax year start | Apr | Apr |  | PASS |
| Payslips calendar row 33: the date runs on unbroken from the tax year start | 45419 | 45419 | 0 | PASS |
| Payslips calendar row 33: the month name is its payroll month counted from the tax year start | May | May |  | PASS |
| Payslips calendar row 64: the date runs on unbroken from the tax year start | 45450 | 45450 | 0 | PASS |
| Payslips calendar row 64: the month name is its payroll month counted from the tax year start | Jun | Jun |  | PASS |
| Payslips calendar row 95: the date runs on unbroken from the tax year start | 45481 | 45481 | 0 | PASS |
| Payslips calendar row 95: the month name is its payroll month counted from the tax year start | Jul | Jul |  | PASS |
| Payslips calendar row 126: the date runs on unbroken from the tax year start | 45512 | 45512 | 0 | PASS |
| Payslips calendar row 126: the month name is its payroll month counted from the tax year start | Aug | Aug |  | PASS |
| Payslips calendar row 157: the date runs on unbroken from the tax year start | 45543 | 45543 | 0 | PASS |
| Payslips calendar row 157: the month name is its payroll month counted from the tax year start | Sep | Sep |  | PASS |
| Payslips calendar row 188: the date runs on unbroken from the tax year start | 45574 | 45574 | 0 | PASS |
| Payslips calendar row 188: the month name is its payroll month counted from the tax year start | Oct | Oct |  | PASS |
| Payslips calendar row 219: the date runs on unbroken from the tax year start | 45605 | 45605 | 0 | PASS |
| Payslips calendar row 219: the month name is its payroll month counted from the tax year start | Nov | Nov |  | PASS |
| Payslips calendar row 250: the date runs on unbroken from the tax year start | 45636 | 45636 | 0 | PASS |
| Payslips calendar row 250: the month name is its payroll month counted from the tax year start | Dec | Dec |  | PASS |
| Payslips calendar row 281: the date runs on unbroken from the tax year start | 45667 | 45667 | 0 | PASS |
| Payslips calendar row 281: the month name is its payroll month counted from the tax year start | Jan | Jan |  | PASS |
| Payslips calendar row 312: the date runs on unbroken from the tax year start | 45698 | 45698 | 0 | PASS |
| Payslips calendar row 312: the month name is its payroll month counted from the tax year start | Feb | Feb |  | PASS |
| Payslips calendar row 343: the date runs on unbroken from the tax year start | 45729 | 45729 | 0 | PASS |
| Payslips calendar row 343: the month name is its payroll month counted from the tax year start | Mar | Mar |  | PASS |
| Payslips calendar row 366: the date runs on unbroken from the tax year start | 45752 | 45752 | 0 | PASS |
| Payslips calendar row 366: the month name is its payroll month counted from the tax year start | Mar | Mar |  | PASS |
| Payslips calendar row 381: the date runs on unbroken from the tax year start | 45767 | 45767 | 0 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;National Insurance | 3,673.67 |
| **Forecast Tax & NI Liability** | 43,617.68 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 June 2024) box 4: VAT reclaimed on purchases | 5,993.5 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 June 2024) box 5: net VAT due | 10,926.5 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 September 2024) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 September 2024) box 4: VAT reclaimed on purchases | 4,509.83 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 September 2024) box 5: net VAT due | 12,746.83 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 December 2024) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 December 2024) box 4: VAT reclaimed on purchases | 9,867 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 December 2024) box 5: net VAT due | 9,913 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 March 2025) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 March 2025) box 4: VAT reclaimed on purchases | 2,084.33 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 March 2025) box 5: net VAT due | 14,775.67 |
...
| C45 | National Insurance | 3673.66699999999 | tax.nationalInsurance.class4 |
| C46 | **Forecast Tax & NI Liability** | 43617.6769999997 | gl-cor:taxAmount (forecast.totalTaxNI) |
...
| S17 | Accounting date | 45388 | documentInfo.periodCoveredEnd |
...
| G1 |  | COPY DETAILS TO HMRC FORM          Submit HMRC RETURN ONLINE                   by 31st January 2026 |  |
| Q2 |  | 45388 |  |
| V2 |  | 45752 |  |
| G141 |  | 0.18 |  |
| J280 |  | 12570 |  |
