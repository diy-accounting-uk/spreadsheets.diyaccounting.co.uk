...
# Reconciliation Report: GB Accounts Company 2022-09-30 (Sep22) Excel 2007
...
| VAT Q1: payment due date (G7) = Vatinterface final date for payment (C8) | 44592 | 44592 | 0 | PASS |
...
| VAT Q2: payment due date (G7) = Vatinterface final date for payment (C11) | 44681 | 44681 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 44773 | 44773 | 0 | PASS |
...
| VAT Q4: payment due date (G7) = Vatinterface final date for payment (C17) | 44865 | 44865 | 0 | PASS |
...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C20) | 44957 | 44957 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 44834 | 44834 | 0 | PASS |
...
| Board minute: meeting date = the scenario's board meeting | 44834 | 44834 | 0 | PASS |
...
| Payslips!Sep K69 the monthly payroll opens in the accounting period's Sep | 44805 | 44805 | 0 | PASS |
...
| Payslips print: the period ends the day the scenario paid that month's wages | 44530 | 44530 | 0 | PASS |
...
| Payslips print: the payment date is the day the scenario paid that month's wages | 44530 | 44530 | 0 | PASS |
...
| Payslips!Feb M49 wages paid date | 44620 | 44620 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 44834 | 44834 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 44834 | 44834 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 44834 | 44834 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 44834 | 44834 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 44834 | 44834 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 365 | 0 | PASS |
| Admin: first financial year row starts at the accounting period start | 44470 | 44470 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 44652 | 44652 | 0 | PASS |
| Admin: second financial year row ends at the year end | 44834 | 44834 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 44470 | 44470 | 0 | PASS |
| CT: working sheet heading ends at the year end | 44834 | 44834 | 0 | PASS |
| CT: the two tax rows span the accounting period | 365 | 365 | 0 | PASS |
| CT600: return period starts at the accounting period start | 44470 | 44470 | 0 | PASS |
| CT600: return period ends at the year end | 44834 | 44834 | 0 | PASS |
...
| CT600: second financial year tax = second tax row gross tax | 11824.4893092592 | 11824.4893092592 | 0 | PASS |
...
| CT: second tax row gross tax = its profit at its rate | 11824.48930925923 | 11824.4893092592 | -3.092281986027956e-11 | PASS |
| CT: first tax row tax = its gross tax less its marginal relief | 11759.8746135802 | 11759.8746135802 | 0 | PASS |
| CT: second tax row tax = its gross tax less its marginal relief | 11824.4893092592 | 11824.4893092592 | 0 | PASS |
...
| CT: charge for the year = the statutory computation with marginal relief | 23584.363922839417 | 23584.3639228394 | -1.8189894035458565e-11 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 covers the periods ending | 31 October 2021, 30 November 2021, 31 December 2021 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 covers the periods ending | 31 January 2022, 28 February 2022, 31 March 2022 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 covers the periods ending | 30 April 2022, 31 May 2022, 30 June 2022 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 covers the periods ending | 31 July 2022, 31 August 2022, 30 September 2022 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 covers the periods ending | 31 October 2022, 30 November 2022, 31 December 2022 |
| The returns above also cover the periods ending 31 October 2022, 30 November 2022, 31 December 2022, which fall outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 180 |
| **The return forms as the package fills them in** |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 December 2021) box 1: VAT due on sales | 16,920 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 December 2021) box 4: VAT reclaimed on purchases | 6,023.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 December 2021) box 5: net VAT due | 10,896.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 March 2022) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 March 2022) box 4: VAT reclaimed on purchases | 4,531.58 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 March 2022) box 5: net VAT due | 12,725.08 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 June 2022) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 June 2022) box 4: VAT reclaimed on purchases | 9,895.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 June 2022) box 5: net VAT due | 9,884.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 September 2022) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 September 2022) box 4: VAT reclaimed on purchases | 2,105.71 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 September 2022) box 5: net VAT due | 14,754.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 December 2022) box 1: VAT due on sales | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 December 2022) box 4: VAT reclaimed on purchases | 180 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 December 2022) box 5: net VAT due | 920 |
...
| J34 |  | 11824.4893092592 |  |
| L33 |  | 0 |  |
| L34 |  | 0 |  |
| I33 |  | 11759.8746135802 |  |
| I34 |  | 11824.4893092592 |  |
...
| AJ128 | Box 395: tax | 11824.4893092592 | gl-cor:taxAmount (ct600.box395) |
