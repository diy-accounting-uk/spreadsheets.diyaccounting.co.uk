...
| | Amount |
|---|------:|
| Audit Accuracy Check | -1,783,720 |
...
| D29 | Directors Loan | 1892380 | accounts.liabilities.2500 (pubBS) |
...
| Cell | DIY Label | Value | diya-gl mapping |
|------|-----------|-------|-----------------|
| EJ91 | Audit Accuracy Check | -1783720 | gl-cor:amount (trialBalanceCheck) |
