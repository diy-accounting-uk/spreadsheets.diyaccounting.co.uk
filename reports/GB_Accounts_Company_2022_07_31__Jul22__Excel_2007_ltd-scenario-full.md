# Reconciliation Report: GB Accounts Company 2022-07-31 (Jul22) Excel 2007
...
| VAT Q1: payment due date (G7) = Vatinterface final date for payment (C8) | 44530 | 44530 | 0 | PASS |
...
| VAT Q2: payment due date (G7) = Vatinterface final date for payment (C11) | 44620 | 44620 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 44712 | 44712 | 0 | PASS |
...
| VAT Q4: payment due date (G7) = Vatinterface final date for payment (C17) | 44804 | 44804 | 0 | PASS |
...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C20) | 44895 | 44895 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 44773 | 44773 | 0 | PASS |
...
| Payslips!Oct K59 the monthly payroll opens in the accounting period's Oct | 44470 | 44470 | 0 | PASS |
...
| Payslips!Jan K59 the monthly payroll opens in the accounting period's Jan | 44562 | 44562 | 0 | PASS |
...
| Payslips!Apr K59 the monthly payroll opens in the accounting period's Apr | 44652 | 44652 | 0 | PASS |
...
| Payslips!Jul K69 the monthly payroll opens in the accounting period's Jul | 44743 | 44743 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 44773 | 44773 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 44773 | 44773 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 44773 | 44773 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 44773 | 44773 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 44773 | 44773 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 365 | 0 | PASS |
| Admin: first financial year row starts at the accounting period start | 44409 | 44409 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 44652 | 44652 | 0 | PASS |
| Admin: second financial year row ends at the year end | 44773 | 44773 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 44409 | 44409 | 0 | PASS |
| CT: working sheet heading ends at the year end | 44773 | 44773 | 0 | PASS |
| CT: the two tax rows span the accounting period | 365 | 365 | 0 | PASS |
| CT600: return period starts at the accounting period start | 44409 | 44409 | 0 | PASS |
| CT600: return period ends at the year end | 44773 | 44773 | 0 | PASS |
...
| CT600: corporation tax = first tax row gross tax | 15738.2648856164 | 15738.2648856164 | 0 | PASS |
| CT600: second financial year tax = second tax row gross tax | 7901.51570388971 | 7901.51570388971 | 0 | PASS |
...
| CT600: tax payable = tax chargeable | 23639.78058950611 | 23639.7805895061 | -1.0913936421275139e-11 | PASS |
...
| CT: first tax row gross tax = its profit at its rate | 15738.264885616383 | 15738.2648856164 | +1.6370904631912708e-11 | PASS |
| CT: second tax row gross tax = its profit at its rate | 7901.515703889717 | 7901.51570388971 | -7.275957614183426e-12 | PASS |
| CT: first tax row tax = its gross tax less its marginal relief | 15738.2648856164 | 15738.2648856164 | 0 | PASS |
| CT: second tax row tax = its gross tax less its marginal relief | 7901.51570388971 | 7901.51570388971 | 0 | PASS |
| CT: charge for the year = the two tax rows | 23639.78058950611 | 23639.7805895061 | -1.0913936421275139e-11 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 covers the periods ending | 31 August 2021, 30 September 2021, 31 October 2021 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 covers the periods ending | 30 November 2021, 31 December 2021, 31 January 2022 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 covers the periods ending | 28 February 2022, 31 March 2022, 30 April 2022 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 covers the periods ending | 31 May 2022, 30 June 2022, 31 July 2022 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 covers the periods ending | 31 August 2022, 30 September 2022, 31 October 2022 |
| The returns above also cover the periods ending 31 August 2022, 30 September 2022, 31 October 2022, which fall outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 180 |
| **The return forms as the package fills them in** |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 October 2021) box 1: VAT due on sales | 16,920 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 October 2021) box 4: VAT reclaimed on purchases | 6,023.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 October 2021) box 5: net VAT due | 10,896.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 January 2022) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 January 2022) box 4: VAT reclaimed on purchases | 4,473.25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 January 2022) box 5: net VAT due | 12,783.42 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 April 2022) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 April 2022) box 4: VAT reclaimed on purchases | 9,895.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 April 2022) box 5: net VAT due | 9,884.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 July 2022) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 July 2022) box 4: VAT reclaimed on purchases | 2,105.71 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 July 2022) box 5: net VAT due | 14,754.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 October 2022) box 1: VAT due on sales | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 October 2022) box 4: VAT reclaimed on purchases | 180 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 October 2022) box 5: net VAT due | 920 |
...
| G33 |  | 19 |  |
| G34 |  | 19 |  |
| J33 |  | 15738.2648856164 |  |
| J34 |  | 7901.51570388971 |  |
| L33 |  | 0 |  |
| L34 |  | 0 |  |
| I33 |  | 15738.2648856164 |  |
| I34 |  | 7901.51570388971 |  |
...
| AJ126 | Box 46: tax | 15738.2648856164 | gl-cor:taxAmount (ct600.box46) |
...
| AJ128 | Box 56: tax | 7901.51570388971 | gl-cor:taxAmount (ct600.box56) |
