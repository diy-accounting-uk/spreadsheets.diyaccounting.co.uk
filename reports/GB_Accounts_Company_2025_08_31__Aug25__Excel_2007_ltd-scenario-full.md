...
| VAT Q1: payment due date (G7) = Vatinterface final date for payment (C8) | 45657 | 45657 | 0 | PASS |
...
| VAT Q2: payment due date (G7) = Vatinterface final date for payment (C11) | 45747 | 45747 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 45838 | 45838 | 0 | PASS |
...
| VAT Q4: payment due date (G7) = Vatinterface final date for payment (C17) | 45930 | 45930 | 0 | PASS |
...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C20) | 46022 | 46022 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 45900 | 45900 | 0 | PASS |
...
| Board minute: meeting date = the scenario's board meeting | 45900 | 45900 | 0 | PASS |
...
| Payslips!Aug K69 the monthly payroll opens in the accounting period's Aug | 45870 | 45870 | 0 | PASS |
...
| Payslips print: the period ends the day the scenario paid that month's wages | 45596 | 45596 | 0 | PASS |
...
| Payslips print: the payment date is the day the scenario paid that month's wages | 45596 | 45596 | 0 | PASS |
...
| Payslips!Dec M49 wages paid date | 45657 | 45657 | 0 | PASS |
...
| Payslips!Jan M49 wages paid date | 45688 | 45688 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 45900 | 45900 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 45900 | 45900 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 45900 | 45900 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 45900 | 45900 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 45900 | 45900 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 365 | 0 | PASS |
| Admin: first financial year row starts at the accounting period start | 45536 | 45536 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 45748 | 45748 | 0 | PASS |
| Admin: second financial year row ends at the year end | 45900 | 45900 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 45536 | 45536 | 0 | PASS |
| CT: working sheet heading ends at the year end | 45900 | 45900 | 0 | PASS |
| CT: the two tax rows span the accounting period | 365 | 365 | 0 | PASS |
| CT600: return period starts at the accounting period start | 45536 | 45536 | 0 | PASS |
| CT600: return period ends at the year end | 45900 | 45900 | 0 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 covers the periods ending | 30 September 2024, 31 October 2024, 30 November 2024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 covers the periods ending | 31 December 2024, 31 January 2025, 28 February 2025 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 covers the periods ending | 31 March 2025, 30 April 2025, 31 May 2025 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 covers the periods ending | 30 June 2025, 31 July 2025, 31 August 2025 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 covers the periods ending | 30 September 2025, 31 October 2025, 30 November 2025 |
| The returns above also cover the periods ending 30 September 2025, 31 October 2025, 30 November 2025, which fall outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 180 |
| **The return forms as the package fills them in** |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 November 2024) box 1: VAT due on sales | 16,920 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 November 2024) box 4: VAT reclaimed on purchases | 6,023.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 November 2024) box 5: net VAT due | 10,896.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 28 February 2025) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 28 February 2025) box 4: VAT reclaimed on purchases | 4,531.58 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 28 February 2025) box 5: net VAT due | 12,725.08 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 May 2025) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 May 2025) box 4: VAT reclaimed on purchases | 9,895.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 May 2025) box 5: net VAT due | 9,884.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 August 2025) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 August 2025) box 4: VAT reclaimed on purchases | 2,105.71 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 August 2025) box 5: net VAT due | 14,754.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 November 2025) box 1: VAT due on sales | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 November 2025) box 4: VAT reclaimed on purchases | 180 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 November 2025) box 5: net VAT due | 920 |
...
| G33 |  | 25 |  |
| G34 |  | 25 |  |
| J33 |  | 18024.0993209876 |  |
| J34 |  | 13007.9584722222 |  |
| L33 |  | 794.393962002218 |  |
| L34 |  | 573.312623520468 |  |
| I33 |  | 17229.7053589854 |  |
| I34 |  | 12434.6458487017 |  |
...
| AJ126 | Box 345: tax | 18024.0993209876 | gl-cor:taxAmount (ct600.box345) |
...
| AJ128 | Box 395: tax | 13007.9584722222 | gl-cor:taxAmount (ct600.box395) |
