...
# Reconciliation Report: GB Accounts Company 2025-04-30 (Apr25) Excel 2007
...
| VAT Q1: payment due date (G7) = Vatinterface final date for payment (C8) | 45535 | 45535 | 0 | PASS |
...
| VAT Q2: payment due date (G7) = Vatinterface final date for payment (C11) | 45626 | 45626 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 45716 | 45716 | 0 | PASS |
...
| VAT Q4: payment due date (G7) = Vatinterface final date for payment (C17) | 45808 | 45808 | 0 | PASS |
...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C20) | 45900 | 45900 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 45777 | 45777 | 0 | PASS |
...
| Board minute: meeting date = the scenario's board meeting | 45777 | 45777 | 0 | PASS |
...
| Payslips!Jul K59 the monthly payroll opens in the accounting period's Jul | 45474 | 45474 | 0 | PASS |
...
| Payslips!Apr K69 the monthly payroll opens in the accounting period's Apr | 45748 | 45748 | 0 | PASS |
...
| Payslips print: the period ends the day the scenario paid that month's wages | 45473 | 45473 | 0 | PASS |
...
| Payslips print: the payment date is the day the scenario paid that month's wages | 45473 | 45473 | 0 | PASS |
...
| Payslips!Aug M49 wages paid date | 45535 | 45535 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 45777 | 45777 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 45777 | 45777 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 45777 | 45777 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 45777 | 45777 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 45777 | 45777 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 365 | 0 | PASS |
| Admin: first financial year row starts at the accounting period start | 45413 | 45413 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 45748 | 45748 | 0 | PASS |
| Admin: second financial year row ends at the year end | 45777 | 45777 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 45413 | 45413 | 0 | PASS |
| CT: working sheet heading ends at the year end | 45777 | 45777 | 0 | PASS |
| CT: the two tax rows span the accounting period | 365 | 365 | 0 | PASS |
| CT600: return period starts at the accounting period start | 45413 | 45413 | 0 | PASS |
| CT600: return period ends at the year end | 45777 | 45777 | 0 | PASS |
...
| CT600: corporation tax = first tax row gross tax | 28481.4777006172 | 28481.4777006172 | 0 | PASS |
| CT600: second financial year tax = second tax row gross tax | 2550.58009259258 | 2550.58009259258 | 0 | PASS |
...
| CT600: tax payable = tax chargeable | 31032.05779320978 | 31032.0577932098 | +1.8189894035458565e-11 | PASS |
...
| CT: first tax row gross tax = its profit at its rate | 28481.47770061725 | 28481.4777006172 | -5.093170329928398e-11 | PASS |
| CT: second tax row gross tax = its profit at its rate | 2550.580092592575 | 2550.58009259258 | +5.002220859751105e-12 | PASS |
| CT: first tax row tax = its gross tax less its marginal relief | 27226.18535500049 | 27226.1853550005 | +1.0913936421275139e-11 | PASS |
| CT: second tax row tax = its gross tax less its marginal relief | 2438.165852686606 | 2438.16585268661 | +4.092726157978177e-12 | PASS |
| CT: charge for the year = the two tax rows | 29664.35120768711 | 29664.3512076871 | -7.275957614183426e-12 | PASS |
...
| CT: first tax row marginal relief = its share of the augmented profits against its share of the limits | 1255.2923456167161 | 1255.29234561671 | -6.139089236967266e-12 | PASS |
| CT: second tax row marginal relief = its share of the augmented profits against its share of the limits | 112.414239905974 | 112.414239905974 | 0 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 covers the periods ending | 31 May 2024, 30 June 2024, 31 July 2024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 covers the periods ending | 31 August 2024, 30 September 2024, 31 October 2024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 covers the periods ending | 30 November 2024, 31 December 2024, 31 January 2025 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 covers the periods ending | 28 February 2025, 31 March 2025, 30 April 2025 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 covers the periods ending | 31 May 2025, 30 June 2025, 31 July 2025 |
| The returns above also cover the periods ending 31 May 2025, 30 June 2025, 31 July 2025, which fall outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 180 |
| **The return forms as the package fills them in** |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 July 2024) box 1: VAT due on sales | 16,920 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 July 2024) box 4: VAT reclaimed on purchases | 6,023.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 July 2024) box 5: net VAT due | 10,896.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 October 2024) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 October 2024) box 4: VAT reclaimed on purchases | 4,531.58 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 October 2024) box 5: net VAT due | 12,725.08 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 January 2025) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 January 2025) box 4: VAT reclaimed on purchases | 9,895.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 January 2025) box 5: net VAT due | 9,884.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 April 2025) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 April 2025) box 4: VAT reclaimed on purchases | 2,105.71 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 April 2025) box 5: net VAT due | 14,754.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 July 2025) box 1: VAT due on sales | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 July 2025) box 4: VAT reclaimed on purchases | 180 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 July 2025) box 5: net VAT due | 920 |
...
| G33 |  | 25 |  |
| G34 |  | 25 |  |
| J33 |  | 28481.4777006172 |  |
| J34 |  | 2550.58009259258 |  |
| L33 |  | 1255.29234561671 |  |
| L34 |  | 112.414239905974 |  |
| I33 |  | 27226.1853550005 |  |
| I34 |  | 2438.16585268661 |  |
...
| AJ126 | Box 345: tax | 28481.4777006172 | gl-cor:taxAmount (ct600.box345) |
...
| AJ128 | Box 395: tax | 2550.58009259258 | gl-cor:taxAmount (ct600.box395) |
