...
| | Amount |
|---|------:|
| Audit Accuracy Check | -1,784,965 |
...
| D29 | Directors Loan | 1893625 | accounts.liabilities.2500 (pubBS) |
...
| Cell | DIY Label | Value | diya-gl mapping |
|------|-----------|-------|-----------------|
| EJ91 | Audit Accuracy Check | -1784965 | gl-cor:amount (trialBalanceCheck) |
