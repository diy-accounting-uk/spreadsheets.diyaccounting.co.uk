...
| | Amount |
|---|------:|
| Audit Accuracy Check | -1,779,981 |
...
| D29 | Directors Loan | 1888641 | accounts.liabilities.2500 (pubBS) |
...
| Cell | DIY Label | Value | diya-gl mapping |
|------|-----------|-------|-----------------|
| EJ91 | Audit Accuracy Check | -1779981 | gl-cor:amount (trialBalanceCheck) |
