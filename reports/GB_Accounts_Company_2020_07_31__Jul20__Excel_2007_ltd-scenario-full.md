# Reconciliation Report: GB Accounts Company 2020-07-31 (Jul20) Excel 2007
...
| VAT Q1: payment due date (G7) = Vatinterface final date for payment (C8) | 43799 | 43799 | 0 | PASS |
...
| VAT Q2: payment due date (G7) = Vatinterface final date for payment (C11) | 43890 | 43890 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 43982 | 43982 | 0 | PASS |
...
| VAT Q4: payment due date (G7) = Vatinterface final date for payment (C17) | 44074 | 44074 | 0 | PASS |
...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C20) | 44165 | 44165 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 44043 | 44043 | 0 | PASS |
...
| Board minute: meeting date = the scenario's board meeting | 44043 | 44043 | 0 | PASS |
...
| Payslips!Sep K49 the monthly payroll opens in the accounting period's Sep | 43709 | 43709 | 0 | PASS |
| Payslips!Oct K59 the monthly payroll opens in the accounting period's Oct | 43739 | 43739 | 0 | PASS |
| Payslips!Nov K49 the monthly payroll opens in the accounting period's Nov | 43770 | 43770 | 0 | PASS |
| Payslips!Dec K49 the monthly payroll opens in the accounting period's Dec | 43800 | 43800 | 0 | PASS |
| Payslips!Jan K59 the monthly payroll opens in the accounting period's Jan | 43831 | 43831 | 0 | PASS |
| Payslips!Feb K49 the monthly payroll opens in the accounting period's Feb | 43862 | 43862 | 0 | PASS |
| Payslips!Mar K49 the monthly payroll opens in the accounting period's Mar | 43891 | 43891 | 0 | PASS |
| Payslips!Apr K59 the monthly payroll opens in the accounting period's Apr | 43922 | 43922 | 0 | PASS |
| Payslips!May K49 the monthly payroll opens in the accounting period's May | 43952 | 43952 | 0 | PASS |
| Payslips!Jun K49 the monthly payroll opens in the accounting period's Jun | 43983 | 43983 | 0 | PASS |
| Payslips!Jul K69 the monthly payroll opens in the accounting period's Jul | 44013 | 44013 | 0 | PASS |
...
| Payslips print: the period ends the day the scenario paid that month's wages | 43738 | 43738 | 0 | PASS |
...
| Payslips print: the payment date is the day the scenario paid that month's wages | 43738 | 43738 | 0 | PASS |
...
| Payslips!Nov M49 wages paid date | 43799 | 43799 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 44043 | 44043 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 44043 | 44043 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 44043 | 44043 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 44043 | 44043 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 44043 | 44043 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 366 | +1 | PASS |
| Admin: first financial year row starts at the accounting period start | 43678 | 43678 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 43922 | 43922 | 0 | PASS |
| Admin: second financial year row ends at the year end | 44043 | 44043 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 43678 | 43678 | 0 | PASS |
| CT: working sheet heading ends at the year end | 44043 | 44043 | 0 | PASS |
| CT: the two tax rows span the accounting period | 366 | 366 | 0 | PASS |
| CT600: return period starts at the accounting period start | 43678 | 43678 | 0 | PASS |
| CT600: return period ends at the year end | 44043 | 44043 | 0 | PASS |
...
| CT600: corporation tax = first tax row gross tax | 15759.8537263374 | 15759.8537263374 | 0 | PASS |
| CT600: second financial year tax = second tax row gross tax | 7879.9268631687 | 7879.9268631687 | 0 | PASS |
...
| CT: first tax row gross tax = its profit at its rate | 15759.853726337395 | 15759.8537263374 | +5.4569682106375694e-12 | PASS |
| CT: second tax row gross tax = its profit at its rate | 7879.926863168707 | 7879.9268631687 | -7.275957614183426e-12 | PASS |
| CT: first tax row tax = its gross tax less its marginal relief | 15759.8537263374 | 15759.8537263374 | 0 | PASS |
| CT: second tax row tax = its gross tax less its marginal relief | 7879.9268631687 | 7879.9268631687 | 0 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Box 335: amount of profit | 82,946.6 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 340: rate of tax | 19 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 345: tax | 15,759.85 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 380: financial year | 2,020 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 385: amount of profit | 41,473.3 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 390: rate of tax | 19 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 395: tax | 7,879.93 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 covers the periods ending | 31 August 2019, 30 September 2019, 31 October 2019 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 covers the periods ending | 30 November 2019, 31 December 2019, 31 January 2020 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 covers the periods ending | 29 February 2020, 31 March 2020, 30 April 2020 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 covers the periods ending | 31 May 2020, 30 June 2020, 31 July 2020 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 covers the periods ending | 31 August 2020, 30 September 2020, 31 October 2020 |
| The returns above also cover the periods ending 31 August 2020, 30 September 2020, 31 October 2020, which fall outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 180 |
| **The return forms as the package fills them in** |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 October 2019) box 1: VAT due on sales | 16,920 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 October 2019) box 4: VAT reclaimed on purchases | 6,023.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 October 2019) box 5: net VAT due | 10,896.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 January 2020) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 January 2020) box 4: VAT reclaimed on purchases | 4,473.25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 January 2020) box 5: net VAT due | 12,783.42 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 April 2020) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 April 2020) box 4: VAT reclaimed on purchases | 9,895.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 April 2020) box 5: net VAT due | 9,884.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 July 2020) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 July 2020) box 4: VAT reclaimed on purchases | 2,105.71 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 July 2020) box 5: net VAT due | 14,754.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 October 2020) box 1: VAT due on sales | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 October 2020) box 4: VAT reclaimed on purchases | 180 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 October 2020) box 5: net VAT due | 920 |
...
| G33 |  | 19 |  |
| G34 |  | 19 |  |
| J33 |  | 15759.8537263374 |  |
| J34 |  | 7879.9268631687 |  |
| L33 |  | 0 |  |
| L34 |  | 0 |  |
| I33 |  | 15759.8537263374 |  |
| I34 |  | 7879.9268631687 |  |
...
| N126 | Box 335: amount of profit | 82946.5985596705 | gl-cor:amount (ct600.box335) |
| AA126 | Box 340: rate of tax | 19 | gl-cor:rate (ct600.box340) |
| AJ126 | Box 345: tax | 15759.8537263374 | gl-cor:taxAmount (ct600.box345) |
| C128 | Box 380: financial year | 2020 | gl-cor:period (ct600.box380) |
| N128 | Box 385: amount of profit | 41473.2992798353 | gl-cor:amount (ct600.box385) |
| AA128 | Box 390: rate of tax | 19 | gl-cor:rate (ct600.box390) |
| AJ128 | Box 395: tax | 7879.9268631687 | gl-cor:taxAmount (ct600.box395) |
