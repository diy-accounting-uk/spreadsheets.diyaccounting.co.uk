# Reconciliation Report: GB Accounts Company 2023-05-31 (May23) Excel 2007
...
| VAT Q1: payment due date (G7) = Vatinterface final date for payment (C8) | 44834 | 44834 | 0 | PASS |
...
| VAT Q2: payment due date (G7) = Vatinterface final date for payment (C11) | 44926 | 44926 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 45016 | 45016 | 0 | PASS |
...
| VAT Q4: payment due date (G7) = Vatinterface final date for payment (C17) | 45107 | 45107 | 0 | PASS |
...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C20) | 45199 | 45199 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 45077 | 45077 | 0 | PASS |
...
| Payslips!Aug K59 the monthly payroll opens in the accounting period's Aug | 44774 | 44774 | 0 | PASS |
...
| Payslips!Nov K59 the monthly payroll opens in the accounting period's Nov | 44866 | 44866 | 0 | PASS |
...
| Payslips!Feb K59 the monthly payroll opens in the accounting period's Feb | 44958 | 44958 | 0 | PASS |
...
| Payslips!May K69 the monthly payroll opens in the accounting period's May | 45047 | 45047 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 45077 | 45077 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 45077 | 45077 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 45077 | 45077 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 45077 | 45077 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 45077 | 45077 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 365 | 0 | PASS |
| Admin: first financial year row starts at the accounting period start | 44713 | 44713 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 45017 | 45017 | 0 | PASS |
| Admin: second financial year row ends at the year end | 45077 | 45077 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 44713 | 44713 | 0 | PASS |
| CT: working sheet heading ends at the year end | 45077 | 45077 | 0 | PASS |
| CT: the two tax rows span the accounting period | 365 | 365 | 0 | PASS |
| CT600: return period starts at the accounting period start | 44713 | 44713 | 0 | PASS |
| CT600: return period ends at the year end | 45077 | 45077 | 0 | PASS |
...
| CT600: amount of profit = first tax row profit | 103626.435460849 | 103626.435460849 | 0 | PASS |
| CT600: tax rate = first tax row rate | 25 | 25 | 0 | PASS |
| CT600: corporation tax = first tax row gross tax | 25906.6088652122 | 25906.6088652122 | 0 | PASS |
| CT600: second financial year tax = second tax row gross tax | 5198.36559466428 | 5198.36559466428 | 0 | PASS |
| CT600: second financial year = second tax row financial year | 2023 | 2023 | 0 | PASS |
| CT600: second financial year profit = second tax row profit | 20793.4623786571 | 20793.4623786571 | 0 | PASS |
| CT600: second financial year rate = second tax row rate | 25 | 25 | 0 | PASS |
| CT600: tax payable = tax chargeable | 31104.97445987648 | 31104.9744598765 | +1.8189894035458565e-11 | PASS |
| CT600: marginal rate relief = the working sheet's relief | 1883.701532407416 | 1883.70153240741 | -5.9117155615240335e-12 | PASS |
...
| CT: first tax row profit = chargeable profit by its share of those days | 103626.43546084882 | 103626.435460849 | +1.7462298274040222e-10 | PASS |
| CT: second tax row profit = chargeable profit by its share of those days | 20793.46237865717 | 20793.4623786571 | -6.912159733474255e-11 | PASS |
| CT: first tax row gross tax = its profit at its rate | 25906.60886521225 | 25906.6088652122 | -4.729372449219227e-11 | PASS |
| CT: second tax row gross tax = its profit at its rate | 5198.365594664275 | 5198.36559466428 | +5.4569682106375694e-12 | PASS |
| CT: first tax row tax = its gross tax less its marginal relief | 24337.717725892053 | 24337.717725892 | -5.4569682106375694e-11 | PASS |
| CT: second tax row tax = its gross tax less its marginal relief | 4883.5552015770145 | 4883.55520157702 | +5.4569682106375694e-12 | PASS |
| CT: charge for the year = the two tax rows | 29221.272927469017 | 29221.272927469 | -1.8189894035458565e-11 | PASS |
...
| CT: first tax row marginal relief = its share of the profit against its share of the limits | 1568.891139320142 | 1568.89113932015 | +7.958078640513122e-12 | PASS |
| CT: second tax row marginal relief = its share of the profit against its share of the limits | 314.81039308726685 | 314.810393087266 | -8.526512829121202e-13 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Box 44: amount of profit | 103,626.44 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 45: rate of tax | 25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 46: tax | 25,906.61 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 53: financial year | 2,023 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 54: amount of profit | 20,793.46 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 covers the periods ending | 30 June 2022, 31 July 2022, 31 August 2022 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 covers the periods ending | 30 September 2022, 31 October 2022, 30 November 2022 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 covers the periods ending | 31 December 2022, 31 January 2023, 28 February 2023 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 covers the periods ending | 31 March 2023, 30 April 2023, 31 May 2023 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 covers the periods ending | 30 June 2023, 31 July 2023, 31 August 2023 |
| The returns above also cover the periods ending 30 June 2023, 31 July 2023, 31 August 2023, which fall outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 180 |
| **The return forms as the package fills them in** |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 August 2022) box 1: VAT due on sales | 16,920 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 August 2022) box 4: VAT reclaimed on purchases | 6,023.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 August 2022) box 5: net VAT due | 10,896.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 November 2022) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 November 2022) box 4: VAT reclaimed on purchases | 4,473.25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 November 2022) box 5: net VAT due | 12,783.42 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 28 February 2023) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 28 February 2023) box 4: VAT reclaimed on purchases | 9,895.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 28 February 2023) box 5: net VAT due | 9,884.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 May 2023) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 May 2023) box 4: VAT reclaimed on purchases | 2,105.71 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 May 2023) box 5: net VAT due | 14,754.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 August 2023) box 1: VAT due on sales | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 August 2023) box 4: VAT reclaimed on purchases | 180 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 August 2023) box 5: net VAT due | 920 |
...
| E33 |  | 2022 |  |
| E34 |  | 2023 |  |
| F33 |  | 103626.435460849 |  |
| F34 |  | 20793.4623786571 |  |
| G33 |  | 25 |  |
| G34 |  | 25 |  |
| J33 |  | 25906.6088652122 |  |
| J34 |  | 5198.36559466428 |  |
| L33 |  | 1568.89113932015 |  |
| L34 |  | 314.810393087266 |  |
| I33 |  | 24337.717725892 |  |
| I34 |  | 4883.55520157702 |  |
...
| N126 | Box 44: amount of profit | 103626.435460849 | gl-cor:amount (ct600.box44) |
| AA126 | Box 45: rate of tax | 25 | gl-cor:rate (ct600.box45) |
| AJ126 | Box 46: tax | 25906.6088652122 | gl-cor:taxAmount (ct600.box46) |
| C128 | Box 53: financial year | 2023 | gl-cor:period (ct600.box53) |
| N128 | Box 54: amount of profit | 20793.4623786571 | gl-cor:amount (ct600.box54) |
| AA128 | Box 55: rate of tax | 25 | gl-cor:rate (ct600.box55) |
| AJ128 | Box 56: tax | 5198.36559466428 | gl-cor:taxAmount (ct600.box56) |
