# Reconciliation Report: GB Accounts Company 2024-12-31 (Dec24) Excel 2007
...
| VAT Q1: payment due date (G7) = Vatinterface final date for payment (C8) | 45412 | 45412 | 0 | PASS |
...
| VAT Q2: payment due date (G7) = Vatinterface final date for payment (C11) | 45504 | 45504 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 45596 | 45596 | 0 | PASS |
...
| VAT Q4: payment due date (G7) = Vatinterface final date for payment (C17) | 45688 | 45688 | 0 | PASS |
...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C20) | 45777 | 45777 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 45657 | 45657 | 0 | PASS |
...
| P&L May G27 = Purchases.xlsx "a" net | 0 | 0 | 0 | PASS |
...
| P&L May expense lines = Purchases.xlsx May net less materials, wages and asset purchases | 2554.375000000003 | 2554.375 | -3.183231456205249e-12 | PASS |
...
| Payslips!Jun K59 the monthly payroll opens in the accounting period's Jun | 45444 | 45444 | 0 | PASS |
...
| Payslips!Dec K69 the monthly payroll opens in the accounting period's Dec | 45627 | 45627 | 0 | PASS |
...
| Payslips print: the period ends the day the scenario paid that month's wages | 46081 | 46081 | 0 | PASS |
...
| Payslips print: the payment date is the day the scenario paid that month's wages | 46081 | 46081 | 0 | PASS |
...
| Payslips!Apr M49 wages paid date | 46142 | 46142 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 45657 | 45657 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 45657 | 45657 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 45657 | 45657 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 45657 | 45657 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 45657 | 45657 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 366 | +1 | PASS |
| Admin: first financial year row starts at the accounting period start | 45292 | 45292 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 45383 | 45383 | 0 | PASS |
| Admin: second financial year row ends at the year end | 45657 | 45657 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 45292 | 45292 | 0 | PASS |
| CT: working sheet heading ends at the year end | 45657 | 45657 | 0 | PASS |
| CT: the two tax rows span the accounting period | 366 | 366 | 0 | PASS |
| CT600: return period starts at the accounting period start | 45292 | 45292 | 0 | PASS |
| CT600: return period ends at the year end | 45657 | 45657 | 0 | PASS |
...
| CT600: amount of profit = first tax row profit | 30935.0019218443 | 30935.0019218443 | 0 | PASS |
| CT600: tax rate = first tax row rate | 25 | 25 | 0 | PASS |
| CT600: corporation tax = first tax row gross tax | 7733.75048046108 | 7733.75048046108 | 0 | PASS |
| CT600: second financial year tax = second tax row gross tax | 23371.2239794154 | 23371.2239794154 | 0 | PASS |
| CT600: second financial year = second tax row financial year | 2024 | 2024 | 0 | PASS |
| CT600: second financial year profit = second tax row profit | 93484.8959176614 | 93484.8959176614 | 0 | PASS |
...
| CT: first tax row profit = chargeable profit by its share of those days | 30935.00192184439 | 30935.0019218443 | -8.731149137020111e-11 | PASS |
| CT: second tax row profit = chargeable profit by its share of those days | 93484.8959176616 | 93484.8959176614 | -2.0372681319713593e-10 | PASS |
| CT: first tax row gross tax = its profit at its rate | 7733.750480461075 | 7733.75048046108 | +4.547473508864641e-12 | PASS |
| CT: second tax row gross tax = its profit at its rate | 23371.22397941535 | 23371.2239794154 | +5.093170329928398e-11 | PASS |
| CT: first tax row tax = its gross tax less its marginal relief | 7265.398460108417 | 7265.39846010842 | +3.637978807091713e-12 | PASS |
| CT: second tax row tax = its gross tax less its marginal relief | 21955.874467360652 | 21955.8744673606 | -5.093170329928398e-11 | PASS |
...
| CT: first tax row marginal relief = its share of the profit against its share of the limits | 468.3520203526634 | 468.352020352663 | -3.979039320256561e-13 | PASS |
| CT: second tax row marginal relief = its share of the profit against its share of the limits | 1415.349512054751 | 1415.34951205475 | -9.094947017729282e-13 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Box 44: amount of profit | 30,935 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 45: rate of tax | 25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 46: tax | 7,733.75 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 53: financial year | 2,024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 54: amount of profit | 93,484.9 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 55: rate of tax | 25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Box 56: tax | 23,371.22 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 covers the periods ending | 31 January 2024, 29 February 2024, 31 March 2024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 covers the periods ending | 30 April 2024, 31 May 2024, 30 June 2024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 covers the periods ending | 31 July 2024, 31 August 2024, 30 September 2024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 covers the periods ending | 31 October 2024, 30 November 2024, 31 December 2024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 covers the periods ending | 31 January 2025, 28 February 2025, 31 March 2025 |
| The returns above also cover the periods ending 31 January 2025, 28 February 2025, 31 March 2025, which fall outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 180 |
| **The return forms as the package fills them in** |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 March 2024) box 1: VAT due on sales | 16,920 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 March 2024) box 4: VAT reclaimed on purchases | 6,023.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 March 2024) box 5: net VAT due | 10,896.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 June 2024) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 June 2024) box 4: VAT reclaimed on purchases | 4,473.25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 June 2024) box 5: net VAT due | 12,783.42 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 September 2024) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 September 2024) box 4: VAT reclaimed on purchases | 9,895.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 September 2024) box 5: net VAT due | 9,884.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 December 2024) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 December 2024) box 4: VAT reclaimed on purchases | 2,105.71 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 December 2024) box 5: net VAT due | 14,754.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 March 2025) box 1: VAT due on sales | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 March 2025) box 4: VAT reclaimed on purchases | 180 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 March 2025) box 5: net VAT due | 920 |
...
| E33 |  | 2023 |  |
| E34 |  | 2024 |  |
| F33 |  | 30935.0019218443 |  |
| F34 |  | 93484.8959176614 |  |
| G33 |  | 25 |  |
| G34 |  | 25 |  |
| J33 |  | 7733.75048046108 |  |
| J34 |  | 23371.2239794154 |  |
| L33 |  | 468.352020352663 |  |
| L34 |  | 1415.34951205475 |  |
| I33 |  | 7265.39846010842 |  |
| I34 |  | 21955.8744673606 |  |
...
| N126 | Box 44: amount of profit | 30935.0019218443 | gl-cor:amount (ct600.box44) |
| AA126 | Box 45: rate of tax | 25 | gl-cor:rate (ct600.box45) |
| AJ126 | Box 46: tax | 7733.75048046108 | gl-cor:taxAmount (ct600.box46) |
| C128 | Box 53: financial year | 2024 | gl-cor:period (ct600.box53) |
| N128 | Box 54: amount of profit | 93484.8959176614 | gl-cor:amount (ct600.box54) |
| AA128 | Box 55: rate of tax | 25 | gl-cor:rate (ct600.box55) |
| AJ128 | Box 56: tax | 23371.2239794154 | gl-cor:taxAmount (ct600.box56) |
...
| A1 |  | 1025 |  |
| A2 |  | 1025 |  |
ompanysecretary.xlsx!Charges&Debentures
