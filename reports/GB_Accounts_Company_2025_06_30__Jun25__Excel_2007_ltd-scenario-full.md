...
| VAT Q1: payment due date (G7) = Vatinterface final date for payment (C8) | 45596 | 45596 | 0 | PASS |
...
| VAT Q2: payment due date (G7) = Vatinterface final date for payment (C11) | 45688 | 45688 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 45777 | 45777 | 0 | PASS |
...
| VAT Q4: payment due date (G7) = Vatinterface final date for payment (C17) | 45869 | 45869 | 0 | PASS |
...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C20) | 45961 | 45961 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 45838 | 45838 | 0 | PASS |
...
| Payslips!Payment B4 tax month 1 ends on the last day of Apr | 45777 | 45777 | 0 | PASS |
| Payslips!Payment C4 tax month 1 is due on the 19th after it | 45796 | 45796 | 0 | PASS |
| Payslips!Payment B5 tax month 2 ends on the last day of May | 45808 | 45808 | 0 | PASS |
| Payslips!Payment C5 tax month 2 is due on the 19th after it | 45827 | 45827 | 0 | PASS |
| Payslips!Payment B6 tax month 3 ends on the last day of Jun | 45838 | 45838 | 0 | PASS |
| Payslips!Payment C6 tax month 3 is due on the 19th after it | 45857 | 45857 | 0 | PASS |
| Payslips!Payment B7 tax month 4 ends on the last day of Jul | 45869 | 45869 | 0 | PASS |
| Payslips!Payment C7 tax month 4 is due on the 19th after it | 45888 | 45888 | 0 | PASS |
| Payslips!Payment B8 tax month 5 ends on the last day of Aug | 45900 | 45900 | 0 | PASS |
| Payslips!Payment C8 tax month 5 is due on the 19th after it | 45919 | 45919 | 0 | PASS |
| Payslips!Payment B9 tax month 6 ends on the last day of Sep | 45930 | 45930 | 0 | PASS |
| Payslips!Payment C9 tax month 6 is due on the 19th after it | 45949 | 45949 | 0 | PASS |
| Payslips!Payment B10 tax month 7 ends on the last day of Oct | 45961 | 45961 | 0 | PASS |
| Payslips!Payment C10 tax month 7 is due on the 19th after it | 45980 | 45980 | 0 | PASS |
| Payslips!Payment B11 tax month 8 ends on the last day of Nov | 45991 | 45991 | 0 | PASS |
| Payslips!Payment C11 tax month 8 is due on the 19th after it | 46010 | 46010 | 0 | PASS |
| Payslips!Payment B12 tax month 9 ends on the last day of Dec | 46022 | 46022 | 0 | PASS |
| Payslips!Payment C12 tax month 9 is due on the 19th after it | 46041 | 46041 | 0 | PASS |
| Payslips!Payment B13 tax month 10 ends on the last day of Jan | 46053 | 46053 | 0 | PASS |
| Payslips!Payment C13 tax month 10 is due on the 19th after it | 46072 | 46072 | 0 | PASS |
| Payslips!Payment B14 tax month 11 ends on the last day of Feb | 46081 | 46081 | 0 | PASS |
| Payslips!Payment C14 tax month 11 is due on the 19th after it | 46100 | 46100 | 0 | PASS |
| Payslips!Payment B15 tax month 12 ends on the last day of Mar | 46112 | 46112 | 0 | PASS |
| Payslips!Payment C15 tax month 12 is due on the 19th after it | 46131 | 46131 | 0 | PASS |
| Payslips!Jul K49 the monthly payroll opens in the accounting period's Jul | 45474 | 45474 | 0 | PASS |
| Payslips!Aug K49 the monthly payroll opens in the accounting period's Aug | 45505 | 45505 | 0 | PASS |
| Payslips!Sep K59 the monthly payroll opens in the accounting period's Sep | 45536 | 45536 | 0 | PASS |
| Payslips!Oct K49 the monthly payroll opens in the accounting period's Oct | 45566 | 45566 | 0 | PASS |
| Payslips!Nov K49 the monthly payroll opens in the accounting period's Nov | 45597 | 45597 | 0 | PASS |
| Payslips!Dec K59 the monthly payroll opens in the accounting period's Dec | 45627 | 45627 | 0 | PASS |
| Payslips!Jan K49 the monthly payroll opens in the accounting period's Jan | 45658 | 45658 | 0 | PASS |
| Payslips!Feb K49 the monthly payroll opens in the accounting period's Feb | 45689 | 45689 | 0 | PASS |
| Payslips!Mar K59 the monthly payroll opens in the accounting period's Mar | 45717 | 45717 | 0 | PASS |
| Payslips!Apr K49 the monthly payroll opens in the accounting period's Apr | 45748 | 45748 | 0 | PASS |
| Payslips!May K49 the monthly payroll opens in the accounting period's May | 45778 | 45778 | 0 | PASS |
| Payslips!Jun K69 the monthly payroll opens in the accounting period's Jun | 45809 | 45809 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 45838 | 45838 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 45838 | 45838 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 45838 | 45838 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 45838 | 45838 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 45838 | 45838 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 365 | 0 | PASS |
| Admin: first financial year row starts at the accounting period start | 45474 | 45474 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 45748 | 45748 | 0 | PASS |
| Admin: second financial year row ends at the year end | 45838 | 45838 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 45474 | 45474 | 0 | PASS |
| CT: working sheet heading ends at the year end | 45838 | 45838 | 0 | PASS |
| CT: the two tax rows span the accounting period | 365 | 365 | 0 | PASS |
| CT600: return period starts at the accounting period start | 45474 | 45474 | 0 | PASS |
| CT600: return period ends at the year end | 45838 | 45838 | 0 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 covers the periods ending | 31 July 2024, 31 August 2024, 30 September 2024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 covers the periods ending | 31 October 2024, 30 November 2024, 31 December 2024 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 covers the periods ending | 31 January 2025, 28 February 2025, 31 March 2025 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 covers the periods ending | 30 April 2025, 31 May 2025, 30 June 2025 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 covers the periods ending | 31 July 2025, 31 August 2025, 30 September 2025 |
| The returns above also cover the periods ending 31 July 2025, 31 August 2025, 30 September 2025, which fall outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 180 |
| **The return forms as the package fills them in** |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 September 2024) box 1: VAT due on sales | 16,920 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 September 2024) box 4: VAT reclaimed on purchases | 6,023.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 September 2024) box 5: net VAT due | 10,896.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 December 2024) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 December 2024) box 4: VAT reclaimed on purchases | 4,473.25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 December 2024) box 5: net VAT due | 12,783.42 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 March 2025) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 March 2025) box 4: VAT reclaimed on purchases | 9,895.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 March 2025) box 5: net VAT due | 9,884.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 June 2025) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 June 2025) box 4: VAT reclaimed on purchases | 2,105.71 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 30 June 2025) box 5: net VAT due | 14,754.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 September 2025) box 1: VAT due on sales | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 September 2025) box 4: VAT reclaimed on purchases | 180 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 30 September 2025) box 5: net VAT due | 920 |
...
| A1 |  | 1025 |  |
| A2 |  | 1025 |  |
cretary.xlsx!Charges&Debentures
