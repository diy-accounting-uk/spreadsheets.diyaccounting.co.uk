...
| NI Class 4 (lower) | 3663.18 | 3663.18 | 0 | PASS |
| Total Tax + NI, less the CIS already deducted | 48038.959570000006 | 48038.9595699998 | -2.0372681319713593e-10 | PASS |
...
| Tax: Total = IT + CIS deduction line + NI | 48038.95956999979 | 48038.9595699998 | +1.4551915228366852e-11 | PASS |
...
| Forecast: National Insurance | 5074.847 | 5074.84699999999 | -1.000444171950221e-11 | PASS |
| Forecast: tax and NI liability | 45018.85700000001 | 45018.8569999997 | -3.128661774098873e-10 | PASS |
...
| SA103F: the period the return covers starts on the Admin tax year start (Q2 = B4) | 44292 | 44292 | 0 | PASS |
| SA103F: the period the return covers ends on the Admin tax year end (V2 = B17) | 44656 | 44656 | 0 | PASS |
| SA103F: the writing down allowance rate the return prints (G141) = the Admin rate (G5) | 0.18 | 0.18 | 0 | PASS |
| SA103F: the Class 4 threshold the return prints (J280) = the Admin Class 4 lower limit (N20) | 9568 | 9568 | 0 | PASS |
| SA103F: the online filing deadline banner (G1) names 31 January the year after the tax year ends | COPY DETAILS TO HMRC FORM          Submit HMRC RETURN ONLINE                   by 31st January 2023 | COPY DETAILS TO HMRC FORM          Submit HMRC RETURN ONLINE                   by 31st January 2023 |  | PASS |
...
| Payslips print: the period ends the day the scenario paid that month's wages | 44347 | 44347 | 0 | PASS |
...
| Payslips print: the payment date is the day the scenario paid that month's wages | 44347 | 44347 | 0 | PASS |
...
| Payslips!Jul M49 wages paid date | 44408 | 44408 | 0 | PASS |
...
| Payslips!Aug M49 wages paid date | 44439 | 44439 | 0 | PASS |
...
| Admin: NI Class 2 Small Profits Threshold = tax data | 6515 | 6515 | 0 | PASS |
| Admin: NI Class 4 Lower Rate = tax data | 0.09 | 0.09 | 0 | PASS |
| Admin: NI Class 4 Lower Limit = tax data | 9568 | 9568 | 0 | PASS |
...
| Admin: Amounts Payable By date (B21) = 31 January the year after the tax year ends | 44957 | 44957 | 0 | PASS |
| Payslips calendar: the payroll year starts on the accounts tax year start (B2 = Admin B4) | 44292 | 44292 | 0 | PASS |
| Payslips calendar: the year the calendar runs to (I1) = the accounts tax year end (Admin B17) | 44656 | 44656 | 0 | PASS |
| Payslips calendar: the tax year the payslips print (N1) = the tax year the package was generated for | 2021-22 | 2021-22 |  | PASS |
| Payslips calendar row 2: the date runs on unbroken from the tax year start | 44292 | 44292 | 0 | PASS |
| Payslips calendar row 2: the month name is its payroll month counted from the tax year start | Apr | Apr |  | PASS |
| Payslips calendar row 33: the date runs on unbroken from the tax year start | 44323 | 44323 | 0 | PASS |
| Payslips calendar row 33: the month name is its payroll month counted from the tax year start | May | May |  | PASS |
| Payslips calendar row 64: the date runs on unbroken from the tax year start | 44354 | 44354 | 0 | PASS |
| Payslips calendar row 64: the month name is its payroll month counted from the tax year start | Jun | Jun |  | PASS |
| Payslips calendar row 95: the date runs on unbroken from the tax year start | 44385 | 44385 | 0 | PASS |
| Payslips calendar row 95: the month name is its payroll month counted from the tax year start | Jul | Jul |  | PASS |
| Payslips calendar row 126: the date runs on unbroken from the tax year start | 44416 | 44416 | 0 | PASS |
| Payslips calendar row 126: the month name is its payroll month counted from the tax year start | Aug | Aug |  | PASS |
| Payslips calendar row 157: the date runs on unbroken from the tax year start | 44447 | 44447 | 0 | PASS |
| Payslips calendar row 157: the month name is its payroll month counted from the tax year start | Sep | Sep |  | PASS |
| Payslips calendar row 188: the date runs on unbroken from the tax year start | 44478 | 44478 | 0 | PASS |
| Payslips calendar row 188: the month name is its payroll month counted from the tax year start | Oct | Oct |  | PASS |
| Payslips calendar row 219: the date runs on unbroken from the tax year start | 44509 | 44509 | 0 | PASS |
| Payslips calendar row 219: the month name is its payroll month counted from the tax year start | Nov | Nov |  | PASS |
| Payslips calendar row 250: the date runs on unbroken from the tax year start | 44540 | 44540 | 0 | PASS |
| Payslips calendar row 250: the month name is its payroll month counted from the tax year start | Dec | Dec |  | PASS |
| Payslips calendar row 281: the date runs on unbroken from the tax year start | 44571 | 44571 | 0 | PASS |
| Payslips calendar row 281: the month name is its payroll month counted from the tax year start | Jan | Jan |  | PASS |
| Payslips calendar row 312: the date runs on unbroken from the tax year start | 44602 | 44602 | 0 | PASS |
| Payslips calendar row 312: the month name is its payroll month counted from the tax year start | Feb | Feb |  | PASS |
| Payslips calendar row 343: the date runs on unbroken from the tax year start | 44633 | 44633 | 0 | PASS |
| Payslips calendar row 343: the month name is its payroll month counted from the tax year start | Mar | Mar |  | PASS |
| Payslips calendar row 366: the date runs on unbroken from the tax year start | 44656 | 44656 | 0 | PASS |
| Payslips calendar row 366: the month name is its payroll month counted from the tax year start | Mar | Mar |  | PASS |
| Payslips calendar row 381: the date runs on unbroken from the tax year start | 44671 | 44671 | 0 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;National Insurance | 5,074.85 |
| **Forecast Tax & NI Liability** | 45,018.86 |
...
| NI Class 2 Small Profits Threshold | 6,515 |
| NI Class 4 Lower Rate | 0.09 |
| NI Class 4 Lower Limit | 9,568 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 June 2021) box 4: VAT reclaimed on purchases | 5,993.5 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 June 2021) box 5: net VAT due | 10,926.5 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 September 2021) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 September 2021) box 4: VAT reclaimed on purchases | 4,509.83 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 September 2021) box 5: net VAT due | 12,746.83 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 December 2021) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 December 2021) box 4: VAT reclaimed on purchases | 9,867 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 December 2021) box 5: net VAT due | 9,913 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 March 2022) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 March 2022) box 4: VAT reclaimed on purchases | 2,084.33 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 March 2022) box 5: net VAT due | 14,775.67 |
...
| E18 | **Total Tax + NI** | 48038.9595699998 | gl-cor:taxAmount (totalTaxNI) |
...
| C45 | National Insurance | 5074.84699999999 | tax.nationalInsurance.class4 |
| C46 | **Forecast Tax & NI Liability** | 45018.8569999997 | gl-cor:taxAmount (forecast.totalTaxNI) |
...
| S17 | Accounting date | 44292 | documentInfo.periodCoveredEnd |
...
| G1 |  | COPY DETAILS TO HMRC FORM          Submit HMRC RETURN ONLINE                   by 31st January 2023 |  |
| Q2 |  | 44292 |  |
| V2 |  | 44656 |  |
| G141 |  | 0.18 |  |
| J280 |  | 9568 |  |
...
| N16 | NI Class 2 Small Profits Threshold | 6515 | tax.nationalInsurance.class2SmallProfitsThreshold |
| L20 | NI Class 4 Lower Rate | 0.09 | tax.nationalInsurance.class4MainRate |
| N20 | NI Class 4 Lower Limit | 9568 | tax.nationalInsurance.class4LowerProfits |
