# Reconciliation Report: GB Accounts Company 2023-01-31 (Jan23) Excel 2007
...
| VAT Q1: payment due date (G7) = Vatinterface final date for payment (C8) | 44712 | 44712 | 0 | PASS |
...
| VAT Q2: payment due date (G7) = Vatinterface final date for payment (C11) | 44804 | 44804 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 44895 | 44895 | 0 | PASS |
...
| VAT Q4: payment due date (G7) = Vatinterface final date for payment (C17) | 44985 | 44985 | 0 | PASS |
...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C19) | 45046 | 45046 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 44957 | 44957 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 44957 | 44957 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 44957 | 44957 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 44957 | 44957 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 44957 | 44957 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 44957 | 44957 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 365 | 0 | PASS |
| Admin: first financial year row starts at the accounting period start | 44593 | 44593 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 44652 | 44652 | 0 | PASS |
| Admin: second financial year row ends at the year end | 44957 | 44957 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 44593 | 44593 | 0 | PASS |
| CT: working sheet heading ends at the year end | 44957 | 44957 | 0 | PASS |
| CT: the two tax rows span the accounting period | 365 | 365 | 0 | PASS |
| CT600: return period starts at the accounting period start | 44593 | 44593 | 0 | PASS |
| CT600: return period ends at the year end | 44957 | 44957 | 0 | PASS |
...
| CT600: corporation tax = first tax row gross tax | 4435.47138296126 | 4435.47138296126 | 0 | PASS |
| CT600: second financial year tax = second tax row gross tax | 23004.3092065448 | 23004.3092065448 | 0 | PASS |
...
| CT600: tax payable = tax chargeable | 27439.78058950606 | 27439.7805895061 | +4.001776687800884e-11 | PASS |
...
| CT: first tax row gross tax = its profit at its rate | 4435.471382961261 | 4435.47138296126 | -9.094947017729282e-13 | PASS |
| CT: second tax row gross tax = its profit at its rate | 23004.309206544858 | 23004.3092065448 | -5.820766091346741e-11 | PASS |
| CT: first tax row tax = its gross tax less its marginal relief | 4435.47138296126 | 4435.47138296126 | 0 | PASS |
| CT: second tax row tax = its gross tax less its marginal relief | 23004.3092065448 | 23004.3092065448 | 0 | PASS |
| CT: charge for the year = the two tax rows | 27439.78058950606 | 27439.7805895061 | +4.001776687800884e-11 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 covers the periods ending | 28 February 2022, 31 March 2022, 30 April 2022 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 covers the periods ending | 31 May 2022, 30 June 2022, 31 July 2022 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 covers the periods ending | 31 August 2022, 30 September 2022, 31 October 2022 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 covers the periods ending | 30 November 2022, 31 December 2022, 31 January 2023 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 covers the periods ending | 31 January 2023, 28 February 2023, 31 March 2023 |
| The returns above also cover the periods ending 28 February 2023, 31 March 2023, which fall outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 900 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 100 |
| Q4 and Q5 both cover the period ending 31 January 2023. The last form is a spare, for a business whose quarter stagger puts five returns across the accounting year; each form takes its period from a dropdown of the month ends the book carries. The book stops two months after the year end, so there is no row to total the quarter after the fourth return and the spare lands on the last period the book carries instead. Filing all five as they stand would declare that period twice. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on it | 5,226.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on it | 621.08 |
| **The return forms as the package fills them in** |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 April 2022) box 1: VAT due on sales | 16,920 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 April 2022) box 4: VAT reclaimed on purchases | 3,423.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 30 April 2022) box 5: net VAT due | 13,496.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 July 2022) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 July 2022) box 4: VAT reclaimed on purchases | 3,073.25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 July 2022) box 5: net VAT due | 14,183.42 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 October 2022) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 October 2022) box 4: VAT reclaimed on purchases | 9,895.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 31 October 2022) box 5: net VAT due | 9,884.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 January 2023) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 January 2023) box 4: VAT reclaimed on purchases | 2,105.71 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 January 2023) box 5: net VAT due | 14,754.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 March 2023) box 1: VAT due on sales | 6,126.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 March 2023) box 4: VAT reclaimed on purchases | 721.08 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 March 2023) box 5: net VAT due | 5,405.58 |
...
| G33 |  | 19 |  |
| G34 |  | 19 |  |
| J33 |  | 4435.47138296126 |  |
| J34 |  | 23004.3092065448 |  |
| L33 |  | 0 |  |
| L34 |  | 0 |  |
| I33 |  | 4435.47138296126 |  |
| I34 |  | 23004.3092065448 |  |
...
| AJ126 | Box 46: tax | 4435.47138296126 | gl-cor:taxAmount (ct600.box46) |
...
| AJ128 | Box 56: tax | 23004.3092065448 | gl-cor:taxAmount (ct600.box56) |
