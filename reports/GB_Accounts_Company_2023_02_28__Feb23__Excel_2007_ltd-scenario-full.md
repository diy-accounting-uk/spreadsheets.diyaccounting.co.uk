# Reconciliation Report: GB Accounts Company 2023-02-28 (Feb23) Excel 2007
...
| VAT Q1: payment due date (G7) = Vatinterface final date for payment (C8) | 44742 | 44742 | 0 | PASS |
...
| VAT Q2: payment due date (G7) = Vatinterface final date for payment (C11) | 44834 | 44834 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 44926 | 44926 | 0 | PASS |
...
| VAT Q4: payment due date (G7) = Vatinterface final date for payment (C17) | 45016 | 45016 | 0 | PASS |
...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C20) | 45107 | 45107 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 44985 | 44985 | 0 | PASS |
...
| Payslips!Feb K69 the monthly payroll opens in the accounting period's Feb | 44958 | 44958 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 44985 | 44985 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 44985 | 44985 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 44985 | 44985 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 44985 | 44985 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 44985 | 44985 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 365 | 0 | PASS |
| Admin: first financial year row starts at the accounting period start | 44621 | 44621 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 44652 | 44652 | 0 | PASS |
| Admin: second financial year row ends at the year end | 44985 | 44985 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 44621 | 44621 | 0 | PASS |
| CT: working sheet heading ends at the year end | 44985 | 44985 | 0 | PASS |
| CT: the two tax rows span the accounting period | 365 | 365 | 0 | PASS |
| CT600: return period starts at the accounting period start | 44621 | 44621 | 0 | PASS |
| CT600: return period ends at the year end | 44985 | 44985 | 0 | PASS |
...
| CT600: corporation tax = first tax row gross tax | 2007.76218705394 | 2007.76218705394 | 0 | PASS |
| CT600: second financial year tax = second tax row gross tax | 21632.0184024522 | 21632.0184024522 | 0 | PASS |
...
| CT600: tax payable = tax chargeable | 23639.78058950614 | 23639.7805895061 | -4.001776687800884e-11 | PASS |
...
| CT: first tax row gross tax = its profit at its rate | 2007.7621870539488 | 2007.76218705394 | -8.86757334228605e-12 | PASS |
| CT: second tax row gross tax = its profit at its rate | 21632.01840245221 | 21632.0184024522 | -1.0913936421275139e-11 | PASS |
| CT: first tax row tax = its gross tax less its marginal relief | 2007.76218705394 | 2007.76218705394 | 0 | PASS |
| CT: second tax row tax = its gross tax less its marginal relief | 21632.0184024522 | 21632.0184024522 | 0 | PASS |
| CT: charge for the year = the two tax rows | 23639.78058950614 | 23639.7805895061 | -4.001776687800884e-11 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 covers the periods ending | 31 March 2022, 30 April 2022, 31 May 2022 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 covers the periods ending | 30 June 2022, 31 July 2022, 31 August 2022 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 covers the periods ending | 30 September 2022, 31 October 2022, 30 November 2022 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 covers the periods ending | 31 December 2022, 31 January 2023, 28 February 2023 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 covers the periods ending | 31 March 2023, 30 April 2023, 31 May 2023 |
| The returns above also cover the periods ending 31 March 2023, 30 April 2023, 31 May 2023, which fall outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 180 |
| **The return forms as the package fills them in** |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 May 2022) box 1: VAT due on sales | 16,920 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 May 2022) box 4: VAT reclaimed on purchases | 6,023.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 May 2022) box 5: net VAT due | 10,896.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 August 2022) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 August 2022) box 4: VAT reclaimed on purchases | 4,473.25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 31 August 2022) box 5: net VAT due | 12,783.42 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 November 2022) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 November 2022) box 4: VAT reclaimed on purchases | 9,895.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 November 2022) box 5: net VAT due | 9,884.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 28 February 2023) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 28 February 2023) box 4: VAT reclaimed on purchases | 2,105.71 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 28 February 2023) box 5: net VAT due | 14,754.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 May 2023) box 1: VAT due on sales | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 May 2023) box 4: VAT reclaimed on purchases | 180 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 May 2023) box 5: net VAT due | 920 |
...
| G33 |  | 19 |  |
| G34 |  | 19 |  |
| J33 |  | 2007.76218705394 |  |
| J34 |  | 21632.0184024522 |  |
| L33 |  | 0 |  |
| L34 |  | 0 |  |
| I33 |  | 2007.76218705394 |  |
| I34 |  | 21632.0184024522 |  |
...
| AJ126 | Box 46: tax | 2007.76218705394 | gl-cor:taxAmount (ct600.box46) |
...
| AJ128 | Box 56: tax | 21632.0184024522 | gl-cor:taxAmount (ct600.box56) |
