...
| CT: Marginal relief expected (profit > £50K) | 53046 | 53046.3058333333 | +0.3058333333028713 | **WARNING** |
...
| | Amount |
|---|------:|
| Audit Accuracy Check | -1,786,213 |
...
| D29 | Directors Loan | 1894873 | accounts.liabilities.2500 (pubBS) |
...
| Cell | DIY Label | Value | diya-gl mapping |
|------|-----------|-------|-----------------|
| EJ91 | Audit Accuracy Check | -1786213 | gl-cor:amount (trialBalanceCheck) |
