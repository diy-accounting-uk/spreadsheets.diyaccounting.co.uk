# Reconciliation Report: GB Accounts Company 2022-12-31 (Dec22) Excel 2007
...
| VAT Q1: payment due date (G7) = Vatinterface final date for payment (C8) | 44681 | 44681 | 0 | PASS |
...
| VAT Q2: payment due date (G7) = Vatinterface final date for payment (C11) | 44773 | 44773 | 0 | PASS |
...
| VAT Q3: payment due date (G7) = Vatinterface final date for payment (C14) | 44865 | 44865 | 0 | PASS |
...
| VAT Q4: payment due date (G7) = Vatinterface final date for payment (C17) | 44957 | 44957 | 0 | PASS |
...
| VAT Q5: payment due date (G7) = Vatinterface final date for payment (C20) | 45046 | 45046 | 0 | PASS |
...
| Directors' report: year end = published balance sheet date | 44926 | 44926 | 0 | PASS |
...
| Payslips!Jun K59 the monthly payroll opens in the accounting period's Jun | 44713 | 44713 | 0 | PASS |
...
| Payslips!Dec K69 the monthly payroll opens in the accounting period's Dec | 44896 | 44896 | 0 | PASS |
...
| Admin: year-end seed = the package's own year end | 44926 | 44926 | 0 | PASS |
| Admin: year-end seed drives the accounting period anchor | 44926 | 44926 | 0 | PASS |
| Published P&L: year end = Admin year-end seed | 44926 | 44926 | 0 | PASS |
| Published balance sheet: date = Admin year-end seed | 44926 | 44926 | 0 | PASS |
| Fixed asset note: year end = Admin year-end seed | 44926 | 44926 | 0 | PASS |
| Admin: accounting period is twelve months | 365 | 365 | 0 | PASS |
| Admin: first financial year row starts at the accounting period start | 44562 | 44562 | 0 | PASS |
| Admin: second financial year row starts the day the first one ends | 44652 | 44652 | 0 | PASS |
| Admin: second financial year row ends at the year end | 44926 | 44926 | 0 | PASS |
| CT: working sheet heading starts at the accounting period start | 44562 | 44562 | 0 | PASS |
| CT: working sheet heading ends at the year end | 44926 | 44926 | 0 | PASS |
| CT: the two tax rows span the accounting period | 365 | 365 | 0 | PASS |
| CT600: return period starts at the accounting period start | 44562 | 44562 | 0 | PASS |
| CT600: return period ends at the year end | 44926 | 44926 | 0 | PASS |
...
| CT600: corporation tax = first tax row gross tax | 5828.98699467274 | 5828.98699467274 | 0 | PASS |
| CT600: second financial year tax = second tax row gross tax | 17810.7935948334 | 17810.7935948334 | 0 | PASS |
...
| CT600: tax payable = tax chargeable | 23639.780589506143 | 23639.7805895061 | -4.3655745685100555e-11 | PASS |
...
| CT: first tax row gross tax = its profit at its rate | 5828.986994672738 | 5828.98699467274 | +2.7284841053187847e-12 | PASS |
| CT: second tax row gross tax = its profit at its rate | 17810.79359483336 | 17810.7935948334 | +4.001776687800884e-11 | PASS |
| CT: first tax row tax = its gross tax less its marginal relief | 5828.98699467274 | 5828.98699467274 | 0 | PASS |
| CT: second tax row tax = its gross tax less its marginal relief | 17810.7935948334 | 17810.7935948334 | 0 | PASS |
| CT: charge for the year = the two tax rows | 23639.780589506143 | 23639.7805895061 | -4.3655745685100555e-11 | PASS |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 covers the periods ending | 31 January 2022, 28 February 2022, 31 March 2022 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 covers the periods ending | 30 April 2022, 31 May 2022, 30 June 2022 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 covers the periods ending | 31 July 2022, 31 August 2022, 30 September 2022 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 covers the periods ending | 31 October 2022, 30 November 2022, 31 December 2022 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 covers the periods ending | 31 January 2023, 28 February 2023, 31 March 2023 |
| The returns above also cover the periods ending 31 January 2023, 28 February 2023, 31 March 2023, which fall outside the accounting year. |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Output VAT on those | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Input VAT on those | 180 |
| **The return forms as the package fills them in** |  |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 March 2022) box 1: VAT due on sales | 16,920 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 March 2022) box 4: VAT reclaimed on purchases | 6,023.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q1 (period ending 31 March 2022) box 5: net VAT due | 10,896.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 June 2022) box 1: VAT due on sales | 17,256.67 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 June 2022) box 4: VAT reclaimed on purchases | 4,473.25 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q2 (period ending 30 June 2022) box 5: net VAT due | 12,783.42 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 September 2022) box 1: VAT due on sales | 19,780 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 September 2022) box 4: VAT reclaimed on purchases | 9,895.88 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q3 (period ending 30 September 2022) box 5: net VAT due | 9,884.13 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 December 2022) box 1: VAT due on sales | 16,860 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 December 2022) box 4: VAT reclaimed on purchases | 2,105.71 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q4 (period ending 31 December 2022) box 5: net VAT due | 14,754.29 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 March 2023) box 1: VAT due on sales | 1,100 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 March 2023) box 4: VAT reclaimed on purchases | 180 |
| &nbsp;&nbsp;&nbsp;&nbsp;Q5 (period ending 31 March 2023) box 5: net VAT due | 920 |
...
| G33 |  | 19 |  |
| G34 |  | 19 |  |
| J33 |  | 5828.98699467274 |  |
| J34 |  | 17810.7935948334 |  |
| L33 |  | 0 |  |
| L34 |  | 0 |  |
| I33 |  | 5828.98699467274 |  |
| I34 |  | 17810.7935948334 |  |
...
| AJ126 | Box 46: tax | 5828.98699467274 | gl-cor:taxAmount (ct600.box46) |
...
| AJ128 | Box 56: tax | 17810.7935948334 | gl-cor:taxAmount (ct600.box56) |
