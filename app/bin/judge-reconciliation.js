...
export const PRODUCTS = {
  ...
  ltd: {
    ...
    notes: [
      ...
      "The working sheet builds the charge from two dated tax rows. The first row is the accounting period, the second is the year after it, so their spans are 365 and 366 days and each row takes that share of the same chargeable profit. The two rows add back to the full charge, and both carry the same rate, so the charge in the accounts is the chargeable profit at that one rate whatever the year end.",
