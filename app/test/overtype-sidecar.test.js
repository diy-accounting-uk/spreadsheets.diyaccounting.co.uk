...
// from the current templates through the product writer, rather than the
// committed examples/se-latest fixture. That fixture is regenerated by CI
// from whichever template shipped when it last ran, so a template formula
// edit between refreshes leaves it carrying a stale literal where the
// current template now computes -- which would otherwise show up as an
// extra typed-over cell nobody introduced.
