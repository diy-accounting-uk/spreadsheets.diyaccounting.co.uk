...
import { TAXI_PURCHASE_CODE_MAP, generateTaxYearWeeks, groupWeeksIntoMonths, calculateExpectedTax } from "../lib/diya-gl-engine.js";
import { calculateTaxiResults } from "../lib/calculators/taxi.js";
import * as taxi from "../products/taxi.js";

const __dirname = dirname(fileURLToPath(import.meta.url));
const ROOT = resolve(__dirname, "..", "..");
const MANIFEST_FILE = resolve(ROOT, "web", "spreadsheets.diyaccounting.co.uk", "public", "diya-gl", "products", "taxi.js");
