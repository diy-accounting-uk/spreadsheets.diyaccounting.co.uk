...
//
// diya-gl-page-upload.test.js — the two page-side pieces an upload runs
// through, exercised from Node against the real example packages.
//
// The books page cannot import app/lib, so diya-gl/xlsx-cells.js opens the
// workbook set itself and diya-gl/drift.js reads the as-read layer off it.
...
import { sniffProduct, PackagePartError } from "../lib/diya-gl-interchange.js";
