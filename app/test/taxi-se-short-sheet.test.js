...
const TEMPLATE_PATH = resolve(APP_DIR, "templates", "taxi", "taxi-excel.xlsx");
...
// The seven expense-detail cells this template's layout carries a gate on
// (D51 and D64 hold no gate formula here), each reading the VAT threshold
// rather than a figure of its own.
const SE_SHORT_GATED_CELLS = ["D46", "O46", "O51", "D55", "O55", "D60", "O60"];
...
describe("the shipped Taxi template's SE Short sheet", () => {
  let xml;
  let adminXml;
  let sharedStrings;
  ...
  it("gates the expense-detail boxes on Admin!F26", () => {
