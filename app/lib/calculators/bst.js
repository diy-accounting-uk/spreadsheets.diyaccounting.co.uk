...
export function calculateBstResults(book, lines, taxData, scenario) {
  ...
  // SE Short (SA103S) — derived from P&L. The sheet's own formulas define the
  // box map; this aggregation is an approximation until the capital
  // allowances and box-by-box mapping land.
