  ...
  return {
    ...
    additionalReads: {
      ...
      "Payslips.xlsx": {
        ...
        // aggregates.
        Jul: [...PAYSLIPS_JUL_DEAD_CELLS, ...PAYSLIPS_MONTH_ENTRY_CELLS],
        Aug: [...PAYSLIPS_AUG_BROUGHT_FORWARD_CELLS, ...PAYSLIPS_MONTH_ENTRY_CELLS],
      },
    },
  };
}
...
export function checkCompliance(results, expected, taxData, calculateExpectedTax) {
  ...
  if (expected.payroll) {
    ...
    checkMonthPayrollEntries("Jul", expected.payroll.jul || []);
    checkMonthPayrollEntries("Aug", expected.payroll.aug || []);
