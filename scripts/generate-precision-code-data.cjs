...
for (let i = 0; i < 12; i++) {
  addSale({
    ...
    comment: "IT consultancy retainer",
    docRef: `INV-${1101 + i}`,
  });
}
...
for (let j = 0; j < dataflowMonths.length; j++) {
  addSale({
    date: fyDate(dataflowMonths[j], 20),
    account: "4000",
    amount: 1800,
    customer: "DataFlow Inc",
    comment: "Ad-hoc consultancy project",
    docRef: `INV-${1201 + j}`,
  });
}
...
for (let j = 0; j < betaMonths.length; j++) {
  addSale({
    date: fyDate(betaMonths[j], 1),
    account: "4001",
    amount: 1200,
    customer: "Beta Systems",
    comment: "Software licence renewal",
    docRef: `INV-${1301 + j}`,
  });
}
...
for (let i = 0; i < 12; i++) {
  addSale({
    ...
    account: "4001",
    amount: 600,
    customer: "CloudNine Ltd",
    comment: "SaaS licence fee",
    docRef: `INV-${1401 + i}`,
  });
}
...
addSale({
  ...
  amount: 2400,
  customer: "Gamma Ltd",
  comment: "Advanced DevOps training course",
  docRef: "INV-1501",
});
addSale({
  date: "2025-11-20",
  ...
  amount: 3600,
  customer: "Delta PLC",
  comment: "Cloud architecture workshop",
  docRef: "INV-1502",
});
addSale({
  date: "2026-02-20",
...
addSale({
  ...
  amount: 960,
  customer: "StartupHub",
  comment: "Agile methodology workshop",
  docRef: "INV-1504",
});
...
addSale({
  ...
  comment: "Client referral commission",
  docRef: "INV-1601",
});
addSale({
  date: "2026-01-25",
...
addSale({
  ...
  account: "4004",
  amount: 2500,
  customer: "Innovate UK",
  comment: "Small business innovation grant",
  docRef: "INV-1701",
  taxCode: "OS",
  taxRate: 0,
});
...
addSale({
  ...
  account: "4006",
  amount: 15000,
  customer: "Private buyer",
  comment: "Disposal of company van",
  docRef: "INV-1901",
});
...
for (let j = 0; j < quickfixMonths.length; j++) {
  addSale({
    date: fyDate(quickfixMonths[j], 12),
    account: "4000",
    amount: 960,
    customer: "QuickFix IT",
    comment: "IT support consultancy",
    docRef: `INV-${2001 + j}`,
  });
}
...
for (let j = 0; j < widgetMonths.length; j++) {
  addSale({
    date: fyDate(widgetMonths[j], 22),
    account: "4000",
    amount: 1440,
    customer: "WidgetWorks",
    comment: "Project consultancy",
    docRef: `INV-${2101 + j}`,
  });
}
...
for (let i = 0; i < 12; i++) {
  addSale({
    ...
    comment: "Monthly support contract",
    docRef: `INV-${2201 + i}`,
  });
}
...
for (let j = 0; j < northstarMonths.length; j++) {
  addSale({
    date: fyDate(northstarMonths[j], 14),
    account: "4000",
    amount: 2160,
    customer: "NorthStar Digital",
...
for (let j = 0; j < oakridgeMonths.length; j++) {
  addSale({
    date: fyDate(oakridgeMonths[j], 25),
    account: "4000",
    amount: 1200,
    customer: "Oakridge Partners",
    comment: "Quarterly consulting engagement",
    docRef: `INV-${2501 + j}`,
  });
}
...
for (let i = 0; i < 12; i++) {
  addSale({
    ...
    account: "4001",
    amount: 360,
    customer: "FreshField Ltd",
    comment: "Software monitoring licence",
    docRef: `INV-${2601 + i}`,
  });
}
...
for (let j = 0; j < horizonMonths.length; j++) {
  addSale({
    date: fyDate(horizonMonths[j], 28),
    account: "4003",
    amount: 840,
    customer: "Horizon Analytics",
    comment: "Data analytics commission",
    docRef: `INV-${2701 + j}`,
  });
}
...
for (let j = 0; j < summitMonths.length; j++) {
  addSale({
    date: fyDate(summitMonths[j], 16),
    account: "4002",
    amount: 1200,
    customer: "Summit Training",
    comment: "Technical training delivery",
    docRef: `INV-${2801 + j}`,
  });
}
...
for (let j = 0; j < 4; j++) {
  addPurchase({
    date: fyDate(utilityMonths[j], 25),
    account: "5201",
    amount: utilityAmounts[j],
    supplier: "EnergySupply",
    comment: "Quarterly utility bill",
  });
}
...
for (let j = 0; j < 4; j++) {
  addPurchase({
    date: fyDate(techpartsMonths[j], 10),
    account: "5000",
    amount: techpartsAmounts[j],
    supplier: "TechParts",
    comment: "Hardware components for resale",
  });
}
...
for (let j = 0; j < 4; j++) {
  addPurchase({
    date: fyDate(compMonths[j], 15),
    account: "5000",
    amount: compAmounts[j],
    supplier: "ComponentsDirect",
...
addPurchase({
  ...
  amount: 1440,
  supplier: "Hiscox",
  comment: "Professional indemnity insurance",
  taxCode: "E",
  taxRate: 0,
});
...
addPurchase({
  ...
  account: "5800",
  amount: 960,
  supplier: "Jones Solicitors",
  comment: "Contract review and legal advice",
});
...
addPurchase({
  ...
  account: "5801",
  amount: 500,
  supplier: "Code Club UK",
  comment: "Charitable donation",
  taxCode: "OS",
  taxRate: 0,
});
...
addPurchase({
  ...
  account: "5802",
  amount: 3000,
  supplier: "J. Smith Consulting",
  comment: "Goodwill amortisation",
  taxCode: "OS",
  taxRate: 0,
});
...
addPurchase({
  ...
  amount: 5000,
  supplier: "Director",
  comment: "Director fees (non-PAYE)",
  taxCode: "OS",
  taxRate: 0,
});
...
addPurchase({
  ...
  account: "5101",
  amount: 800,
  supplier: "Casual worker",
  comment: "Temporary labour",
  taxCode: "OS",
  taxRate: 0,
});
...
for (const [mi, amt] of electroData) {
  addPurchase({
    ...
    comment: "Specialist electronic components",
  });
}
...
for (const [mi, amt] of offMaintData) {
  addPurchase({
    ...
    account: "5400",
    amount: amt,
    supplier: "Office Maintenance Ltd",
    comment: "Premises maintenance and repairs",
  });
}
...
addPurchase({
  ...
  comment: "Contents insurance renewal",
  taxCode: "E",
  taxRate: 0,
});
...
addPurchase({
  ...
  amount: 1800,
  supplier: "Dell",
  comment: "New laptop for development",
  docRef: "PUR-FA-001",
});
addPurchase({
  date: "2025-10-25",
  ...
  amount: 36000,
  supplier: "Ford",
  comment: "Ford Transit Custom van",
  docRef: "PUR-FA-002",
});
...
addPurchase({
  ...
  comment: "Sub-contractor network installation",
  docRef: "PUR-CIS-001",
  cisDeduction: 1000,
  cisRate: 0.2,
});
addPurchase({
  ...
  amount: 3000,
  supplier: "BuildTech Solutions",
  comment: "Sub-contractor cabling works",
  docRef: "PUR-CIS-002",
  cisDeduction: 600,
  cisRate: 0.2,
});
...
for (let j = 0; j < loanIntData.length; j++) {
  ...
  addPurchase({
    ...
    account: "5803",
    amount: amt,
    supplier: "Directors loan",
    comment: "Directors loan interest",
    docRef: `PUR-INT-${String(j + 1).padStart(3, "0")}`,
    taxCode: "OS",
    taxRate: 0,
  });
}
...
const mileageData = [
  ...
  { mi: 1, miles: 120, dest: "Birmingham", amount: 54.0 },
  { mi: 2, miles: 200, dest: "London", amount: 90.0 },
  { mi: 3, miles: 45, dest: "Leeds", amount: 20.25 },
  { mi: 4, miles: 85, dest: "Manchester", amount: 38.25 },
  { mi: 5, miles: 160, dest: "Bristol", amount: 72.0 },
  { mi: 6, miles: 95, dest: "Sheffield", amount: 42.75 },
  { mi: 7, miles: 180, dest: "London", amount: 81.0 },
  { mi: 8, miles: 110, dest: "Various", amount: 49.5 },
  { mi: 9, miles: 85, dest: "Manchester", amount: 38.25 },
  { mi: 10, miles: 70, dest: "Nottingham", amount: 31.5 },
  { mi: 11, miles: 130, dest: "Various", amount: 58.5 },
];
...
for (const m of mileageData) {
  addPurchase({
    ...
    comment: `Business mileage to ${m.dest}`,
    docType: "mileage-log",
    taxCode: "OS",
    taxRate: 0,
    measurableQuantity: m.miles,
    unitOfMeasure: "miles",
...
addBank({
  ...
  comment: "Current account opening balance",
  bankCode: "BC",
  docRef: "BNK-0001",
});
...
for (let i = 0; i < 12; i++) {
  addBank({
    ...
    bankCode: "DR",
    docRef: `BNK-DR-${String(i + 1).padStart(3, "0")}`,
  });
}
...
for (let i = 0; i < 12; i++) {
  addBank({
    ...
    bankAccountID: "1200",
    amount: 2400,
    detail: "TechStart Ltd",
    comment: "Customer receipt",
    bankCode: "DR",
    docRef: `BNK-DR-${String(i + 13).padStart(3, "0")}`,
  });
}
...
for (let i = 0; i < 12; i++) {
  addBank({
    date: fyDate(i, 28),
    bankAccountID: "1200",
    amount: otherDRAmounts[i],
    detail: "Various customers",
    comment: "Aggregate customer receipts",
    bankCode: "DR",
    docRef: `BNK-DR-${String(i + 25).padStart(3, "0")}`,
  });
}
...
addBank({
  ...
  amount: 7200,
  detail: "Acme Corp",
  comment: "Opening debtor receipt",
  bankCode: "DR",
  docRef: "BNK-DR-037",
});
addBank({
...
addBank({
  ...
  bankAccountID: "1200",
  amount: 15000,
  detail: "Private buyer",
  comment: "Van sale proceeds",
  bankCode: "DR",
  docRef: "BNK-DR-040",
});
...
addBank({
  ...
  bankAccountID: "1200",
  amount: 5000,
  detail: "Director loan",
  comment: "Directors loan advance",
  bankCode: "DL",
  docRef: "BNK-DL-IN-001",
});
...
for (let i = 0; i < 12; i++) {
  addBank({
    ...
    bankAccountID: "1200",
    amount: 1200,
    detail: "WorkSpace Ltd",
    comment: "Office rent payment",
    bankCode: "CR",
    docRef: `BNK-CR-${String(i + 1).padStart(3, "0")}`,
  });
}
...
for (let i = 0; i < 12; i++) {
  addBank({
    ...
    amount: 300,
    detail: "Smith & Co",
    comment: "Accountancy fee payment",
    bankCode: "CR",
    docRef: `BNK-CR-${String(i + 13).padStart(3, "0")}`,
  });
}
...
for (let i = 0; i < 12; i++) {
  ...
  addBank({
    ...
    amount: 5652,
    detail: "Payroll",
    comment: "Monthly net wages (all staff)",
    bankCode: "W",
    docRef: `BNK-W-${String(i + 1).padStart(3, "0")}`,
  });
}
...
for (let i = 0; i < 12; i++) {
  addBank({
    ...
    amount: 1501,
    detail: "HMRC",
    comment: "Monthly PAYE/NI payment",
    bankCode: "RP",
    docRef: `BNK-RP-${String(i + 1).padStart(3, "0")}`,
  });
}
...
addBank({
  ...
  amount: 3800,
  detail: "HMRC",
  comment: "VAT payment Q1 Apr-Jun",
  bankCode: "RP",
  docRef: "BNK-RP-VAT-001",
});
addBank({
  date: "2025-10-07",
  bankAccountID: "1200",
  amount: 3200,
  detail: "HMRC",
  comment: "VAT payment Q2 Jul-Sep",
  bankCode: "RP",
  docRef: "BNK-RP-VAT-002",
});
...
addBank({
  ...
  amount: 1500,
  detail: "HMRC",
  comment: "VAT refund Q3 Oct-Dec",
  bankCode: "RV",
  docRef: "BNK-RV-VAT-003",
});
addBank({
  date: "2026-04-01",
  bankAccountID: "1200",
  amount: 2800,
  detail: "HMRC",
  comment: "VAT payment Q4 Jan-Mar",
  bankCode: "RP",
  docRef: "BNK-RP-VAT-004",
});
...
addBank({
  ...
  amount: 4500,
  detail: "HMRC",
  comment: "Corporation Tax prior year",
  bankCode: "RP",
  docRef: "BNK-RP-CT-001",
});
...
for (let i = 0; i < 12; i++) {
  addBank({
    ...
    amount: 1000,
    detail: "Director",
    comment: "Directors loan repayment",
    bankCode: "DL",
    docRef: `BNK-DL-${String(i + 1).padStart(3, "0")}`,
  });
}
...
for (let j = 0; j < bankIntData.length; j++) {
  addBank({
    date: bankIntData[j][0],
    bankAccountID: "1200",
    amount: bankIntData[j][1],
    detail: "Directors loan interest",
    comment: "Quarterly loan interest payment",
    bankCode: "B",
    docRef: `BNK-B-INT-${String(j + 1).padStart(3, "0")}`,
  });
}
...
addBank({
  ...
  amount: 6000,
  detail: "Dividend",
  comment: "Final dividend payment",
  bankCode: "DV",
  docRef: "BNK-DV-004",
});
...
addBank({
  ...
  amount: 36000,
  detail: "Ford",
  comment: "Ford Transit Custom purchase",
  bankCode: "CR",
  docRef: "BNK-CR-FA-001",
});
...
addBank({
  ...
  comment: "Transfer to savings account",
  bankCode: "X",
  docRef: "BNK-X-001",
});
...
for (let j = 0; j < ccPayData.length; j++) {
  addBank({
    date: ccPayData[j][0],
    bankAccountID: "1200",
    amount: ccPayData[j][1],
    detail: "Credit card payment",
    comment: "Pay credit card balance",
    bankCode: "X",
    docRef: `BNK-X-CC-${String(j + 1).padStart(3, "0")}`,
  });
}
...
for (let i = 0; i < 12; i++) {
  addBank({
    date: fyDate(i, 5),
    bankAccountID: "1200",
    amount: miscCRAmounts[i],
    detail: "Various suppliers",
    comment: "Aggregate supplier payments",
    bankCode: "CR",
    docRef: `BNK-CR-MISC-${String(i + 1).padStart(3, "0")}`,
  });
}
...
addBank({
  ...
  amount: 1000,
  detail: "HMRC",
  comment: "CIS deduction remittance",
  bankCode: "RP",
  docRef: "BNK-RP-CIS-001",
});
addBank({
  date: "2025-12-19",
  bankAccountID: "1200",
...
addBank({
  ...
  amount: 5000,
  detail: "Opening balance",
  comment: "Savings account opening balance",
  bankCode: "BC",
  docRef: "BNK-SAV-001",
});
addBank({
  ...
  amount: 5000,
  detail: "Internal transfer",
  comment: "Transfer from current account",
  bankCode: "X",
  docRef: "BNK-SAV-002",
});
addBank({
...
addBank({
  ...
  amount: 500,
  detail: "Opening balance",
  comment: "Cash float opening balance",
  bankCode: "BC",
  docRef: "BNK-CASH-001",
});
addBank({
  ...
  amount: 100,
  detail: "Cash top-up",
  comment: "Cash float replenishment",
  bankCode: "X",
  docRef: "BNK-CASH-002",
});
addBank({
...
addBank({
  ...
  amount: 50,
  detail: "Various",
  comment: "Christmas team refreshments",
  bankCode: "CR",
  docRef: "BNK-CASH-006",
});
addBank({
  ...
  amount: 12,
  detail: "Newsagent",
  comment: "Newspapers for reception",
  bankCode: "CR",
  docRef: "BNK-CASH-007",
});
...
addBank({
  ...
  amount: 120,
  detail: "Trainline",
  comment: "Train ticket on credit card",
  bankCode: "CR",
  docRef: "BNK-CC-002",
});
addBank({
...
addBank({
  ...
  amount: 35,
  detail: "HSBC",
  comment: "Credit card annual fee",
  bankCode: "B",
  docRef: "BNK-CC-004",
});
...
addBank({
  ...
  bankAccountID: "1230",
  amount: 500,
  detail: "Payment from current",
  comment: "Credit card payment received",
  bankCode: "X",
  docRef: "BNK-CC-005",
});
addBank({
...
const employees = [
  { id: "EMP001", name: "Alice Johnson", account: "5101", gross: 3500, tax: 530, eeNI: 200, erNI: 382.5, net: 2770 },
  { id: "EMP002", name: "Bob Williams", account: "5101", gross: 2200, tax: 270, eeNI: 96, erNI: 187.5, net: 1834 },
  { id: "EMP003", name: "Carol Smith", account: "5100", gross: 1048, tax: 0, eeNI: 0, erNI: 7.2, net: 1048 },
];
...
addJournal({
  ...
  comment: "Stock reduction (10000 opening - 6000 closing)",
  docRef: "JNL-001",
  dc: "C",
  lineNumber: 1,
});
addJournal({
  ...
  amount: 4000,
  detail: "Stock adjustment",
  comment: "Cost of goods sold stock adjustment",
  docRef: "JNL-001",
  dc: "D",
  lineNumber: 2,
});
