...
test.describe("Spreadsheets Site - spreadsheets.diyaccounting.co.uk", () => {
  ...
  // with force:true, so this drives the field with focus plus keyboard
  // input the same way Submit's own login helper does.
  async function typeIntoVisibleField(page, selector, value) {
  ...
  test("Cloud sign-in: save, list, open, delete and sign out of the DIYA-GL account", async ({ page }) => {
    ...
    const cloudScreenshotPath = `${screenshotPath}/cloud-sign-in`;
