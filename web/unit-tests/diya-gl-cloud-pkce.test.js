...
const CONFIG_SRC = readFileSync(resolve(process.cwd(), "web/diya-gl.co.uk/public/cloud-config.js"), "utf8");
const CLOUD_SRC = readFileSync(resolve(process.cwd(), "web/diya-gl.co.uk/public/cloud.js"), "utf8");
