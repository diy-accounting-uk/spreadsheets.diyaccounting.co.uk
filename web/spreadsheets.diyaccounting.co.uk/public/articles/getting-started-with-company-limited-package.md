...
There is a user guide with the package (Companyaccountsuserguide.pdf) which goes into some detail about what to do.
    ...
    We also have a forum here:[http://forums.teneric.co.uk/diy-accounting/](http://forums.teneric.co.uk/diy-accounting/) where you can post queries and search for solutions already present.