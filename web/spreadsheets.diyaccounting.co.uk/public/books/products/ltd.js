...
(function (global) {
  ...
  var ADMIN_STRADDLE_CHECK_CELL = "CorporationTax!A34";
  ...
  global.DiyaGlLtdShared = {
    ...
    BUSINESS_DETAILS_SHEET: BUSINESS_DETAILS_SHEET,
    ...
    HP_SHEET: HP_SHEET,
    OPENING_DEBTORS_SHEET: OPENING_DEBTORS_SHEET,
    CLOSING_DEBTORS_SHEET: CLOSING_DEBTORS_SHEET,
    OPENING_CREDITORS_SHEET: OPENING_CREDITORS_SHEET,
    CLOSING_CREDITORS_SHEET: CLOSING_CREDITORS_SHEET,
    LEDGER_TOTAL_CELL: LEDGER_TOTAL_CELL,
    ...
    ADMIN_STRADDLE_CHECK_CELL: ADMIN_STRADDLE_CHECK_CELL,
    ENTITY_PATH_PREFIX: ENTITY_PATH_PREFIX,
    liveSnapshot: liveSnapshot,
    labelFor: labelFor,
    unitOf: unitOf,
    sectionRowsOf: sectionRowsOf,
    num: num,
    cellValue: cellValue,
