...
// web/browser-tests/diya-gl-taxi-views.browser.test.js
//
...
// only ever appearing once. diya-gl-taxi-forms.browser.test.js covers the
...
// applyDriftMarks from scratch on every call (diya-gl/shell.js render()), so a
