...
// web/browser-tests/diya-gl-taxi-formats.browser.test.js
//
...
// fixture. The two currently disagree (see diya-gl-taxi-equivalence's own A3
...
test.beforeAll(async ({ browser }) => {
  ...
  // The JSON fixture is the page's own diya-gl document for the same
...
// ── E3: JSON round trips identically ────────────────────────────────────────

test.describe("DIYA-GL Taxi books page — the round trip (E3)", () => {
