...
// web/browser-tests/diya-gl-donation.browser.test.js
//
// The two donation nudges diya-gl/shell.js shows: one the first time the year
...
// Loading an example writes it into the URL as a deep link (diya-gl/shell.js's
