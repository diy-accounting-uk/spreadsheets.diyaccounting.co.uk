...
// web/browser-tests/diya-gl-ltd-deep-links.browser.test.js
//
// The books page's ?example=/&view=/&month= deep links, over diya-gl/ltd.html:
// the same shell (shell.js) that drives diya-gl-deep-links.browser.test.js for
