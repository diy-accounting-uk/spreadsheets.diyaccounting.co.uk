...
| SE-T37g | The Ltd proof: the bank add and the transfer pair with its counter-leg | PLAN_DIYA_GL_SE_CLI_MCP_WEB.md | machine | — | in-flight | Sonnet (the Ltd descriptor needs aligning to the shell's field shape); worktree SE-T37g, `claude/ltd-add-proof` |
