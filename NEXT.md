...
PR for the rows that are ready: CQ-37, CQ-35, CQ-36 and CQ-34 are on the batch, its full local
suite running before the one push. The SE rows stay on `claude/b16-se` (worktree `b16-se`, Opus:
SET-12, SET-8, SET-10, SET-9 in the plan's step order), held locally and never pushed until wake. No PR yet; no
watch monitor armed. Main is `8c065650`, green on `test` and `codeql`; prod serves `63028313`.
