...
|---|---|---|---|---|---|---|
| LP-26 | The cloud case's step 8: a book saves but never appears as a row in the account list, so either the list call or the row render is wrong | operator | machine | — | in-flight | worktree `lp26`; reading the run's trace for the list call |
