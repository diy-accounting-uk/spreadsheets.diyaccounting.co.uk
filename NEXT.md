...
| DG-1e | Move the DIYA-GL pages to `web/diya-gl.co.uk/public`; re-home builds, redirects, links and the path constants | PLAN_DIYA_GL_HOME.md | machine-only | — | in-flight | ~40 files | Sonnet | six parts committed on claude/dg-1e-site-move; routed run in its browser tier |
