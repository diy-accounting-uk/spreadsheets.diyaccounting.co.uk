...
| TX-T18 | Taxi T18 the form-box proof on both routes | PLAN_DIYA_GL_TAXI_CLI_MCP_WEB.md | machine | — | in-flight | `../.worktrees/spreadsheets/tx-t18` on `claude/wt-tx-t18`; Sonnet; plus the A5 gap: `PurchasesMar!A1`/`A2` hidden on no-mileage books, undeclared |
