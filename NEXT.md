...
PR for eight rows in one wave, three worktrees: `b16-router` (`claude/b16-router`, Sonnet: CQ-36
then CQ-34), `b16-skills` (`claude/b16-skills`, Haiku: CQ-37 then CQ-35), `b16-se`
(`claude/b16-se`, Opus: SET-12, SET-8, SET-10, SET-9 in the plan's step order). No PR yet; no
