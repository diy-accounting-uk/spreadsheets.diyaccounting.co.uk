...
| SE-T25 | `drift.js` emits two entries with one id when a link cell drifts and the hub cell also reads short | PLAN_DIYA_GL_SE_CLI_MCP_WEB.md | machine | SE-T19 | in-flight | `../.worktrees/spreadsheets/se-t25` on `claude/wt-se-t25`; Haiku |
