...
| LT-T18 | Ltd T18 register the Ltd specs in `playwright.config.js` | PLAN_DIYA_GL_LTD_CLI_MCP_WEB.md | machine | LT-T26 | blocked-to-start | the full unit and browser runs and one more four-product refresh, on the batch head |
