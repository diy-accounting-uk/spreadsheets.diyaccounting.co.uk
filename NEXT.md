...
| fidelity-t6 (wave 5) | T6: `verify-stability.js` (EQ3 on every package; `--all` for T7), `volatile-cells.json` with 54 stale cached values reported apart, 1 unstable conversion, 0 volatile | merged into `claude/wave-5` `847f184b`, stability test running, worktree removed |
