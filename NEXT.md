...
`../.worktrees/spreadsheets/lp-11-docker`, stacked on PR #76); the tap agent works in
...
| LP-11 | Docker image (`node:alpine` plus the packed tarball, pushed to GHCR from the publish workflow) and the Homebrew formula in the tap | PLAN_DIYA_GL_LAUNCH.md | machine | LP-22 | in-flight | image half is PR #77 on #76; the tap agent works in `../.worktrees/homebrew-tap` |
