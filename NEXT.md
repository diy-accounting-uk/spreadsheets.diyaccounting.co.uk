...
| LP-27 | The cloud case's step 9: the donation prompt painted over the account panel at equal z-index, so every row button was a dead click | operator | machine | — | in-flight | `6bf7d58f` on b7; a real customer hit this too |
