...
| LP-17 | Sign-in and "save to my account" on the books pages: hosted-UI redirect, token held in session, the book list, put and get through the storage API, conflict shown not merged; the same page on mobile | PLAN_DIYA_GL_LAUNCH.md | machine | LP-15, LP-16, H9 | in-flight | design landed in `PLAN_DIYA_GL_CLOUD_PAGE.md`; Sonnet builder on `claude/lp-17-cloud`, worktree lp-17; ids and the ci case wait on H9  |
