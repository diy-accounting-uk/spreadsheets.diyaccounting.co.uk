...
Wave 3 integrates on `claude/wave-3` (from main `038d0f37`, after the operator's generate refresh); it rebases onto main after the operator's deploy before its CI. Every later PR branch starts from a rebase onto the post-deploy green main.
